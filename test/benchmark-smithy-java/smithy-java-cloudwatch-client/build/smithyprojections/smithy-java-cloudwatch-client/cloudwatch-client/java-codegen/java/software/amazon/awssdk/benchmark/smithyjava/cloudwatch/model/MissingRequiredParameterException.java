 ...
 */
@SmithyGenerated
public final class MissingRequiredParameterException extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.MISSING_REQUIRED_PARAMETER_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private MissingRequiredParameterException(Builder builder) {
     ...
     *
     * @return a builder for {@link MissingRequiredParameterException}.
     */
    ...
    /**
     * Builder for {@link MissingRequiredParameterException}.
     */
    public static final class Builder implements ShapeBuilder<MissingRequiredParameterException> {
