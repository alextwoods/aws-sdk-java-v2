 ...
 */
@SmithyGenerated
public final class LimitExceededFault extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.LIMIT_EXCEEDED_FAULT;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private LimitExceededFault(Builder builder) {
     ...
     *
     * @return a builder for {@link LimitExceededFault}.
     */
    ...
    /**
     * Builder for {@link LimitExceededFault}.
     */
    public static final class Builder implements ShapeBuilder<LimitExceededFault> {
        ...
        @Override
        public LimitExceededFault build() {
            return new LimitExceededFault(this);
        }
