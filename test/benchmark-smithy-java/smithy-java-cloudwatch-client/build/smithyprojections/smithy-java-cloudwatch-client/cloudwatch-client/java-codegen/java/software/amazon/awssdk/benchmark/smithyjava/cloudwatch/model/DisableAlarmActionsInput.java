...
@SmithyGenerated
public final class DisableAlarmActionsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DISABLE_ALARM_ACTIONS_INPUT;
    ...
    private DisableAlarmActionsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DisableAlarmActionsInput that = (DisableAlarmActionsInput) other;
     ...
     *
     * @return a builder for {@link DisableAlarmActionsInput}.
     */
    ...
    /**
     * Builder for {@link DisableAlarmActionsInput}.
     */
    public static final class Builder implements ShapeBuilder<DisableAlarmActionsInput> {
        ...
        @Override
        public DisableAlarmActionsInput build() {
            tracker.validate();
            return new DisableAlarmActionsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DisableAlarmActionsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
