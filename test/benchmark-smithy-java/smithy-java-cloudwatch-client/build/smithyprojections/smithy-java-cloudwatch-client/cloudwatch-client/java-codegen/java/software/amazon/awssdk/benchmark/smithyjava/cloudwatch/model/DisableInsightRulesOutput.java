...
@SmithyGenerated
public final class DisableInsightRulesOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DISABLE_INSIGHT_RULES_OUTPUT;
    ...
    private DisableInsightRulesOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DisableInsightRulesOutput that = (DisableInsightRulesOutput) other;
     ...
     *
     * @return a builder for {@link DisableInsightRulesOutput}.
     */
    ...
    /**
     * Builder for {@link DisableInsightRulesOutput}.
     */
    public static final class Builder implements ShapeBuilder<DisableInsightRulesOutput> {
        ...
        @Override
        public DisableInsightRulesOutput build() {
            return new DisableInsightRulesOutput(this);
        }
