...
@SmithyGenerated
public final class PutManagedInsightRulesOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.PUT_MANAGED_INSIGHT_RULES_OUTPUT;
    ...
    private PutManagedInsightRulesOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        PutManagedInsightRulesOutput that = (PutManagedInsightRulesOutput) other;
     ...
     *
     * @return a builder for {@link PutManagedInsightRulesOutput}.
     */
    ...
    /**
     * Builder for {@link PutManagedInsightRulesOutput}.
     */
    public static final class Builder implements ShapeBuilder<PutManagedInsightRulesOutput> {
        ...
        @Override
        public PutManagedInsightRulesOutput build() {
            return new PutManagedInsightRulesOutput(this);
        }
