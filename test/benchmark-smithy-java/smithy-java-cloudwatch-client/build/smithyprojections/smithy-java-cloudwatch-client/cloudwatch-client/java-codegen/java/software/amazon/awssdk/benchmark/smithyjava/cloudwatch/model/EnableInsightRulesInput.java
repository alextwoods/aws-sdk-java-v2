...
@SmithyGenerated
public final class EnableInsightRulesInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.ENABLE_INSIGHT_RULES_INPUT;
    ...
    private EnableInsightRulesInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        EnableInsightRulesInput that = (EnableInsightRulesInput) other;
     ...
     *
     * @return a builder for {@link EnableInsightRulesInput}.
     */
    ...
    /**
     * Builder for {@link EnableInsightRulesInput}.
     */
    public static final class Builder implements ShapeBuilder<EnableInsightRulesInput> {
        ...
        @Override
        public EnableInsightRulesInput build() {
            tracker.validate();
            return new EnableInsightRulesInput(this);
        }
        ...
        @Override
        public ShapeBuilder<EnableInsightRulesInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
