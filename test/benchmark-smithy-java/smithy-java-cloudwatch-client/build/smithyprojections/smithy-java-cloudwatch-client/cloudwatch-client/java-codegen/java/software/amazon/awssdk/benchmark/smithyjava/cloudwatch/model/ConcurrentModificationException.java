 ...
 */
@SmithyGenerated
public final class ConcurrentModificationException extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.CONCURRENT_MODIFICATION_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("Message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ConcurrentModificationException(Builder builder) {
     ...
     *
     * @return a builder for {@link ConcurrentModificationException}.
     */
    ...
    /**
     * Builder for {@link ConcurrentModificationException}.
     */
    public static final class Builder implements ShapeBuilder<ConcurrentModificationException> {
