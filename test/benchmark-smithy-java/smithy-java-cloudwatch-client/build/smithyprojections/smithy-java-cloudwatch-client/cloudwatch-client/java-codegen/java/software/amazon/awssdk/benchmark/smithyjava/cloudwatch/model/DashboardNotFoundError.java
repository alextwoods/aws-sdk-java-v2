 ...
 */
@SmithyGenerated
public final class DashboardNotFoundError extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.DASHBOARD_NOT_FOUND_ERROR;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private DashboardNotFoundError(Builder builder) {
     ...
     *
     * @return a builder for {@link DashboardNotFoundError}.
     */
    ...
    /**
     * Builder for {@link DashboardNotFoundError}.
     */
    public static final class Builder implements ShapeBuilder<DashboardNotFoundError> {
        ...
        @Override
        public DashboardNotFoundError build() {
            return new DashboardNotFoundError(this);
        }
