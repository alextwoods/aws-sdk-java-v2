...
/**
 * The specified Amazon Web Services Key Management Service (Amazon Web Services KMS) key is disabled or pending
 * deletion. Re-enable the key (or restore it, if it is pending deletion) and retry the operation.
 */
@SmithyGenerated
public final class KmsKeyDisabledException extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.KMS_KEY_DISABLED_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("Message");

    public static final ShapeId $ID = $SCHEMA.id();

    private KmsKeyDisabledException(Builder builder) {
     ...
     *
     * @return a builder for {@link KmsKeyDisabledException}.
     */
    ...
    /**
     * Builder for {@link KmsKeyDisabledException}.
     */
    public static final class Builder implements ShapeBuilder<KmsKeyDisabledException> {
        ...
        @Override
        public KmsKeyDisabledException build() {
            tracker.validate();
            return new KmsKeyDisabledException(this);
        }
        ...
        @Override
        public ShapeBuilder<KmsKeyDisabledException> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
