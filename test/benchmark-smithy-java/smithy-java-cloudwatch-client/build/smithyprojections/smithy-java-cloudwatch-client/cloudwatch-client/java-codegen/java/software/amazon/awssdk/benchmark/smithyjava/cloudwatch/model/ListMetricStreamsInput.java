...
@SmithyGenerated
public final class ListMetricStreamsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.LIST_METRIC_STREAMS_INPUT;
    ...
    private ListMetricStreamsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListMetricStreamsInput that = (ListMetricStreamsInput) other;
     ...
     *
     * @return a builder for {@link ListMetricStreamsInput}.
     */
    ...
    /**
     * Builder for {@link ListMetricStreamsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListMetricStreamsInput> {
        ...
        @Override
        public ListMetricStreamsInput build() {
            return new ListMetricStreamsInput(this);
        }
