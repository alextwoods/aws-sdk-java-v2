...
@SmithyGenerated
public final class StopMetricStreamsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.STOP_METRIC_STREAMS_INPUT;
    ...
    private StopMetricStreamsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        StopMetricStreamsInput that = (StopMetricStreamsInput) other;
     ...
     *
     * @return a builder for {@link StopMetricStreamsInput}.
     */
    ...
    /**
     * Builder for {@link StopMetricStreamsInput}.
     */
    public static final class Builder implements ShapeBuilder<StopMetricStreamsInput> {
        ...
        @Override
        public StopMetricStreamsInput build() {
            tracker.validate();
            return new StopMetricStreamsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<StopMetricStreamsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
