...
@SmithyGenerated
public final class DisableInsightRulesInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DISABLE_INSIGHT_RULES_INPUT;
    ...
    private DisableInsightRulesInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DisableInsightRulesInput that = (DisableInsightRulesInput) other;
     ...
     *
     * @return a builder for {@link DisableInsightRulesInput}.
     */
    ...
    /**
     * Builder for {@link DisableInsightRulesInput}.
     */
    public static final class Builder implements ShapeBuilder<DisableInsightRulesInput> {
        ...
        @Override
        public DisableInsightRulesInput build() {
            tracker.validate();
            return new DisableInsightRulesInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DisableInsightRulesInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
