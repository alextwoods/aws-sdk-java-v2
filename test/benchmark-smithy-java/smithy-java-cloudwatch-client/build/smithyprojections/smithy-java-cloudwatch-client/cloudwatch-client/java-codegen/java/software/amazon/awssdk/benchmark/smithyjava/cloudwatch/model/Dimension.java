 ...
 *
 * <p>You can assign up to 30 dimensions to a metric.
 */
@SmithyGenerated
public final class Dimension implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DIMENSION;
     ...
     *
     * @return a builder for {@link Dimension}.
     */
     ...
     */
    public static final class Builder implements ShapeBuilder<Dimension> {
        ...
        @Override
        public ShapeBuilder<Dimension> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
