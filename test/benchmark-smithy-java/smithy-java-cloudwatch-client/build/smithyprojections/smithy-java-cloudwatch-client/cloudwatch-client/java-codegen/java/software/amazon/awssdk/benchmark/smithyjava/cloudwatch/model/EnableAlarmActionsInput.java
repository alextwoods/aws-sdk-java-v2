...
@SmithyGenerated
public final class EnableAlarmActionsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.ENABLE_ALARM_ACTIONS_INPUT;
    ...
    private EnableAlarmActionsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        EnableAlarmActionsInput that = (EnableAlarmActionsInput) other;
     ...
     *
     * @return a builder for {@link EnableAlarmActionsInput}.
     */
    ...
    /**
     * Builder for {@link EnableAlarmActionsInput}.
     */
    public static final class Builder implements ShapeBuilder<EnableAlarmActionsInput> {
        ...
        @Override
        public EnableAlarmActionsInput build() {
            tracker.validate();
            return new EnableAlarmActionsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<EnableAlarmActionsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
