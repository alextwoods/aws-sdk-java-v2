...
@SmithyGenerated
public final class DisassociateDatasetKmsKeyInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DISASSOCIATE_DATASET_KMS_KEY_INPUT;
    ...
    private DisassociateDatasetKmsKeyInput(Builder builder) {
        this.datasetIdentifier = builder.datasetIdentifier;
    }

    /**
     * Specifies the identifier of the dataset from which to remove the KMS key association. For the <code>default</code>
    ...
    public boolean equals(Object other) {
        ...
        DisassociateDatasetKmsKeyInput that = (DisassociateDatasetKmsKeyInput) other;
     ...
     *
     * @return a builder for {@link DisassociateDatasetKmsKeyInput}.
     */
    ...
    /**
     * Builder for {@link DisassociateDatasetKmsKeyInput}.
     */
    public static final class Builder implements ShapeBuilder<DisassociateDatasetKmsKeyInput> {
        ...
        @Override
        public DisassociateDatasetKmsKeyInput build() {
            tracker.validate();
            return new DisassociateDatasetKmsKeyInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DisassociateDatasetKmsKeyInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
