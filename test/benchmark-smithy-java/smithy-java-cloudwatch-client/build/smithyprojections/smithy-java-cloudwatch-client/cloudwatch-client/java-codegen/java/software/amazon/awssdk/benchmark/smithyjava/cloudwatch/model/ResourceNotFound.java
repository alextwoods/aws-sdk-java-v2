 ...
 */
@SmithyGenerated
public final class ResourceNotFound extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.RESOURCE_NOT_FOUND;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ResourceNotFound(Builder builder) {
     ...
     *
     * @return a builder for {@link ResourceNotFound}.
     */
    ...
    /**
     * Builder for {@link ResourceNotFound}.
     */
    public static final class Builder implements ShapeBuilder<ResourceNotFound> {
        ...
        @Override
        public ResourceNotFound build() {
            return new ResourceNotFound(this);
        }
