 ...
 */
@SmithyGenerated
public final class InvalidParameterCombinationException extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.INVALID_PARAMETER_COMBINATION_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidParameterCombinationException(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidParameterCombinationException}.
     */
    ...
    /**
     * Builder for {@link InvalidParameterCombinationException}.
     */
    public static final class Builder implements ShapeBuilder<InvalidParameterCombinationException> {
        ...
        @Override
        public InvalidParameterCombinationException build() {
            return new InvalidParameterCombinationException(this);
        }
