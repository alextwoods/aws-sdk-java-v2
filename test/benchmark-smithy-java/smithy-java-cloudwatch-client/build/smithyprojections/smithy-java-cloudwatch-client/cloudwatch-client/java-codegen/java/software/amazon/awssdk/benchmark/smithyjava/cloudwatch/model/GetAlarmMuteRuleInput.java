...
@SmithyGenerated
public final class GetAlarmMuteRuleInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.GET_ALARM_MUTE_RULE_INPUT;
    ...
    private GetAlarmMuteRuleInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetAlarmMuteRuleInput that = (GetAlarmMuteRuleInput) other;
     ...
     *
     * @return a builder for {@link GetAlarmMuteRuleInput}.
     */
    ...
    /**
     * Builder for {@link GetAlarmMuteRuleInput}.
     */
    public static final class Builder implements ShapeBuilder<GetAlarmMuteRuleInput> {
        ...
        @Override
        public GetAlarmMuteRuleInput build() {
            tracker.validate();
            return new GetAlarmMuteRuleInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetAlarmMuteRuleInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
