 ...
 */
@SmithyGenerated
public final class InvalidFormatFault extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.INVALID_FORMAT_FAULT;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidFormatFault(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidFormatFault}.
     */
    ...
    /**
     * Builder for {@link InvalidFormatFault}.
     */
    public static final class Builder implements ShapeBuilder<InvalidFormatFault> {
        ...
        @Override
        public InvalidFormatFault build() {
            return new InvalidFormatFault(this);
        }
