...
public final class InternalServiceFault extends CloudWatchException {
    ...
    public static final Schema $SCHEMA = Schemas.INTERNAL_SERVICE_FAULT;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("Message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InternalServiceFault(Builder builder) {
     ...
     *
     * @return a builder for {@link InternalServiceFault}.
     */
    ...
    /**
     * Builder for {@link InternalServiceFault}.
     */
    public static final class Builder implements ShapeBuilder<InternalServiceFault> {
        ...
        @Override
        public InternalServiceFault build() {
            return new InternalServiceFault(this);
        }
