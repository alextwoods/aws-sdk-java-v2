 ...
 *
 * <p>You can target up to 100 specific alarms by name. When a mute rule is active, the targeted alarms continue to
 * evaluate metrics and transition between states, but their configured actions are muted.
 */
@SmithyGenerated
public final class MuteTargets implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.MUTE_TARGETS;
    ...
    private MuteTargets(Builder builder) {
     ...
     *
     * <p>Each alarm name must be between 1 and 255 characters in length. The alarm names must match existing alarms in
    ...
    public boolean equals(Object other) {
        ...
        MuteTargets that = (MuteTargets) other;
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        if (alarmNames != null) {
            serializer.writeList($SCHEMA_ALARM_NAMES, alarmNames, alarmNames.size(), SharedSerde.MuteTargetAlarmNameListSerializer.INSTANCE);
        }
    }
     ...
     *
     * @return a builder for {@link MuteTargets}.
     */
    ...
    /**
     * Builder for {@link MuteTargets}.
     */
    public static final class Builder implements ShapeBuilder<MuteTargets> {
        ...
        @Override
        public MuteTargets build() {
            tracker.validate();
            return new MuteTargets(this);
        }
        ...
        @Override
        public ShapeBuilder<MuteTargets> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.alarmNames(SharedSerde.deserializeMuteTargetAlarmNameList(member, de));
