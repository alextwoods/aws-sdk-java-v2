 ...
 */
@SmithyGenerated
public final class InvalidParameterValueException extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.INVALID_PARAMETER_VALUE_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidParameterValueException(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidParameterValueException}.
     */
    ...
    /**
     * Builder for {@link InvalidParameterValueException}.
     */
    public static final class Builder implements ShapeBuilder<InvalidParameterValueException> {
        ...
        @Override
        public InvalidParameterValueException build() {
            return new InvalidParameterValueException(this);
        }
