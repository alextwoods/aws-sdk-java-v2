...
/**
 * The operation could not be completed because the request conflicts with the current state of the alarm or its
 * underlying scheduled query resource.
 */
@SmithyGenerated
public final class ResourceConflict extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.RESOURCE_CONFLICT;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ResourceConflict(Builder builder) {
     ...
     *
     * @return a builder for {@link ResourceConflict}.
     */
    ...
    /**
     * Builder for {@link ResourceConflict}.
     */
    public static final class Builder implements ShapeBuilder<ResourceConflict> {
        ...
        @Override
        public ResourceConflict build() {
            return new ResourceConflict(this);
        }
