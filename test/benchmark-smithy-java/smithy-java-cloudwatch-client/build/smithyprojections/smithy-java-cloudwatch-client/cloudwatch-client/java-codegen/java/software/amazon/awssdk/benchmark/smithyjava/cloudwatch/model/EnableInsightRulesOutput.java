...
@SmithyGenerated
public final class EnableInsightRulesOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.ENABLE_INSIGHT_RULES_OUTPUT;
    ...
    private EnableInsightRulesOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        EnableInsightRulesOutput that = (EnableInsightRulesOutput) other;
     ...
     *
     * @return a builder for {@link EnableInsightRulesOutput}.
     */
    ...
    /**
     * Builder for {@link EnableInsightRulesOutput}.
     */
    public static final class Builder implements ShapeBuilder<EnableInsightRulesOutput> {
        ...
        @Override
        public EnableInsightRulesOutput build() {
            return new EnableInsightRulesOutput(this);
        }
