 ...
 */
@SmithyGenerated
public final class InvalidNextToken extends CloudWatchException {

    public static final Schema $SCHEMA = Schemas.INVALID_NEXT_TOKEN;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidNextToken(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidNextToken}.
     */
    ...
    /**
     * Builder for {@link InvalidNextToken}.
     */
    public static final class Builder implements ShapeBuilder<InvalidNextToken> {
        ...
        @Override
        public InvalidNextToken build() {
            return new InvalidNextToken(this);
        }
