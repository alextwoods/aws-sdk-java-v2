...
dependencies {
    ...
    implementation("software.amazon.api.models:cloudwatch:1.0.17")
    ...
    // Protocol runtime - awsQuery for CloudWatch
    implementation("software.amazon.smithy.java:aws-client-awsquery:$smithyJavaVersion")
...
afterEvaluate {
    val generated = smithy.getPluginProjectionPath("cloudwatch-client", "java-codegen").get()
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            artifactId = "smithy-java-cloudwatch-client"
            version = "1.0-SNAPSHOT"
        }
    }
}
