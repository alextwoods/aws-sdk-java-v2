 ...
 */
@SmithyGenerated
public final class DeleteTableOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DELETE_TABLE_OUTPUT;
    ...
    private DeleteTableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteTableOutput that = (DeleteTableOutput) other;
     ...
     *
     * @return a builder for {@link DeleteTableOutput}.
     */
    ...
    /**
     * Builder for {@link DeleteTableOutput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteTableOutput> {
        ...
        @Override
        public DeleteTableOutput build() {
            return new DeleteTableOutput(this);
        }
