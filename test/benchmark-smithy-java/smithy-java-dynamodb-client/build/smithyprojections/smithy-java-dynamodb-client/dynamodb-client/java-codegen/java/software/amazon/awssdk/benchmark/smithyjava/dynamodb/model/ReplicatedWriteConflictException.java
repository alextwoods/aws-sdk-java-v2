 ...
 */
@SmithyGenerated
public final class ReplicatedWriteConflictException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.REPLICATED_WRITE_CONFLICT_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ReplicatedWriteConflictException(Builder builder) {
     ...
     *
     * @return a builder for {@link ReplicatedWriteConflictException}.
     */
    ...
    /**
     * Builder for {@link ReplicatedWriteConflictException}.
     */
    public static final class Builder implements ShapeBuilder<ReplicatedWriteConflictException> {
        ...
        @Override
        public ReplicatedWriteConflictException build() {
            return new ReplicatedWriteConflictException(this);
        }
