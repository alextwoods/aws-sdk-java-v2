 ...
 */
@SmithyGenerated
public final class IdempotentParameterMismatchException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.IDEMPOTENT_PARAMETER_MISMATCH_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("Message");

    public static final ShapeId $ID = $SCHEMA.id();

    private IdempotentParameterMismatchException(Builder builder) {
     ...
     *
     * @return a builder for {@link IdempotentParameterMismatchException}.
     */
    ...
    /**
     * Builder for {@link IdempotentParameterMismatchException}.
     */
    public static final class Builder implements ShapeBuilder<IdempotentParameterMismatchException> {
