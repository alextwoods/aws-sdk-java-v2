 ...
 */
@SmithyGenerated
public final class PutItemInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.PUT_ITEM_INPUT;
    ...
    private PutItemInput(Builder builder) {
     ...
     *
     * <p>You must provide all of the attributes for the primary key. For example, with a simple primary key, you only
     * need to provide a value for the partition key. For a composite primary key, you must provide both values for both
     * the partition key and the sort key.
     *
     * <p>If you specify any attributes that are part of an index key, then the data types for those attributes must
     * match those of the schema in the table's attribute definition.
     *
     * <p>If the table has vector indexes, the following validations apply to write operations. A violation of any of
     * these constraints results in a <code>ValidationException</code>:
     *
     * <ul>
     *   <li>
     ...
     *   </li>
     *   <li>
     *     Partition key and inline filter attributes defined in the search schema must have data types matching the
     ...
     *
     * <p>For more information about primary keys, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html#HowItWorks.CoreComponents.PrimaryKey">Primary Key</a> in the <i>Amazon DynamoDB Developer Guide</i>.
     *
     * <p>Each element in the <code>Item</code> map is an <code>AttributeValue</code> object.
     */
     ...
     *
     * <p>The <code>ReturnValues</code> parameter is used by several DynamoDB operations; however, <code>PutItem</code>
     ...
     * </ul>
     *
     * <p>For more information on condition expressions, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html">Condition Expressions</a> in the <i>Amazon DynamoDB
     * Developer Guide</i>.
     */
    ...
    public boolean equals(Object other) {
        ...
        PutItemInput that = (PutItemInput) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_RETURN_VALUES, member, returnValues);
            case 4 -> (T) SchemaUtils.validateSameMember($SCHEMA_RETURN_CONSUMED_CAPACITY, member, returnConsumedCapacity);
            case 5 -> (T) SchemaUtils.validateSameMember($SCHEMA_RETURN_ITEM_COLLECTION_METRICS, member, returnItemCollectionMetrics);
     ...
     *
     * @return a builder for {@link PutItemInput}.
     */
    ...
    /**
     * Builder for {@link PutItemInput}.
     */
    public static final class Builder implements ShapeBuilder<PutItemInput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> returnValues((ReturnValue) SchemaUtils.validateSameMember($SCHEMA_RETURN_VALUES, member, value));
                ...
                case 5 -> returnItemCollectionMetrics((ReturnItemCollectionMetrics) SchemaUtils.validateSameMember($SCHEMA_RETURN_ITEM_COLLECTION_METRICS, member, value));
        ...
        @Override
        public ShapeBuilder<PutItemInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.item(SharedSerde.deserializePutItemInputAttributeMap(member, de));
                    case 2 -> builder.expected(SharedSerde.deserializeExpectedAttributeMap(member, de));
                    case 3 -> builder.returnValues(ReturnValue.builder().deserializeMember(de, member).build());
                    case 4 -> builder.returnConsumedCapacity(ReturnConsumedCapacity.builder().deserializeMember(de, member).build());
                    case 5 -> builder.returnItemCollectionMetrics(ReturnItemCollectionMetrics.builder().deserializeMember(de, member).build());
