 ...
 */
@SmithyGenerated
public final class IndexNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.INDEX_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private IndexNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link IndexNotFoundException}.
     */
    ...
    /**
     * Builder for {@link IndexNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<IndexNotFoundException> {
        ...
        @Override
        public IndexNotFoundException build() {
