 ...
 */
@SmithyGenerated
public final class PutItemOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.PUT_ITEM_OUTPUT;
    ...
    private PutItemOutput(Builder builder) {
    ...
    /**
     * Information about item collections, if any, that were affected by the <code>PutItem</code> operation. <code>
    ...
    public boolean equals(Object other) {
        ...
        PutItemOutput that = (PutItemOutput) other;
     ...
     *
     * @return a builder for {@link PutItemOutput}.
     */
    ...
    /**
     * Builder for {@link PutItemOutput}.
     */
    public static final class Builder implements ShapeBuilder<PutItemOutput> {
        ...
        @Override
        public PutItemOutput build() {
            return new PutItemOutput(this);
        }
