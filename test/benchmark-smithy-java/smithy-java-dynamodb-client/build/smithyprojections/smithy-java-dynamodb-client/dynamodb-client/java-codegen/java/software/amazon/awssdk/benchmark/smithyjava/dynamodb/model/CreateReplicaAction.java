 ...
 */
@SmithyGenerated
public final class CreateReplicaAction implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.CREATE_REPLICA_ACTION;
    ...
    private CreateReplicaAction(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateReplicaAction that = (CreateReplicaAction) other;
     ...
     *
     * @return a builder for {@link CreateReplicaAction}.
     */
    ...
    /**
     * Builder for {@link CreateReplicaAction}.
     */
    public static final class Builder implements ShapeBuilder<CreateReplicaAction> {
        ...
        @Override
        public ShapeBuilder<CreateReplicaAction> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
