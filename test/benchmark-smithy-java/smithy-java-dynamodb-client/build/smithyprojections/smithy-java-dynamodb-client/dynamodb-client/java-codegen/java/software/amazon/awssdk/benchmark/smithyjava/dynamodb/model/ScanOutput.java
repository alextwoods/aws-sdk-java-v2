 ...
 */
@SmithyGenerated
public final class ScanOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.SCAN_OUTPUT;
    ...
    private ScanOutput(Builder builder) {
     ...
     *
     * <p>If you set <code>ScanFilter</code> in the request, then <code>Count</code> is the number of items returned
     * after the filter was applied, and <code>ScannedCount</code> is the number of matching items before the filter was
     * applied.
     *
     * <p>If you did not use a filter in the request, then <code>Count</code> is the same as <code>ScannedCount</code>.
     */
    public int getCount() {
        return count;
    }
     ...
     * information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html#Count">Count and ScannedCount</a> in the <i>Amazon DynamoDB Developer Guide</i>.
     *
    ...
    public boolean equals(Object other) {
        ...
        ScanOutput that = (ScanOutput) other;
     ...
     *
     * @return a builder for {@link ScanOutput}.
     */
    ...
    /**
     * Builder for {@link ScanOutput}.
     */
    public static final class Builder implements ShapeBuilder<ScanOutput> {
        ...
        @Override
        public ScanOutput build() {
            return new ScanOutput(this);
        }
