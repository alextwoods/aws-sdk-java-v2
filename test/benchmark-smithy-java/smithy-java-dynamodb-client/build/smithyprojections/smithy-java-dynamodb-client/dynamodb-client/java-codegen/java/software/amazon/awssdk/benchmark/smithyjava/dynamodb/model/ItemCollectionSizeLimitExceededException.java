 ...
 */
@SmithyGenerated
public final class ItemCollectionSizeLimitExceededException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.ITEM_COLLECTION_SIZE_LIMIT_EXCEEDED_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ItemCollectionSizeLimitExceededException(Builder builder) {
     ...
     *
     * @return a builder for {@link ItemCollectionSizeLimitExceededException}.
     */
    ...
    /**
     * Builder for {@link ItemCollectionSizeLimitExceededException}.
     */
    public static final class Builder implements ShapeBuilder<ItemCollectionSizeLimitExceededException> {
        ...
        @Override
        public ItemCollectionSizeLimitExceededException build() {
            return new ItemCollectionSizeLimitExceededException(this);
        }
