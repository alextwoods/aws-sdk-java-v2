...
@SmithyGenerated
public final class InvalidEndpointException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.INVALID_ENDPOINT_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("Message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidEndpointException(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidEndpointException}.
     */
    ...
    /**
     * Builder for {@link InvalidEndpointException}.
     */
    public static final class Builder implements ShapeBuilder<InvalidEndpointException> {
        ...
        @Override
        public InvalidEndpointException build() {
            return new InvalidEndpointException(this);
        }
