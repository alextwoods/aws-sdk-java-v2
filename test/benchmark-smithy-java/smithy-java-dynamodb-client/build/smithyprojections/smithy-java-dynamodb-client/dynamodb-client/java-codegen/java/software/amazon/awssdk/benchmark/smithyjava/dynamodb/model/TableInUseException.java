 ...
 */
@SmithyGenerated
public final class TableInUseException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.TABLE_IN_USE_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private TableInUseException(Builder builder) {
     ...
     *
     * @return a builder for {@link TableInUseException}.
     */
    ...
    /**
     * Builder for {@link TableInUseException}.
     */
    public static final class Builder implements ShapeBuilder<TableInUseException> {
        ...
        @Override
        public TableInUseException build() {
            return new TableInUseException(this);
        }
