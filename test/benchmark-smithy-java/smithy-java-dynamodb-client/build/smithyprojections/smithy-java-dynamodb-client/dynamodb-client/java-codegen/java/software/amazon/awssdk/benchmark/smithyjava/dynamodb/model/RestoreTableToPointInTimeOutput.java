...
@SmithyGenerated
public final class RestoreTableToPointInTimeOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.RESTORE_TABLE_TO_POINT_IN_TIME_OUTPUT;
    ...
    private RestoreTableToPointInTimeOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        RestoreTableToPointInTimeOutput that = (RestoreTableToPointInTimeOutput) other;
     ...
     *
     * @return a builder for {@link RestoreTableToPointInTimeOutput}.
     */
    ...
    /**
     * Builder for {@link RestoreTableToPointInTimeOutput}.
     */
    public static final class Builder implements ShapeBuilder<RestoreTableToPointInTimeOutput> {
        ...
        @Override
        public RestoreTableToPointInTimeOutput build() {
            return new RestoreTableToPointInTimeOutput(this);
        }
