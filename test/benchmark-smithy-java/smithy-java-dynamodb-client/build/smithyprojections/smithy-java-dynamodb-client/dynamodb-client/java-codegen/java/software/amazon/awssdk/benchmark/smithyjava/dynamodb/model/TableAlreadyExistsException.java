 ...
 */
@SmithyGenerated
public final class TableAlreadyExistsException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.TABLE_ALREADY_EXISTS_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private TableAlreadyExistsException(Builder builder) {
     ...
     *
     * @return a builder for {@link TableAlreadyExistsException}.
     */
    ...
    /**
     * Builder for {@link TableAlreadyExistsException}.
     */
    public static final class Builder implements ShapeBuilder<TableAlreadyExistsException> {
        ...
        @Override
        public TableAlreadyExistsException build() {
            return new TableAlreadyExistsException(this);
        }
