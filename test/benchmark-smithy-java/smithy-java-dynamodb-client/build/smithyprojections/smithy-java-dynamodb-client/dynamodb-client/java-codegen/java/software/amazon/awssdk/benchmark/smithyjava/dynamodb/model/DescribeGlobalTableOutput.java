...
@SmithyGenerated
public final class DescribeGlobalTableOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DESCRIBE_GLOBAL_TABLE_OUTPUT;
    ...
    private DescribeGlobalTableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DescribeGlobalTableOutput that = (DescribeGlobalTableOutput) other;
     ...
     *
     * @return a builder for {@link DescribeGlobalTableOutput}.
     */
    ...
    /**
     * Builder for {@link DescribeGlobalTableOutput}.
     */
    public static final class Builder implements ShapeBuilder<DescribeGlobalTableOutput> {
        ...
        @Override
        public DescribeGlobalTableOutput build() {
            return new DescribeGlobalTableOutput(this);
        }
