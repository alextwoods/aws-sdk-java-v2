 ...
 */
@SmithyGenerated
public final class CreateTableOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.CREATE_TABLE_OUTPUT;
    ...
    private CreateTableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        CreateTableOutput that = (CreateTableOutput) other;
     ...
     *
     * @return a builder for {@link CreateTableOutput}.
     */
    ...
    /**
     * Builder for {@link CreateTableOutput}.
     */
    public static final class Builder implements ShapeBuilder<CreateTableOutput> {
        ...
        @Override
        public CreateTableOutput build() {
            return new CreateTableOutput(this);
        }
