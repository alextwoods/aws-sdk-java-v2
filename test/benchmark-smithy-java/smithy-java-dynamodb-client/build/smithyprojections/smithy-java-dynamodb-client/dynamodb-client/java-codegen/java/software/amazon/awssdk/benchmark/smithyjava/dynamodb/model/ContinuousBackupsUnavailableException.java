 ...
 */
@SmithyGenerated
public final class ContinuousBackupsUnavailableException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.CONTINUOUS_BACKUPS_UNAVAILABLE_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ContinuousBackupsUnavailableException(Builder builder) {
     ...
     *
     * @return a builder for {@link ContinuousBackupsUnavailableException}.
     */
    ...
    /**
     * Builder for {@link ContinuousBackupsUnavailableException}.
     */
    public static final class Builder implements ShapeBuilder<ContinuousBackupsUnavailableException> {
        ...
        @Override
        public ContinuousBackupsUnavailableException build() {
            return new ContinuousBackupsUnavailableException(this);
        }
