 ...
 */
@SmithyGenerated
public final class DeleteItemOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DELETE_ITEM_OUTPUT;
    ...
    private DeleteItemOutput(Builder builder) {
     ...
     * more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/provisioned-capacity-mode.html">Provisioned capacity mode</a> in the <i>Amazon DynamoDB Developer Guide</i>.
     *
    ...
    /**
     * Information about item collections, if any, that were affected by the <code>DeleteItem</code> operation. <code>
    ...
    public boolean equals(Object other) {
        ...
        DeleteItemOutput that = (DeleteItemOutput) other;
     ...
     *
     * @return a builder for {@link DeleteItemOutput}.
     */
    ...
    /**
     * Builder for {@link DeleteItemOutput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteItemOutput> {
        ...
        @Override
        public DeleteItemOutput build() {
            return new DeleteItemOutput(this);
        }
