 ...
 */
@SmithyGenerated
public final class ConditionCheck implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.CONDITION_CHECK;
    ...
    /**
     * A condition that must be satisfied in order for a conditional update to succeed. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.ConditionExpressions.html">
    ...
    /**
     * One or more substitution tokens for attribute names in an expression. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.ExpressionAttributeNames.html">Expression
    ...
    /**
     * One or more values that can be substituted in an expression. For more information, see <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.ConditionExpressions.html">Condition expressions</a>
    ...
    public boolean equals(Object other) {
        ...
        ConditionCheck that = (ConditionCheck) other;
     ...
     *
     * @return a builder for {@link ConditionCheck}.
     */
    ...
    /**
     * Builder for {@link ConditionCheck}.
     */
    public static final class Builder implements ShapeBuilder<ConditionCheck> {
        ...
        public Builder conditionExpression(String conditionExpression) {
            this.conditionExpression = Objects.requireNonNull(conditionExpression, "conditionExpression cannot be null");
            tracker.setMember($SCHEMA_CONDITION_EXPRESSION);
            return this;
        }
        ...
        @Override
        public ShapeBuilder<ConditionCheck> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_CONDITION_EXPRESSION)) {
                conditionExpression("");
            }
            return this;
        }
