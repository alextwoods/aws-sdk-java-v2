...
@SmithyGenerated
public final class UpdateGlobalTableSettingsOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.UPDATE_GLOBAL_TABLE_SETTINGS_OUTPUT;
    ...
    private UpdateGlobalTableSettingsOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateGlobalTableSettingsOutput that = (UpdateGlobalTableSettingsOutput) other;
     ...
     *
     * @return a builder for {@link UpdateGlobalTableSettingsOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateGlobalTableSettingsOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateGlobalTableSettingsOutput> {
        ...
        @Override
        public UpdateGlobalTableSettingsOutput build() {
            return new UpdateGlobalTableSettingsOutput(this);
        }
