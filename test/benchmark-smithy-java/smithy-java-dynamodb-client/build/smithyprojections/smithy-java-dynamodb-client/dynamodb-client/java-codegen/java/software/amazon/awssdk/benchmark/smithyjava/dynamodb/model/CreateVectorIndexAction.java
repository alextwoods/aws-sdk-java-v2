 ...
 */
@SmithyGenerated
public final class CreateVectorIndexAction implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.CREATE_VECTOR_INDEX_ACTION;
    ...
    /**
     * The attribute that contains vector embeddings. If multiple vector indexes reference the same attribute, they must
    ...
    /**
     * The distance function used to calculate similarity. Valid values: <code>COSINE</code>, <code>EUCLIDEAN</code>,
    ...
    public boolean equals(Object other) {
        ...
        CreateVectorIndexAction that = (CreateVectorIndexAction) other;
     ...
     *
     * @return a builder for {@link CreateVectorIndexAction}.
     */
     ...
     */
    public static final class Builder implements ShapeBuilder<CreateVectorIndexAction> {
        ...
        @Override
        public ShapeBuilder<CreateVectorIndexAction> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
