 ...
 */
@SmithyGenerated
public final class DeleteVectorIndexAction implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DELETE_VECTOR_INDEX_ACTION;
    ...
    public boolean equals(Object other) {
        ...
        DeleteVectorIndexAction that = (DeleteVectorIndexAction) other;
     ...
     *
     * @return a builder for {@link DeleteVectorIndexAction}.
     */
     ...
     */
    public static final class Builder implements ShapeBuilder<DeleteVectorIndexAction> {
        ...
        @Override
        public ShapeBuilder<DeleteVectorIndexAction> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
