...
@SmithyGenerated
public final class PutResourcePolicyOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.PUT_RESOURCE_POLICY_OUTPUT;
    ...
    private PutResourcePolicyOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        PutResourcePolicyOutput that = (PutResourcePolicyOutput) other;
     ...
     *
     * @return a builder for {@link PutResourcePolicyOutput}.
     */
    ...
    /**
     * Builder for {@link PutResourcePolicyOutput}.
     */
    public static final class Builder implements ShapeBuilder<PutResourcePolicyOutput> {
        ...
        @Override
        public PutResourcePolicyOutput build() {
            return new PutResourcePolicyOutput(this);
        }
