 ...
 */
@SmithyGenerated
public final class AutoScalingTargetTrackingScalingPolicyConfigurationUpdate implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.AUTO_SCALING_TARGET_TRACKING_SCALING_POLICY_CONFIGURATION_UPDATE;
    ...
    private AutoScalingTargetTrackingScalingPolicyConfigurationUpdate(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        AutoScalingTargetTrackingScalingPolicyConfigurationUpdate that = (AutoScalingTargetTrackingScalingPolicyConfigurationUpdate) other;
     ...
     *
     * @return a builder for {@link AutoScalingTargetTrackingScalingPolicyConfigurationUpdate}.
     */
    ...
    /**
     * Builder for {@link AutoScalingTargetTrackingScalingPolicyConfigurationUpdate}.
     */
    public static final class Builder implements ShapeBuilder<AutoScalingTargetTrackingScalingPolicyConfigurationUpdate> {
        ...
        @Override
        public ShapeBuilder<AutoScalingTargetTrackingScalingPolicyConfigurationUpdate> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
