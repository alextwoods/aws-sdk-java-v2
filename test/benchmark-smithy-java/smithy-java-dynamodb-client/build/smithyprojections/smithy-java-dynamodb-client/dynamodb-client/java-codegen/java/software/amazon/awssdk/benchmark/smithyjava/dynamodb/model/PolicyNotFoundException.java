 ...
 *
 * <p>If you specified an <code>ExpectedRevisionId</code>, it's possible that a policy is present for the resource but
 * its revision ID didn't match the expected value.
 */
@SmithyGenerated
public final class PolicyNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.POLICY_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private PolicyNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link PolicyNotFoundException}.
     */
    ...
    /**
     * Builder for {@link PolicyNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<PolicyNotFoundException> {
        ...
        @Override
        public PolicyNotFoundException build() {
            return new PolicyNotFoundException(this);
        }
