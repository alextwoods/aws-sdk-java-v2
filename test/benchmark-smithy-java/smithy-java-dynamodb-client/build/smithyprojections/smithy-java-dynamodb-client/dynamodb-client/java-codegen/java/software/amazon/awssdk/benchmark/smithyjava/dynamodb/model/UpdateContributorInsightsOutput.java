...
@SmithyGenerated
public final class UpdateContributorInsightsOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.UPDATE_CONTRIBUTOR_INSIGHTS_OUTPUT;
    ...
    private UpdateContributorInsightsOutput(Builder builder) {
    ...
    /**
     * The updated mode of CloudWatch Contributor Insights that determines whether to monitor all access and throttled
     * events or to track throttled events exclusively.
     */
    ...
    public boolean equals(Object other) {
        ...
        UpdateContributorInsightsOutput that = (UpdateContributorInsightsOutput) other;
     ...
     *
     * @return a builder for {@link UpdateContributorInsightsOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateContributorInsightsOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateContributorInsightsOutput> {
        ...
        @Override
        public UpdateContributorInsightsOutput build() {
            return new UpdateContributorInsightsOutput(this);
        }
