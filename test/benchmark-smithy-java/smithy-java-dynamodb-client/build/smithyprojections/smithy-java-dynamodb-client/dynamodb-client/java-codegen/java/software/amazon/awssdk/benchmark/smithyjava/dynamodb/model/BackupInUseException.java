 ...
 */
@SmithyGenerated
public final class BackupInUseException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.BACKUP_IN_USE_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private BackupInUseException(Builder builder) {
     ...
     *
     * @return a builder for {@link BackupInUseException}.
     */
    ...
    /**
     * Builder for {@link BackupInUseException}.
     */
    public static final class Builder implements ShapeBuilder<BackupInUseException> {
        ...
        @Override
        public BackupInUseException build() {
            return new BackupInUseException(this);
        }
