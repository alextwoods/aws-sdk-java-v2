 ...
 */
@SmithyGenerated
public final class DescribeTableInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DESCRIBE_TABLE_INPUT;
    ...
    private DescribeTableInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DescribeTableInput that = (DescribeTableInput) other;
     ...
     *
     * @return a builder for {@link DescribeTableInput}.
     */
    ...
    /**
     * Builder for {@link DescribeTableInput}.
     */
    public static final class Builder implements ShapeBuilder<DescribeTableInput> {
        ...
        @Override
        public DescribeTableInput build() {
            tracker.validate();
            return new DescribeTableInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DescribeTableInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
