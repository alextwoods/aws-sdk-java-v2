 ...
 * the ARN of the impacted resource, find the <a href="https://docs.aws.amazon.com/amazondynamodb/latest/APIReference/API_ThrottlingReason.html">ThrottlingReason</a> field in the returned exception. The Amazon Web
 ...
 * backoff. For more information, go to <a href="https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Programming.Errors.html#Programming.Errors.RetryAndBackoff">Error Retries and Exponential Backoff</a> in the <i>Amazon DynamoDB Developer
 * Guide</i>.
 */
@SmithyGenerated
public final class ProvisionedThroughputExceededException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.PROVISIONED_THROUGHPUT_EXCEEDED_EXCEPTION;
    ...
    private ProvisionedThroughputExceededException(Builder builder) {
     ...
     *
     * @return a builder for {@link ProvisionedThroughputExceededException}.
     */
    ...
    /**
     * Builder for {@link ProvisionedThroughputExceededException}.
     */
    public static final class Builder implements ShapeBuilder<ProvisionedThroughputExceededException> {
