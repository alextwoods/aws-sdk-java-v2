 ...
 */
@SmithyGenerated
public final class ThrottlingException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.THROTTLING_EXCEPTION;
    ...
    private ThrottlingException(Builder builder) {
     ...
     *
     * @return a builder for {@link ThrottlingException}.
     */
    ...
    /**
     * Builder for {@link ThrottlingException}.
     */
    public static final class Builder implements ShapeBuilder<ThrottlingException> {
