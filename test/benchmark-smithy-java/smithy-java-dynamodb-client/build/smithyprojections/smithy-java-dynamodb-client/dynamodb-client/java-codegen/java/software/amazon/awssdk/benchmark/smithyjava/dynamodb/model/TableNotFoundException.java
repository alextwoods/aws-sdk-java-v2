 ...
 */
@SmithyGenerated
public final class TableNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.TABLE_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private TableNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link TableNotFoundException}.
     */
    ...
    /**
     * Builder for {@link TableNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<TableNotFoundException> {
        ...
        @Override
        public TableNotFoundException build() {
