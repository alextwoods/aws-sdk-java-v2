...
@SmithyGenerated
public final class UpdateGlobalTableOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.UPDATE_GLOBAL_TABLE_OUTPUT;
    ...
    private UpdateGlobalTableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateGlobalTableOutput that = (UpdateGlobalTableOutput) other;
     ...
     *
     * @return a builder for {@link UpdateGlobalTableOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateGlobalTableOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateGlobalTableOutput> {
        ...
        @Override
        public UpdateGlobalTableOutput build() {
            return new UpdateGlobalTableOutput(this);
        }
