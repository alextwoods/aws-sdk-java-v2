 ...
 */
@SmithyGenerated
public final class TransactionConflictException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.TRANSACTION_CONFLICT_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private TransactionConflictException(Builder builder) {
     ...
     *
     * @return a builder for {@link TransactionConflictException}.
     */
    ...
    /**
     * Builder for {@link TransactionConflictException}.
     */
    public static final class Builder implements ShapeBuilder<TransactionConflictException> {
        ...
        @Override
        public TransactionConflictException build() {
            return new TransactionConflictException(this);
        }
