 ...
 */
@SmithyGenerated
public final class DescribeGlobalTable implements ApiOperation<DescribeGlobalTableInput, DescribeGlobalTableOutput> {

    private static final DescribeGlobalTable $INSTANCE = new DescribeGlobalTable();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.dynamodb#DescribeGlobalTable"));
     ...
     */
    public static DescribeGlobalTable instance() {
        return $INSTANCE;
    }

    private DescribeGlobalTable() {}

    @Override
    public ShapeBuilder<DescribeGlobalTableInput> inputBuilder() {
        return DescribeGlobalTableInput.builder();
    }

    @Override
    public ShapeBuilder<DescribeGlobalTableOutput> outputBuilder() {
        return DescribeGlobalTableOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return DescribeGlobalTableInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return DescribeGlobalTableOutput.$SCHEMA;
    }
