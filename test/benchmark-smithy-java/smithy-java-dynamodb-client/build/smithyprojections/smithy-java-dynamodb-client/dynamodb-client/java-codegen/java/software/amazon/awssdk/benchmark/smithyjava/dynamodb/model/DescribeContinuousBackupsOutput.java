...
@SmithyGenerated
public final class DescribeContinuousBackupsOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DESCRIBE_CONTINUOUS_BACKUPS_OUTPUT;
    ...
    private DescribeContinuousBackupsOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DescribeContinuousBackupsOutput that = (DescribeContinuousBackupsOutput) other;
     ...
     *
     * @return a builder for {@link DescribeContinuousBackupsOutput}.
     */
    ...
    /**
     * Builder for {@link DescribeContinuousBackupsOutput}.
     */
    public static final class Builder implements ShapeBuilder<DescribeContinuousBackupsOutput> {
        ...
        @Override
        public DescribeContinuousBackupsOutput build() {
            return new DescribeContinuousBackupsOutput(this);
        }
