 ...
 */
@SmithyGenerated
public final class GlobalTableNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.GLOBAL_TABLE_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private GlobalTableNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link GlobalTableNotFoundException}.
     */
    ...
    /**
     * Builder for {@link GlobalTableNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<GlobalTableNotFoundException> {
        ...
        @Override
        public GlobalTableNotFoundException build() {
            return new GlobalTableNotFoundException(this);
        }
