 ...
 */
@SmithyGenerated
public final class ReplicaAlreadyExistsException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.REPLICA_ALREADY_EXISTS_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ReplicaAlreadyExistsException(Builder builder) {
     ...
     *
     * @return a builder for {@link ReplicaAlreadyExistsException}.
     */
    ...
    /**
     * Builder for {@link ReplicaAlreadyExistsException}.
     */
    public static final class Builder implements ShapeBuilder<ReplicaAlreadyExistsException> {
        ...
        @Override
        public ReplicaAlreadyExistsException build() {
            return new ReplicaAlreadyExistsException(this);
        }
