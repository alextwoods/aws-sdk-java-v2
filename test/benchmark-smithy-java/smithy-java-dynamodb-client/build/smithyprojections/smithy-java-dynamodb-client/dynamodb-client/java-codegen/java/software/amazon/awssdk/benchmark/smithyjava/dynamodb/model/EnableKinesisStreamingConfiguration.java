 ...
 */
@SmithyGenerated
public final class EnableKinesisStreamingConfiguration implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.ENABLE_KINESIS_STREAMING_CONFIGURATION;
    ...
    private EnableKinesisStreamingConfiguration(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        EnableKinesisStreamingConfiguration that = (EnableKinesisStreamingConfiguration) other;
     ...
     *
     * @return a builder for {@link EnableKinesisStreamingConfiguration}.
     */
    ...
    /**
     * Builder for {@link EnableKinesisStreamingConfiguration}.
     */
    public static final class Builder implements ShapeBuilder<EnableKinesisStreamingConfiguration> {
        ...
        @Override
        public EnableKinesisStreamingConfiguration build() {
            return new EnableKinesisStreamingConfiguration(this);
        }
