 ...
 */
@SmithyGenerated
public final class InvalidRestoreTimeException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.INVALID_RESTORE_TIME_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidRestoreTimeException(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidRestoreTimeException}.
     */
    ...
    /**
     * Builder for {@link InvalidRestoreTimeException}.
     */
    public static final class Builder implements ShapeBuilder<InvalidRestoreTimeException> {
        ...
        @Override
        public InvalidRestoreTimeException build() {
            return new InvalidRestoreTimeException(this);
        }
