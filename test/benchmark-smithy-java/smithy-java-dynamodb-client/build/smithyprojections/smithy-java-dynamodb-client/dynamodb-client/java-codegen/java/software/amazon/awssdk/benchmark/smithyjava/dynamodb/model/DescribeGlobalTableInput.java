...
@SmithyGenerated
public final class DescribeGlobalTableInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DESCRIBE_GLOBAL_TABLE_INPUT;
    ...
    private DescribeGlobalTableInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DescribeGlobalTableInput that = (DescribeGlobalTableInput) other;
     ...
     *
     * @return a builder for {@link DescribeGlobalTableInput}.
     */
    ...
    /**
     * Builder for {@link DescribeGlobalTableInput}.
     */
    public static final class Builder implements ShapeBuilder<DescribeGlobalTableInput> {
        ...
        @Override
        public DescribeGlobalTableInput build() {
            tracker.validate();
            return new DescribeGlobalTableInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DescribeGlobalTableInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
