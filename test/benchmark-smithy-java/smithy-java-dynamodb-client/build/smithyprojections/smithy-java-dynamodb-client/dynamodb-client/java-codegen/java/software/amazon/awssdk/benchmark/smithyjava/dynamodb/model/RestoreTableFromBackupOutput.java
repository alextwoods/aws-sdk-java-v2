...
@SmithyGenerated
public final class RestoreTableFromBackupOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.RESTORE_TABLE_FROM_BACKUP_OUTPUT;
    ...
    private RestoreTableFromBackupOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        RestoreTableFromBackupOutput that = (RestoreTableFromBackupOutput) other;
     ...
     *
     * @return a builder for {@link RestoreTableFromBackupOutput}.
     */
    ...
    /**
     * Builder for {@link RestoreTableFromBackupOutput}.
     */
    public static final class Builder implements ShapeBuilder<RestoreTableFromBackupOutput> {
        ...
        @Override
        public RestoreTableFromBackupOutput build() {
            return new RestoreTableFromBackupOutput(this);
        }
