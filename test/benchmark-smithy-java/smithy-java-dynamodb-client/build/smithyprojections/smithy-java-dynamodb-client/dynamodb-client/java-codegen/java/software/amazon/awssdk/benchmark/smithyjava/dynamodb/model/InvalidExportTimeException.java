 ...
 */
@SmithyGenerated
public final class InvalidExportTimeException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.INVALID_EXPORT_TIME_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidExportTimeException(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidExportTimeException}.
     */
    ...
    /**
     * Builder for {@link InvalidExportTimeException}.
     */
    public static final class Builder implements ShapeBuilder<InvalidExportTimeException> {
        ...
        @Override
        public InvalidExportTimeException build() {
            return new InvalidExportTimeException(this);
        }
