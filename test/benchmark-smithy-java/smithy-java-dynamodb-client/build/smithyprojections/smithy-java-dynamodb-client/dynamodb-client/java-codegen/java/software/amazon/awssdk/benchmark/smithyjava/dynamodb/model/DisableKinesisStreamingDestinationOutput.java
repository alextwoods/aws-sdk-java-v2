...
@SmithyGenerated
public final class DisableKinesisStreamingDestinationOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DISABLE_KINESIS_STREAMING_DESTINATION_OUTPUT;
    ...
    private DisableKinesisStreamingDestinationOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DisableKinesisStreamingDestinationOutput that = (DisableKinesisStreamingDestinationOutput) other;
     ...
     *
     * @return a builder for {@link DisableKinesisStreamingDestinationOutput}.
     */
    ...
    /**
     * Builder for {@link DisableKinesisStreamingDestinationOutput}.
     */
    public static final class Builder implements ShapeBuilder<DisableKinesisStreamingDestinationOutput> {
        ...
        @Override
        public DisableKinesisStreamingDestinationOutput build() {
            return new DisableKinesisStreamingDestinationOutput(this);
        }
