 ...
 */
@SmithyGenerated
public final class ExportConflictException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.EXPORT_CONFLICT_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ExportConflictException(Builder builder) {
     ...
     *
     * @return a builder for {@link ExportConflictException}.
     */
    ...
    /**
     * Builder for {@link ExportConflictException}.
     */
    public static final class Builder implements ShapeBuilder<ExportConflictException> {
        ...
        @Override
        public ExportConflictException build() {
            return new ExportConflictException(this);
        }
