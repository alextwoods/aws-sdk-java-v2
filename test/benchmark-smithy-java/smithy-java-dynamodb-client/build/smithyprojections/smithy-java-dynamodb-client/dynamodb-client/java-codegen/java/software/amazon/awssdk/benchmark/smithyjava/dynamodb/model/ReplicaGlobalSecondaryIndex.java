 ...
 */
@SmithyGenerated
public final class ReplicaGlobalSecondaryIndex implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.REPLICA_GLOBAL_SECONDARY_INDEX;
    ...
    private ReplicaGlobalSecondaryIndex(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ReplicaGlobalSecondaryIndex that = (ReplicaGlobalSecondaryIndex) other;
     ...
     *
     * @return a builder for {@link ReplicaGlobalSecondaryIndex}.
     */
    ...
    /**
     * Builder for {@link ReplicaGlobalSecondaryIndex}.
     */
    public static final class Builder implements ShapeBuilder<ReplicaGlobalSecondaryIndex> {
        ...
        @Override
        public ShapeBuilder<ReplicaGlobalSecondaryIndex> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
