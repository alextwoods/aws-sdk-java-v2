...
@SmithyGenerated
public final class ExecuteTransactionOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.EXECUTE_TRANSACTION_OUTPUT;
    ...
    private ExecuteTransactionOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ExecuteTransactionOutput that = (ExecuteTransactionOutput) other;
     ...
     *
     * @return a builder for {@link ExecuteTransactionOutput}.
     */
    ...
    /**
     * Builder for {@link ExecuteTransactionOutput}.
     */
    public static final class Builder implements ShapeBuilder<ExecuteTransactionOutput> {
        ...
        @Override
        public ExecuteTransactionOutput build() {
            return new ExecuteTransactionOutput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> responses((List<ItemResponse>) SchemaUtils.validateSameMember($SCHEMA_RESPONSES, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.responses(SharedSerde.deserializeItemResponseList(member, de));
