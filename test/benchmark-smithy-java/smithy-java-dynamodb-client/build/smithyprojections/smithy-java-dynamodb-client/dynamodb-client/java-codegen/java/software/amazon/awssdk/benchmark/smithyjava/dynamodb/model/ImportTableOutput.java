...
@SmithyGenerated
public final class ImportTableOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.IMPORT_TABLE_OUTPUT;
    ...
    private ImportTableOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ImportTableOutput that = (ImportTableOutput) other;
     ...
     *
     * @return a builder for {@link ImportTableOutput}.
     */
    ...
    /**
     * Builder for {@link ImportTableOutput}.
     */
    public static final class Builder implements ShapeBuilder<ImportTableOutput> {
        ...
        @Override
        public ImportTableOutput build() {
            tracker.validate();
            return new ImportTableOutput(this);
        }
        ...
        @Override
        public ShapeBuilder<ImportTableOutput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
