 ...
 */
@SmithyGenerated
public final class DeleteReplicaAction implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DELETE_REPLICA_ACTION;
    ...
    private DeleteReplicaAction(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteReplicaAction that = (DeleteReplicaAction) other;
     ...
     *
     * @return a builder for {@link DeleteReplicaAction}.
     */
    ...
    /**
     * Builder for {@link DeleteReplicaAction}.
     */
    public static final class Builder implements ShapeBuilder<DeleteReplicaAction> {
        ...
        @Override
        public DeleteReplicaAction build() {
            tracker.validate();
            return new DeleteReplicaAction(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteReplicaAction> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
