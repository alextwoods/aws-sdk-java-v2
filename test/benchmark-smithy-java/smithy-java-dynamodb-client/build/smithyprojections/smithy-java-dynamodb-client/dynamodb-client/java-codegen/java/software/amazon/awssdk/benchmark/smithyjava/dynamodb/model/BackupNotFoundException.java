 ...
 */
@SmithyGenerated
public final class BackupNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.BACKUP_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private BackupNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link BackupNotFoundException}.
     */
    ...
    /**
     * Builder for {@link BackupNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<BackupNotFoundException> {
        ...
        @Override
        public BackupNotFoundException build() {
            return new BackupNotFoundException(this);
        }
