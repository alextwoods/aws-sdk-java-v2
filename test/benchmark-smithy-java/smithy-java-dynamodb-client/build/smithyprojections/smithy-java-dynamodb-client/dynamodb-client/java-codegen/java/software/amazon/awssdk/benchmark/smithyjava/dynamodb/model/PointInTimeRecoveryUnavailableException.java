 ...
 */
@SmithyGenerated
public final class PointInTimeRecoveryUnavailableException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.POINT_IN_TIME_RECOVERY_UNAVAILABLE_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private PointInTimeRecoveryUnavailableException(Builder builder) {
     ...
     *
     * @return a builder for {@link PointInTimeRecoveryUnavailableException}.
     */
    ...
    /**
     * Builder for {@link PointInTimeRecoveryUnavailableException}.
     */
    public static final class Builder implements ShapeBuilder<PointInTimeRecoveryUnavailableException> {
        ...
        @Override
        public PointInTimeRecoveryUnavailableException build() {
            return new PointInTimeRecoveryUnavailableException(this);
        }
