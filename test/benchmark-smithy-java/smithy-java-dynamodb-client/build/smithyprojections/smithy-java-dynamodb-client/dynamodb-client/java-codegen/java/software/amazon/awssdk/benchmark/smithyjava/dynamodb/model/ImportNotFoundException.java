 ...
 */
@SmithyGenerated
public final class ImportNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.IMPORT_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ImportNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link ImportNotFoundException}.
     */
    ...
    /**
     * Builder for {@link ImportNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<ImportNotFoundException> {
        ...
        @Override
        public ImportNotFoundException build() {
            return new ImportNotFoundException(this);
        }
