...
@SmithyGenerated
public final class ExportTableToPointInTimeOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.EXPORT_TABLE_TO_POINT_IN_TIME_OUTPUT;
    ...
    private ExportTableToPointInTimeOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ExportTableToPointInTimeOutput that = (ExportTableToPointInTimeOutput) other;
     ...
     *
     * @return a builder for {@link ExportTableToPointInTimeOutput}.
     */
    ...
    /**
     * Builder for {@link ExportTableToPointInTimeOutput}.
     */
    public static final class Builder implements ShapeBuilder<ExportTableToPointInTimeOutput> {
        ...
        @Override
        public ExportTableToPointInTimeOutput build() {
            return new ExportTableToPointInTimeOutput(this);
        }
