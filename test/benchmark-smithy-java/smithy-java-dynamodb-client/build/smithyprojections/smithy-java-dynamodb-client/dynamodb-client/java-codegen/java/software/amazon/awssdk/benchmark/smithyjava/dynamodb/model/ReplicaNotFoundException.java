 ...
 */
@SmithyGenerated
public final class ReplicaNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.REPLICA_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ReplicaNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link ReplicaNotFoundException}.
     */
    ...
    /**
     * Builder for {@link ReplicaNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<ReplicaNotFoundException> {
        ...
        @Override
        public ReplicaNotFoundException build() {
            return new ReplicaNotFoundException(this);
        }
