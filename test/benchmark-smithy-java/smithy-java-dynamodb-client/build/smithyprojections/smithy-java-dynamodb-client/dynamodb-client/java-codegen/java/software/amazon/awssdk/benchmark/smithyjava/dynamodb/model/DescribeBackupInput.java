...
@SmithyGenerated
public final class DescribeBackupInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DESCRIBE_BACKUP_INPUT;
    ...
    private DescribeBackupInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DescribeBackupInput that = (DescribeBackupInput) other;
     ...
     *
     * @return a builder for {@link DescribeBackupInput}.
     */
    ...
    /**
     * Builder for {@link DescribeBackupInput}.
     */
    public static final class Builder implements ShapeBuilder<DescribeBackupInput> {
        ...
        @Override
        public DescribeBackupInput build() {
            tracker.validate();
            return new DescribeBackupInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DescribeBackupInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
