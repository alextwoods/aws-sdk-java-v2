 ...
 */
@SmithyGenerated
public final class DeleteGlobalSecondaryIndexAction implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.DELETE_GLOBAL_SECONDARY_INDEX_ACTION;
    ...
    private DeleteGlobalSecondaryIndexAction(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteGlobalSecondaryIndexAction that = (DeleteGlobalSecondaryIndexAction) other;
     ...
     *
     * @return a builder for {@link DeleteGlobalSecondaryIndexAction}.
     */
    ...
    /**
     * Builder for {@link DeleteGlobalSecondaryIndexAction}.
     */
    public static final class Builder implements ShapeBuilder<DeleteGlobalSecondaryIndexAction> {
        ...
        @Override
        public ShapeBuilder<DeleteGlobalSecondaryIndexAction> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
