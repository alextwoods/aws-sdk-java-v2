...
@SmithyGenerated
public final class EnableKinesisStreamingDestinationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.ENABLE_KINESIS_STREAMING_DESTINATION_INPUT;
    ...
    private EnableKinesisStreamingDestinationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        EnableKinesisStreamingDestinationInput that = (EnableKinesisStreamingDestinationInput) other;
     ...
     *
     * @return a builder for {@link EnableKinesisStreamingDestinationInput}.
     */
    ...
    /**
     * Builder for {@link EnableKinesisStreamingDestinationInput}.
     */
    public static final class Builder implements ShapeBuilder<EnableKinesisStreamingDestinationInput> {
        ...
        @Override
        public EnableKinesisStreamingDestinationInput build() {
            tracker.validate();
            return new EnableKinesisStreamingDestinationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<EnableKinesisStreamingDestinationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
