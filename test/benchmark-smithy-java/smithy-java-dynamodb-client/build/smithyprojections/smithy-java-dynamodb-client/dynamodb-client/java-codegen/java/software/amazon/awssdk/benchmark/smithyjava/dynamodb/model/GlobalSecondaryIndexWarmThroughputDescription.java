 ...
 */
@SmithyGenerated
public final class GlobalSecondaryIndexWarmThroughputDescription implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.GLOBAL_SECONDARY_INDEX_WARM_THROUGHPUT_DESCRIPTION;
    ...
    private final transient IndexStatus status;

    private GlobalSecondaryIndexWarmThroughputDescription(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GlobalSecondaryIndexWarmThroughputDescription that = (GlobalSecondaryIndexWarmThroughputDescription) other;
     ...
     *
     * @return a builder for {@link GlobalSecondaryIndexWarmThroughputDescription}.
     */
    ...
    /**
     * Builder for {@link GlobalSecondaryIndexWarmThroughputDescription}.
     */
    public static final class Builder implements ShapeBuilder<GlobalSecondaryIndexWarmThroughputDescription> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> status((IndexStatus) SchemaUtils.validateSameMember($SCHEMA_STATUS, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.status(IndexStatus.builder().deserializeMember(de, member).build());
