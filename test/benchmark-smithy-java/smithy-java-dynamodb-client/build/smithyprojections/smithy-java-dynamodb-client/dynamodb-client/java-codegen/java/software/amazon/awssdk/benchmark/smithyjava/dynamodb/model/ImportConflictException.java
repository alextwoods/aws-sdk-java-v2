 ...
 */
@SmithyGenerated
public final class ImportConflictException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.IMPORT_CONFLICT_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ImportConflictException(Builder builder) {
     ...
     *
     * @return a builder for {@link ImportConflictException}.
     */
    ...
    /**
     * Builder for {@link ImportConflictException}.
     */
    public static final class Builder implements ShapeBuilder<ImportConflictException> {
        ...
        @Override
        public ImportConflictException build() {
            return new ImportConflictException(this);
        }
