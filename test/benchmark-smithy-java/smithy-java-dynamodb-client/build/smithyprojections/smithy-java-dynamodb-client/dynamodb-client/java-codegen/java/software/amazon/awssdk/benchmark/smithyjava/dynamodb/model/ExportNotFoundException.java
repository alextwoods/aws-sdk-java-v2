 ...
 */
@SmithyGenerated
public final class ExportNotFoundException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.EXPORT_NOT_FOUND_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private ExportNotFoundException(Builder builder) {
     ...
     *
     * @return a builder for {@link ExportNotFoundException}.
     */
    ...
    /**
     * Builder for {@link ExportNotFoundException}.
     */
    public static final class Builder implements ShapeBuilder<ExportNotFoundException> {
        ...
        @Override
        public ExportNotFoundException build() {
            return new ExportNotFoundException(this);
        }
