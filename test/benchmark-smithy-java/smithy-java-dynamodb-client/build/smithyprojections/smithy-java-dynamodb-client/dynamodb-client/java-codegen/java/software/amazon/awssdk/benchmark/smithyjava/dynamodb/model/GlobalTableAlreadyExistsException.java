 ...
 */
@SmithyGenerated
public final class GlobalTableAlreadyExistsException extends DynamoDBException {

    public static final Schema $SCHEMA = Schemas.GLOBAL_TABLE_ALREADY_EXISTS_EXCEPTION;
    private static final Schema $SCHEMA_MESSAGE = $SCHEMA.member("message");

    public static final ShapeId $ID = $SCHEMA.id();

    private GlobalTableAlreadyExistsException(Builder builder) {
     ...
     *
     * @return a builder for {@link GlobalTableAlreadyExistsException}.
     */
    ...
    /**
     * Builder for {@link GlobalTableAlreadyExistsException}.
     */
    public static final class Builder implements ShapeBuilder<GlobalTableAlreadyExistsException> {
        ...
        @Override
        public GlobalTableAlreadyExistsException build() {
            return new GlobalTableAlreadyExistsException(this);
        }
