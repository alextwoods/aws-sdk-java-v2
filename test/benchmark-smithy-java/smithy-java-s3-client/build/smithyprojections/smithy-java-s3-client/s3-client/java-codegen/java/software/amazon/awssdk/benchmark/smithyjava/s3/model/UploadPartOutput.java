...
@SmithyGenerated
public final class UploadPartOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas7.UPLOAD_PART_OUTPUT;
    ...
    /**
     * The Base64 encoded, 32-bit <code>CRC32</code> checksum of the part. This will only be present if the checksum was
     * provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 32-bit <code>CRC32C</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 64-bit <code>CRC64NVME</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 160-bit <code>SHA1</code> checksum of the part. This will only be present if the checksum was
     * provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 256-bit <code>SHA256</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 512-bit <code>SHA512</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 128-bit <code>MD5</code> checksum of the part. This will only be present if the checksum was
     * provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 64-bit <code>XXHASH64</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 64-bit <code>XXHASH3</code> checksum of the part. This will only be present if the checksum
     * was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon S3 User
     * Guide</i>.
     */
    ...
    /**
     * The Base64 encoded, 128-bit <code>XXHASH128</code> checksum of the part. This will only be present if the
     * checksum was provided in the request. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a> in the <i>Amazon
     * S3 User Guide</i>.
     */
    ...
    public boolean equals(Object other) {
        ...
        UploadPartOutput that = (UploadPartOutput) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            case 0 -> (T) SchemaUtils.validateSameMember($SCHEMA_SERVER_SIDE_ENCRYPTION, member, serverSideEncryption);
            ...
            case 12 -> (T) SchemaUtils.validateSameMember($SCHEMA_SSE_CUSTOMER_ALGORITHM, member, sseCustomerAlgorithm);
            case 13 -> (T) SchemaUtils.validateSameMember($SCHEMA_SSE_CUSTOMER_KEYM_D5, member, sseCustomerKeymD5);
            case 14 -> (T) SchemaUtils.validateSameMember($SCHEMA_SSEKMS_KEY_ID, member, ssekmsKeyId);
            case 15 -> (T) SchemaUtils.validateSameMember($SCHEMA_BUCKET_KEY_ENABLED, member, bucketKeyEnabled);
     ...
     *
     * @return a builder for {@link UploadPartOutput}.
     */
    ...
    /**
     * Builder for {@link UploadPartOutput}.
     */
    public static final class Builder implements ShapeBuilder<UploadPartOutput> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> serverSideEncryption((ServerSideEncryption) SchemaUtils.validateSameMember($SCHEMA_SERVER_SIDE_ENCRYPTION, member, value));
                ...
                case 12 -> sseCustomerAlgorithm((String) SchemaUtils.validateSameMember($SCHEMA_SSE_CUSTOMER_ALGORITHM, member, value));
                case 13 -> sseCustomerKeymD5((String) SchemaUtils.validateSameMember($SCHEMA_SSE_CUSTOMER_KEYM_D5, member, value));
                case 14 -> ssekmsKeyId((String) SchemaUtils.validateSameMember($SCHEMA_SSEKMS_KEY_ID, member, value));
                case 15 -> bucketKeyEnabled((Boolean) SchemaUtils.validateSameMember($SCHEMA_BUCKET_KEY_ENABLED, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.serverSideEncryption(ServerSideEncryption.builder().deserializeMember(de, member).build());
                    ...
                    case 12 -> builder.sseCustomerAlgorithm(de.readString(member));
                    case 13 -> builder.sseCustomerKeymD5(de.readString(member));
                    case 14 -> builder.ssekmsKeyId(de.readString(member));
                    case 15 -> builder.bucketKeyEnabled(de.readBoolean(member));
