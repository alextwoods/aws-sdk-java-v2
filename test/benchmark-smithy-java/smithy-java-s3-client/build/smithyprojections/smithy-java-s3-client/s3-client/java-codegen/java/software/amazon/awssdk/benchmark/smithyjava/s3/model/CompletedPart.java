 ...
 */
@SmithyGenerated
public final class CompletedPart implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas.COMPLETED_PART;
     ...
     *     x-amz-checksum-sha1</code>, or <code>x-amz-checksum-sha256</code>) is applied to each part, the <code>
     *     PartNumber</code> must start at 1 and the part numbers must be consecutive. Otherwise, Amazon S3
    ...
    public boolean equals(Object other) {
        ...
        CompletedPart that = (CompletedPart) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C32, member, checksumcrC32);
            case 2 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C32_C, member, checksumcrC32C);
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C64NVM_E, member, checksumcrC64nvmE);
            case 4 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A1, member, checksumshA1);
            case 5 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A256, member, checksumshA256);
            case 6 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A512, member, checksumshA512);
            case 7 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMM_D5, member, checksummD5);
            case 8 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H64, member, checksumxxhasH64);
            case 9 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H3, member, checksumxxhasH3);
            case 10 -> (T) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H128, member, checksumxxhasH128);
            case 11 -> (T) SchemaUtils.validateSameMember($SCHEMA_PART_NUMBER, member, partNumber);
     ...
     *
     * @return a builder for {@link CompletedPart}.
     */
     ...
     */
    public static final class Builder implements ShapeBuilder<CompletedPart> {
        private String eTag;
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> checksumcrC32((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C32, member, value));
                case 2 -> checksumcrC32C((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C32_C, member, value));
                case 3 -> checksumcrC64nvmE((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMCR_C64NVM_E, member, value));
                case 4 -> checksumshA1((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A1, member, value));
                case 5 -> checksumshA256((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A256, member, value));
                case 6 -> checksumshA512((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMSH_A512, member, value));
                case 7 -> checksummD5((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMM_D5, member, value));
                case 8 -> checksumxxhasH64((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H64, member, value));
                case 9 -> checksumxxhasH3((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H3, member, value));
                case 10 -> checksumxxhasH128((String) SchemaUtils.validateSameMember($SCHEMA_CHECKSUMXXHAS_H128, member, value));
                case 11 -> partNumber((Integer) SchemaUtils.validateSameMember($SCHEMA_PART_NUMBER, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.checksumcrC32(de.readString(member));
                    case 2 -> builder.checksumcrC32C(de.readString(member));
                    case 3 -> builder.checksumcrC64nvmE(de.readString(member));
                    case 4 -> builder.checksumshA1(de.readString(member));
                    case 5 -> builder.checksumshA256(de.readString(member));
                    case 6 -> builder.checksumshA512(de.readString(member));
                    case 7 -> builder.checksummD5(de.readString(member));
                    case 8 -> builder.checksumxxhasH64(de.readString(member));
                    case 9 -> builder.checksumxxhasH3(de.readString(member));
                    case 10 -> builder.checksumxxhasH128(de.readString(member));
                    case 11 -> builder.partNumber(de.readInteger(member));
