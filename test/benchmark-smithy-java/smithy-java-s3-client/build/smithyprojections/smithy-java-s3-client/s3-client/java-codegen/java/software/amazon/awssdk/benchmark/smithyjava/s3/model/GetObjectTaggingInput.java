...
@SmithyGenerated
public final class GetObjectTaggingInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_OBJECT_TAGGING_INPUT;
    ...
    private GetObjectTaggingInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetObjectTaggingInput that = (GetObjectTaggingInput) other;
     ...
     *
     * @return a builder for {@link GetObjectTaggingInput}.
     */
    ...
    /**
     * Builder for {@link GetObjectTaggingInput}.
     */
    public static final class Builder implements ShapeBuilder<GetObjectTaggingInput> {
        ...
        public GetObjectTaggingInput build() {
            tracker.validate();
            return new GetObjectTaggingInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetObjectTaggingInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
