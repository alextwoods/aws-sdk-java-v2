 ...
 *
 * <p>Lists the S3 Intelligent-Tiering configuration from the specified bucket.
 *
 ...
 * objects</a>.
 *
 * <p>Operations related to <code>ListBucketIntelligentTieringConfigurations</code> include:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class ListBucketIntelligentTieringConfigurations implements ApiOperation<ListBucketIntelligentTieringConfigurationsInput, ListBucketIntelligentTieringConfigurationsOutput> {

    private static final ListBucketIntelligentTieringConfigurations $INSTANCE = new ListBucketIntelligentTieringConfigurations();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#ListBucketIntelligentTieringConfigurations"),
            ...
            HttpTrait.builder().method("GET").code(200).uri(UriPattern.parse("/{Bucket}?intelligent-tiering&x-id=ListBucketIntelligentTieringConfigurations")).build());
     ...
     */
    public static ListBucketIntelligentTieringConfigurations instance() {
        return $INSTANCE;
    }

    private ListBucketIntelligentTieringConfigurations() {}

    @Override
    public ShapeBuilder<ListBucketIntelligentTieringConfigurationsInput> inputBuilder() {
        return ListBucketIntelligentTieringConfigurationsInput.builder();
    }

    @Override
    public ShapeBuilder<ListBucketIntelligentTieringConfigurationsOutput> outputBuilder() {
        return ListBucketIntelligentTieringConfigurationsOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return ListBucketIntelligentTieringConfigurationsInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return ListBucketIntelligentTieringConfigurationsOutput.$SCHEMA;
    }
