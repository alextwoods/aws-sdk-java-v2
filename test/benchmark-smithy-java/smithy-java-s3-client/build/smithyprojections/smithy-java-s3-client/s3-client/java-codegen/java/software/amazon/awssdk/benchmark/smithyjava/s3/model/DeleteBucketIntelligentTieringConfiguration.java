 ...
 *
 * <p>Deletes the S3 Intelligent-Tiering configuration from the specified bucket.
 *
 ...
 * objects</a>.
 *
 * <p>Operations related to <code>DeleteBucketIntelligentTieringConfiguration</code> include:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class DeleteBucketIntelligentTieringConfiguration implements ApiOperation<DeleteBucketIntelligentTieringConfigurationInput, DeleteBucketIntelligentTieringConfigurationOutput> {

    private static final DeleteBucketIntelligentTieringConfiguration $INSTANCE = new DeleteBucketIntelligentTieringConfiguration();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#DeleteBucketIntelligentTieringConfiguration"),
            ...
            HttpTrait.builder().method("DELETE").code(204).uri(UriPattern.parse("/{Bucket}?intelligent-tiering")).build());
     ...
     */
    public static DeleteBucketIntelligentTieringConfiguration instance() {
        return $INSTANCE;
    }

    private DeleteBucketIntelligentTieringConfiguration() {}

    @Override
    public ShapeBuilder<DeleteBucketIntelligentTieringConfigurationInput> inputBuilder() {
        return DeleteBucketIntelligentTieringConfigurationInput.builder();
    }

    @Override
    public ShapeBuilder<DeleteBucketIntelligentTieringConfigurationOutput> outputBuilder() {
        return DeleteBucketIntelligentTieringConfigurationOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return DeleteBucketIntelligentTieringConfigurationInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return DeleteBucketIntelligentTieringConfigurationOutput.$SCHEMA;
    }
