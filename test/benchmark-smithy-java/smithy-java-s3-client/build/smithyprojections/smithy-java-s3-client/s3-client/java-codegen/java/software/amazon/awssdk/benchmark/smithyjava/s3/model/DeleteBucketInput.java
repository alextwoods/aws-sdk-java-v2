...
@SmithyGenerated
public final class DeleteBucketInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_INPUT;
    ...
    private DeleteBucketInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketInput that = (DeleteBucketInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketInput> {
        ...
        public DeleteBucketInput build() {
            tracker.validate();
            return new DeleteBucketInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
