...
@SmithyGenerated
public final class ListBucketAnalyticsConfigurationsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.LIST_BUCKET_ANALYTICS_CONFIGURATIONS_INPUT;
    ...
    private ListBucketAnalyticsConfigurationsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListBucketAnalyticsConfigurationsInput that = (ListBucketAnalyticsConfigurationsInput) other;
     ...
     *
     * @return a builder for {@link ListBucketAnalyticsConfigurationsInput}.
     */
    ...
    /**
     * Builder for {@link ListBucketAnalyticsConfigurationsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListBucketAnalyticsConfigurationsInput> {
        ...
        @Override
        public ListBucketAnalyticsConfigurationsInput build() {
            tracker.validate();
            return new ListBucketAnalyticsConfigurationsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListBucketAnalyticsConfigurationsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
