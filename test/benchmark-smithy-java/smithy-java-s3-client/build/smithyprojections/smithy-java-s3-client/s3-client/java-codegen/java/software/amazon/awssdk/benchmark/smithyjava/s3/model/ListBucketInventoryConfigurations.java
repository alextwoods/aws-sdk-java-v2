...
/**
 * Returns a list of S3 Inventory configurations for the bucket. You can have up to 1,000 inventory configurations per
 * bucket.
 *
 * <p>This action supports list pagination and does not return more than 100 configurations at a time. Always check the <code>
 * IsTruncated</code> element in the response. If there are no more configurations to list, <code>IsTruncated</code> is
 * set to false. If there are more configurations to list, <code>IsTruncated</code> is set to true, and there is a value
 * in <code>NextContinuationToken</code>. You use the <code>NextContinuationToken</code> value to continue the
 * pagination of the list by passing the value in continuation-token in the request to <code>GET</code> the next page.
 *
 ...
 *
 * <p>The following operations are related to <code>ListBucketInventoryConfigurations</code>:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class ListBucketInventoryConfigurations implements ApiOperation<ListBucketInventoryConfigurationsInput, ListBucketInventoryConfigurationsOutput> {

    private static final ListBucketInventoryConfigurations $INSTANCE = new ListBucketInventoryConfigurations();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#ListBucketInventoryConfigurations"),
            ...
            HttpTrait.builder().method("GET").code(200).uri(UriPattern.parse("/{Bucket}?inventory&x-id=ListBucketInventoryConfigurations")).build());
     ...
     */
    public static ListBucketInventoryConfigurations instance() {
        return $INSTANCE;
    }
    ...
    @Override
    public ShapeBuilder<ListBucketInventoryConfigurationsInput> inputBuilder() {
        return ListBucketInventoryConfigurationsInput.builder();
    }

    @Override
    public ShapeBuilder<ListBucketInventoryConfigurationsOutput> outputBuilder() {
        return ListBucketInventoryConfigurationsOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return ListBucketInventoryConfigurationsInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return ListBucketInventoryConfigurationsOutput.$SCHEMA;
    }
