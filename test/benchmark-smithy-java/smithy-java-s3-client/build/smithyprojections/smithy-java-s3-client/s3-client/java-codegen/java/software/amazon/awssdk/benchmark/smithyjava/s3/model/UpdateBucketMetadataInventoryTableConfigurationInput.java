...
@SmithyGenerated
public final class UpdateBucketMetadataInventoryTableConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas6.UPDATE_BUCKET_METADATA_INVENTORY_TABLE_CONFIGURATION_INPUT;
    ...
    private final transient InventoryTableConfigurationUpdates inventoryTableConfiguration;
    private final transient String expectedBucketOwner;

    private UpdateBucketMetadataInventoryTableConfigurationInput(Builder builder) {
    ...
    /**
     * The general purpose bucket that corresponds to the metadata configuration that you want to enable or disable an
     * inventory table for.
     */
     ...
     */
    public InventoryTableConfigurationUpdates getInventoryTableConfiguration() {
        return inventoryTableConfiguration;
    }

    /**
     * The expected owner of the general purpose bucket that corresponds to the metadata table configuration that you
    ...
    public boolean equals(Object other) {
        ...
        UpdateBucketMetadataInventoryTableConfigurationInput that = (UpdateBucketMetadataInventoryTableConfigurationInput) other;
     ...
     *
     * @return a builder for {@link UpdateBucketMetadataInventoryTableConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link UpdateBucketMetadataInventoryTableConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateBucketMetadataInventoryTableConfigurationInput> {
         ...
         * @return this builder.
         */
        public Builder inventoryTableConfiguration(InventoryTableConfigurationUpdates inventoryTableConfiguration) {
            this.inventoryTableConfiguration = Objects.requireNonNull(inventoryTableConfiguration, "inventoryTableConfiguration cannot be null");
            tracker.setMember($SCHEMA_INVENTORY_TABLE_CONFIGURATION);
            return this;
        }
        ...
        @Override
        public UpdateBucketMetadataInventoryTableConfigurationInput build() {
            tracker.validate();
            return new UpdateBucketMetadataInventoryTableConfigurationInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> inventoryTableConfiguration((InventoryTableConfigurationUpdates) SchemaUtils.validateSameMember($SCHEMA_INVENTORY_TABLE_CONFIGURATION, member, value));
        ...
        @Override
        public ShapeBuilder<UpdateBucketMetadataInventoryTableConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_INVENTORY_TABLE_CONFIGURATION)) {
                tracker.setMember($SCHEMA_INVENTORY_TABLE_CONFIGURATION);
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.inventoryTableConfiguration(InventoryTableConfigurationUpdates.builder().deserializeMember(de, member).build());
