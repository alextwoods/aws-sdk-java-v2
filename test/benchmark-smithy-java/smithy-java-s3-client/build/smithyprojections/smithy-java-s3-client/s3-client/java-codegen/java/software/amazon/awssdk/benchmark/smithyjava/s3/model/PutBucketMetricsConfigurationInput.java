...
@SmithyGenerated
public final class PutBucketMetricsConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.PUT_BUCKET_METRICS_CONFIGURATION_INPUT;
    ...
    private PutBucketMetricsConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        PutBucketMetricsConfigurationInput that = (PutBucketMetricsConfigurationInput) other;
        return Objects.equals(this.bucket, that.bucket)
               && Objects.equals(this.id, that.id)
               && Objects.equals(this.expectedBucketOwner, that.expectedBucketOwner)
               && Objects.equals(this.metricsConfiguration, that.metricsConfiguration);
    }
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(metricsConfiguration);
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 2 -> (T) SchemaUtils.validateSameMember($SCHEMA_METRICS_CONFIGURATION, member, metricsConfiguration);
     ...
     *
     * @return a builder for {@link PutBucketMetricsConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link PutBucketMetricsConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<PutBucketMetricsConfigurationInput> {
        ...
        public Builder metricsConfiguration(MetricsConfiguration metricsConfiguration) {
            this.metricsConfiguration = Objects.requireNonNull(metricsConfiguration, "metricsConfiguration cannot be null");
            tracker.setMember($SCHEMA_METRICS_CONFIGURATION);
            return this;
        }
        ...
        @Override
        public PutBucketMetricsConfigurationInput build() {
            tracker.validate();
            return new PutBucketMetricsConfigurationInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> metricsConfiguration((MetricsConfiguration) SchemaUtils.validateSameMember($SCHEMA_METRICS_CONFIGURATION, member, value));
        ...
        @Override
        public ShapeBuilder<PutBucketMetricsConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_METRICS_CONFIGURATION)) {
                tracker.setMember($SCHEMA_METRICS_CONFIGURATION);
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.metricsConfiguration(MetricsConfiguration.builder().deserializeMember(de, member).build());
