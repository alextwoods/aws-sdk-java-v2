...
@SmithyGenerated
public final class ListBucketInventoryConfigurationsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.LIST_BUCKET_INVENTORY_CONFIGURATIONS_INPUT;
    ...
    private ListBucketInventoryConfigurationsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListBucketInventoryConfigurationsInput that = (ListBucketInventoryConfigurationsInput) other;
     ...
     *
     * @return a builder for {@link ListBucketInventoryConfigurationsInput}.
     */
    ...
    /**
     * Builder for {@link ListBucketInventoryConfigurationsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListBucketInventoryConfigurationsInput> {
        ...
        @Override
        public ListBucketInventoryConfigurationsInput build() {
            tracker.validate();
            return new ListBucketInventoryConfigurationsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListBucketInventoryConfigurationsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
