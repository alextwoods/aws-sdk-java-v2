 ...
 */
@SmithyGenerated
public final class TopicConfiguration implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.TOPIC_CONFIGURATION;
    private static final Schema $SCHEMA_ID = $SCHEMA.member("Id");
    private static final Schema $SCHEMA_TOPIC_ARN = $SCHEMA.member("TopicArn");
    ...
    private final transient String topicArn;
    ...
    /**
     * The Amazon S3 bucket event about which to send notifications. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html">Supported Event Types</a>
    ...
    public boolean equals(Object other) {
        ...
        TopicConfiguration that = (TopicConfiguration) other;
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(topicArn);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        serializer.writeString($SCHEMA_TOPIC_ARN, topicArn);
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            case 0 -> (T) SchemaUtils.validateSameMember($SCHEMA_TOPIC_ARN, member, topicArn);
     ...
     *
     * @return a builder for {@link TopicConfiguration}.
     */
    ...
    /**
     * Builder for {@link TopicConfiguration}.
     */
    public static final class Builder implements ShapeBuilder<TopicConfiguration> {
        ...
        public Builder topicArn(String topicArn) {
            ...
            tracker.setMember($SCHEMA_TOPIC_ARN);
            return this;
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> topicArn((String) SchemaUtils.validateSameMember($SCHEMA_TOPIC_ARN, member, value));
        ...
        @Override
        public ShapeBuilder<TopicConfiguration> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            if (!tracker.checkMember($SCHEMA_TOPIC_ARN)) {
                topicArn("");
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.topicArn(de.readString(member));
