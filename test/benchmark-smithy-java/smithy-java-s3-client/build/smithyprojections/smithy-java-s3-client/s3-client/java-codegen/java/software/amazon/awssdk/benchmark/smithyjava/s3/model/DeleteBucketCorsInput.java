...
@SmithyGenerated
public final class DeleteBucketCorsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_CORS_INPUT;
    ...
    private DeleteBucketCorsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketCorsInput that = (DeleteBucketCorsInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketCorsInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketCorsInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketCorsInput> {
        ...
        public DeleteBucketCorsInput build() {
            tracker.validate();
            return new DeleteBucketCorsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketCorsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
