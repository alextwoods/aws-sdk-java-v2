...
@SmithyGenerated
public final class DeleteBucketReplicationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_REPLICATION_INPUT;
    ...
    private DeleteBucketReplicationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketReplicationInput that = (DeleteBucketReplicationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketReplicationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketReplicationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketReplicationInput> {
        ...
        public DeleteBucketReplicationInput build() {
            tracker.validate();
            return new DeleteBucketReplicationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketReplicationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
