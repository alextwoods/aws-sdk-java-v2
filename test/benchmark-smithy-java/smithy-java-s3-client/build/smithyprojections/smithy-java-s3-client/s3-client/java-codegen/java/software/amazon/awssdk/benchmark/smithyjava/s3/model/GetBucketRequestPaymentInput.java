...
@SmithyGenerated
public final class GetBucketRequestPaymentInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_REQUEST_PAYMENT_INPUT;
    ...
    private GetBucketRequestPaymentInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketRequestPaymentInput that = (GetBucketRequestPaymentInput) other;
     ...
     *
     * @return a builder for {@link GetBucketRequestPaymentInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketRequestPaymentInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketRequestPaymentInput> {
        ...
        @Override
        public GetBucketRequestPaymentInput build() {
            tracker.validate();
            return new GetBucketRequestPaymentInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketRequestPaymentInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
