...
@SmithyGenerated
public final class DeleteBucketMetricsConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_METRICS_CONFIGURATION_INPUT;
    ...
    private DeleteBucketMetricsConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketMetricsConfigurationInput that = (DeleteBucketMetricsConfigurationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketMetricsConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketMetricsConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketMetricsConfigurationInput> {
        ...
        @Override
        public DeleteBucketMetricsConfigurationInput build() {
            tracker.validate();
            return new DeleteBucketMetricsConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketMetricsConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
