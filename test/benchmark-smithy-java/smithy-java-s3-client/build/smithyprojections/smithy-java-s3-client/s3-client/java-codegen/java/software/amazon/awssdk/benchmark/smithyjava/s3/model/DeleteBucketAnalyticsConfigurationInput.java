...
@SmithyGenerated
public final class DeleteBucketAnalyticsConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_ANALYTICS_CONFIGURATION_INPUT;
    ...
    private DeleteBucketAnalyticsConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketAnalyticsConfigurationInput that = (DeleteBucketAnalyticsConfigurationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketAnalyticsConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketAnalyticsConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketAnalyticsConfigurationInput> {
        ...
        @Override
        public DeleteBucketAnalyticsConfigurationInput build() {
            tracker.validate();
            return new DeleteBucketAnalyticsConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketAnalyticsConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
