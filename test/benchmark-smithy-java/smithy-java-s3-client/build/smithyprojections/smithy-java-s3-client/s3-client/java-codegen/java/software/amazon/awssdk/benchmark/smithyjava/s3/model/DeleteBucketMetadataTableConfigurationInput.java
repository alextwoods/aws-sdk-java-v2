...
@SmithyGenerated
public final class DeleteBucketMetadataTableConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_METADATA_TABLE_CONFIGURATION_INPUT;
    ...
    private DeleteBucketMetadataTableConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketMetadataTableConfigurationInput that = (DeleteBucketMetadataTableConfigurationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketMetadataTableConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketMetadataTableConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketMetadataTableConfigurationInput> {
        ...
        @Override
        public DeleteBucketMetadataTableConfigurationInput build() {
            tracker.validate();
            return new DeleteBucketMetadataTableConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketMetadataTableConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
