...
@SmithyGenerated
public final class UpdateObjectEncryptionOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas7.UPDATE_OBJECT_ENCRYPTION_OUTPUT;
    ...
    private UpdateObjectEncryptionOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        UpdateObjectEncryptionOutput that = (UpdateObjectEncryptionOutput) other;
     ...
     *
     * @return a builder for {@link UpdateObjectEncryptionOutput}.
     */
    ...
    /**
     * Builder for {@link UpdateObjectEncryptionOutput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateObjectEncryptionOutput> {
        ...
        @Override
        public UpdateObjectEncryptionOutput build() {
            return new UpdateObjectEncryptionOutput(this);
        }
