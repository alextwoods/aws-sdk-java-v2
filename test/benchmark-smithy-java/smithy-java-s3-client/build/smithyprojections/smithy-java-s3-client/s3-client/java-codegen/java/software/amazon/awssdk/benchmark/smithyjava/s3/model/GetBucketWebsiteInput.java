...
@SmithyGenerated
public final class GetBucketWebsiteInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_WEBSITE_INPUT;
    ...
    private GetBucketWebsiteInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketWebsiteInput that = (GetBucketWebsiteInput) other;
     ...
     *
     * @return a builder for {@link GetBucketWebsiteInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketWebsiteInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketWebsiteInput> {
        ...
        public GetBucketWebsiteInput build() {
            tracker.validate();
            return new GetBucketWebsiteInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketWebsiteInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
