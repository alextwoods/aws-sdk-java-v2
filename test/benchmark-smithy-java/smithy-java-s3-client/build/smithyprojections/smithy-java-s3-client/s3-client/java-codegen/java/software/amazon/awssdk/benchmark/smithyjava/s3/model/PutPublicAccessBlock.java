 ...
 * operation, you must have the <code>s3:PutBucketPublicAccessBlock</code> permission. For more information about Amazon
 * S3 permissions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html">Specifying Permissions in a Policy</a>.
 *
 ...
 * If the <code>PublicAccessBlock</code> configurations are different between the bucket and the account, Amazon S3 uses
 * the most restrictive combination of the bucket-level and account-level settings.
 *
 ...
 * .
 *
 * <p>The following operations are related to <code>PutPublicAccessBlock</code>:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class PutPublicAccessBlock implements ApiOperation<PutPublicAccessBlockInput, PutPublicAccessBlockOutput> {

    private static final PutPublicAccessBlock $INSTANCE = new PutPublicAccessBlock();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#PutPublicAccessBlock"),
            ...
            HttpTrait.builder().method("PUT").code(200).uri(UriPattern.parse("/{Bucket}?publicAccessBlock")).build());
     ...
     */
    public static PutPublicAccessBlock instance() {
        return $INSTANCE;
    }
    ...
    @Override
    public ShapeBuilder<PutPublicAccessBlockInput> inputBuilder() {
        return PutPublicAccessBlockInput.builder();
    }

    @Override
    public ShapeBuilder<PutPublicAccessBlockOutput> outputBuilder() {
        return PutPublicAccessBlockOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return PutPublicAccessBlockInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return PutPublicAccessBlockOutput.$SCHEMA;
    }
