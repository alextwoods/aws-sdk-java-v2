 ...
 */
@SmithyGenerated
public final class AccessDenied extends S3Exception {

    public static final Schema $SCHEMA = Schemas.ACCESS_DENIED;

    public static final ShapeId $ID = $SCHEMA.id();

    private AccessDenied(Builder builder) {
     ...
     *
     * @return a builder for {@link AccessDenied}.
     */
    ...
    /**
     * Builder for {@link AccessDenied}.
     */
    public static final class Builder implements ShapeBuilder<AccessDenied> {
