 ...
 * bucket and do not provide information on daily storage metrics. You can have up to 1,000 configurations per bucket.
 *
 ...
 * pagination of the list by passing the value in <code>continuation-token</code> in the request to <code>GET</code> the
 * next page.
 *
 * <dl>
 *   <dt>
 ...
 * Amazon CloudWatch</a>.
 *
 * <p>The following operations are related to <code>ListBucketMetricsConfigurations</code>:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class ListBucketMetricsConfigurations implements ApiOperation<ListBucketMetricsConfigurationsInput, ListBucketMetricsConfigurationsOutput> {

    private static final ListBucketMetricsConfigurations $INSTANCE = new ListBucketMetricsConfigurations();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#ListBucketMetricsConfigurations"),
            ...
            HttpTrait.builder().method("GET").code(200).uri(UriPattern.parse("/{Bucket}?metrics&x-id=ListBucketMetricsConfigurations")).build());
     ...
     */
    public static ListBucketMetricsConfigurations instance() {
        return $INSTANCE;
    }
    ...
    @Override
    public ShapeBuilder<ListBucketMetricsConfigurationsInput> inputBuilder() {
        return ListBucketMetricsConfigurationsInput.builder();
    }

    @Override
    public ShapeBuilder<ListBucketMetricsConfigurationsOutput> outputBuilder() {
        return ListBucketMetricsConfigurationsOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return ListBucketMetricsConfigurationsInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return ListBucketMetricsConfigurationsOutput.$SCHEMA;
    }
