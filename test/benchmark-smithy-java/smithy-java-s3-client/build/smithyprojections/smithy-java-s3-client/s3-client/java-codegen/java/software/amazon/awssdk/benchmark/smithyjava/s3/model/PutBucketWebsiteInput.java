...
@SmithyGenerated
public final class PutBucketWebsiteInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.PUT_BUCKET_WEBSITE_INPUT;
    ...
    private static final Schema $SCHEMA_WEBSITE_CONFIGURATION = $SCHEMA.member("WebsiteConfiguration");
    ...
    private final transient WebsiteConfiguration websiteConfiguration;
    private final transient String expectedBucketOwner;

    private PutBucketWebsiteInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        PutBucketWebsiteInput that = (PutBucketWebsiteInput) other;
        return Objects.equals(this.bucket, that.bucket)
               ...
               && Objects.equals(this.websiteConfiguration, that.websiteConfiguration);
    }
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(websiteConfiguration);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (websiteConfiguration != null) {
            serializer.writeStruct($SCHEMA_WEBSITE_CONFIGURATION, websiteConfiguration);
        }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_WEBSITE_CONFIGURATION, member, websiteConfiguration);
     ...
     *
     * @return a builder for {@link PutBucketWebsiteInput}.
     */
    public Builder toBuilder() {
        ...
        builder.websiteConfiguration(this.websiteConfiguration);
    ...
    /**
     * Builder for {@link PutBucketWebsiteInput}.
     */
    public static final class Builder implements ShapeBuilder<PutBucketWebsiteInput> {
        ...
        public Builder websiteConfiguration(WebsiteConfiguration websiteConfiguration) {
            this.websiteConfiguration = Objects.requireNonNull(websiteConfiguration, "websiteConfiguration cannot be null");
            tracker.setMember($SCHEMA_WEBSITE_CONFIGURATION);
            return this;
        }
        ...
        public PutBucketWebsiteInput build() {
            tracker.validate();
            return new PutBucketWebsiteInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> websiteConfiguration((WebsiteConfiguration) SchemaUtils.validateSameMember($SCHEMA_WEBSITE_CONFIGURATION, member, value));
        ...
        @Override
        public ShapeBuilder<PutBucketWebsiteInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_WEBSITE_CONFIGURATION)) {
                tracker.setMember($SCHEMA_WEBSITE_CONFIGURATION);
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.websiteConfiguration(WebsiteConfiguration.builder().deserializeMember(de, member).build());
