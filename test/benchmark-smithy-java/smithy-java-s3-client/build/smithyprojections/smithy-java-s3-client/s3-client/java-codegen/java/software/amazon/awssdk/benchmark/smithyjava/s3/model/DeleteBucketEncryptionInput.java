...
@SmithyGenerated
public final class DeleteBucketEncryptionInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_ENCRYPTION_INPUT;
    ...
    private DeleteBucketEncryptionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketEncryptionInput that = (DeleteBucketEncryptionInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketEncryptionInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketEncryptionInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketEncryptionInput> {
        ...
        @Override
        public DeleteBucketEncryptionInput build() {
            tracker.validate();
            return new DeleteBucketEncryptionInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketEncryptionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
