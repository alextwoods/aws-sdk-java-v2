...
@SmithyGenerated
public final class GetBucketPolicyStatusInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_POLICY_STATUS_INPUT;
    ...
    private GetBucketPolicyStatusInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketPolicyStatusInput that = (GetBucketPolicyStatusInput) other;
     ...
     *
     * @return a builder for {@link GetBucketPolicyStatusInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketPolicyStatusInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketPolicyStatusInput> {
        ...
        @Override
        public GetBucketPolicyStatusInput build() {
            tracker.validate();
            return new GetBucketPolicyStatusInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketPolicyStatusInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
