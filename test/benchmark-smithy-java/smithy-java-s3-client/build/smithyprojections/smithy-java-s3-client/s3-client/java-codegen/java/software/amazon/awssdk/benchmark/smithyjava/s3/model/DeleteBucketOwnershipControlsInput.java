...
@SmithyGenerated
public final class DeleteBucketOwnershipControlsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_OWNERSHIP_CONTROLS_INPUT;
    ...
    private DeleteBucketOwnershipControlsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketOwnershipControlsInput that = (DeleteBucketOwnershipControlsInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketOwnershipControlsInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketOwnershipControlsInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketOwnershipControlsInput> {
        ...
        @Override
        public DeleteBucketOwnershipControlsInput build() {
            tracker.validate();
            return new DeleteBucketOwnershipControlsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketOwnershipControlsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
