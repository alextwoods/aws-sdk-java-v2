...
@SmithyGenerated
public final class DeleteBucketMetadataConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_METADATA_CONFIGURATION_INPUT;
    ...
    private DeleteBucketMetadataConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketMetadataConfigurationInput that = (DeleteBucketMetadataConfigurationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketMetadataConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketMetadataConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketMetadataConfigurationInput> {
        ...
        @Override
        public DeleteBucketMetadataConfigurationInput build() {
            tracker.validate();
            return new DeleteBucketMetadataConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketMetadataConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
