...
@SmithyGenerated
public final class GetBucketPolicyInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_POLICY_INPUT;
    ...
    private GetBucketPolicyInput(Builder builder) {
     ...
     * Guide</i>
     *
     * <p><b>Access points</b> - When you use this API operation with an access point, provide the alias of the access
     * point in place of the bucket name.
     *
     * <p><b>Object Lambda access points</b> - When you use this API operation with an Object Lambda access point,
     * provide the alias of the Object Lambda access point in place of the bucket name. If the Object Lambda access
     * point alias in a request is not valid, the error code <code>InvalidAccessPointAliasError</code> is returned. For
     * more information about <code>InvalidAccessPointAliasError</code>, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html#ErrorCodeList">List of Error Codes</a>.
     *
    ...
    public boolean equals(Object other) {
        ...
        GetBucketPolicyInput that = (GetBucketPolicyInput) other;
     ...
     *
     * @return a builder for {@link GetBucketPolicyInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketPolicyInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketPolicyInput> {
        ...
        public GetBucketPolicyInput build() {
            tracker.validate();
            return new GetBucketPolicyInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketPolicyInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
