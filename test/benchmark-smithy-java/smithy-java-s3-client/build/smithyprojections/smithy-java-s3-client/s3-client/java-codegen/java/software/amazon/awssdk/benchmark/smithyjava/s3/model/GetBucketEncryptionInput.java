...
@SmithyGenerated
public final class GetBucketEncryptionInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_ENCRYPTION_INPUT;
    ...
    private GetBucketEncryptionInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketEncryptionInput that = (GetBucketEncryptionInput) other;
     ...
     *
     * @return a builder for {@link GetBucketEncryptionInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketEncryptionInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketEncryptionInput> {
        ...
        @Override
        public GetBucketEncryptionInput build() {
            tracker.validate();
            return new GetBucketEncryptionInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketEncryptionInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
