...
@SmithyGenerated
public final class ListBucketIntelligentTieringConfigurationsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.LIST_BUCKET_INTELLIGENT_TIERING_CONFIGURATIONS_INPUT;
    ...
    private ListBucketIntelligentTieringConfigurationsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListBucketIntelligentTieringConfigurationsInput that = (ListBucketIntelligentTieringConfigurationsInput) other;
     ...
     *
     * @return a builder for {@link ListBucketIntelligentTieringConfigurationsInput}.
     */
    ...
    /**
     * Builder for {@link ListBucketIntelligentTieringConfigurationsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListBucketIntelligentTieringConfigurationsInput> {
        ...
        @Override
        public ListBucketIntelligentTieringConfigurationsInput build() {
            tracker.validate();
            return new ListBucketIntelligentTieringConfigurationsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListBucketIntelligentTieringConfigurationsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
