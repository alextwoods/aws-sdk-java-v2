 ...
 * returns the <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_ServerSideEncryptionRule.html#AmazonS3-Type-ServerSideEncryptionRule-BucketKeyEnabled">BucketKeyEnabled</a> and <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_ServerSideEncryptionRule.html#AmazonS3-Type-ServerSideEncryptionRule-BlockedEncryptionTypes">BlockedEncryptionTypes</a> statuses.
 *
 * <ul>
 *   <li>
 *     <b>General purpose buckets</b> - For information about the bucket default encryption feature, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucket-encryption.html">Amazon
 ...
 *     <ul>
 *       <li>
 *         <b>General purpose bucket permissions</b> - The <code>s3:GetEncryptionConfiguration</code> permission
 ...
 *         s3express:GetEncryptionConfiguration</code> permission in an IAM identity-based policy instead of a
 ...
 * </dl>
 *
 * <p>The following operations are related to <code>GetBucketEncryption</code>:
 *
 * <ul>
 *   <li>
 ...
 */
@SmithyGenerated
public final class GetBucketEncryption implements ApiOperation<GetBucketEncryptionInput, GetBucketEncryptionOutput> {

    private static final GetBucketEncryption $INSTANCE = new GetBucketEncryption();

    static final Schema $SCHEMA = Schema.createOperation(ShapeId.from("com.amazonaws.s3#GetBucketEncryption"),
            ...
            HttpTrait.builder().method("GET").code(200).uri(UriPattern.parse("/{Bucket}?encryption")).build());
     ...
     */
    public static GetBucketEncryption instance() {
        return $INSTANCE;
    }
    ...
    @Override
    public ShapeBuilder<GetBucketEncryptionInput> inputBuilder() {
        return GetBucketEncryptionInput.builder();
    }

    @Override
    public ShapeBuilder<GetBucketEncryptionOutput> outputBuilder() {
        return GetBucketEncryptionOutput.builder();
    }
    ...
    public Schema inputSchema() {
        return GetBucketEncryptionInput.$SCHEMA;
    }

    @Override
    public Schema outputSchema() {
        return GetBucketEncryptionOutput.$SCHEMA;
    }
