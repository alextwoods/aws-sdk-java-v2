...
public final class NoSuchKey extends S3Exception {
    ...
    public static final Schema $SCHEMA = Schemas1.NO_SUCH_KEY;

    public static final ShapeId $ID = $SCHEMA.id();

    private NoSuchKey(Builder builder) {
     ...
     *
     * @return a builder for {@link NoSuchKey}.
     */
    ...
    /**
     * Builder for {@link NoSuchKey}.
     */
    public static final class Builder implements ShapeBuilder<NoSuchKey> {
        ...
        @Override
        public NoSuchKey build() {
            return new NoSuchKey(this);
        }
