...
@SmithyGenerated
public final class UpdateBucketMetadataJournalTableConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas6.UPDATE_BUCKET_METADATA_JOURNAL_TABLE_CONFIGURATION_INPUT;
    ...
    private final transient JournalTableConfigurationUpdates journalTableConfiguration;
    private final transient String expectedBucketOwner;

    private UpdateBucketMetadataJournalTableConfigurationInput(Builder builder) {
     ...
     */
    public JournalTableConfigurationUpdates getJournalTableConfiguration() {
    ...
    public boolean equals(Object other) {
        ...
        UpdateBucketMetadataJournalTableConfigurationInput that = (UpdateBucketMetadataJournalTableConfigurationInput) other;
        return Objects.equals(this.bucket, that.bucket)
               ...
               && Objects.equals(this.journalTableConfiguration, that.journalTableConfiguration);
    }
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(journalTableConfiguration);
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_JOURNAL_TABLE_CONFIGURATION, member, journalTableConfiguration);
     ...
     *
     * @return a builder for {@link UpdateBucketMetadataJournalTableConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link UpdateBucketMetadataJournalTableConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<UpdateBucketMetadataJournalTableConfigurationInput> {
         ...
         * @return this builder.
         */
        public Builder journalTableConfiguration(JournalTableConfigurationUpdates journalTableConfiguration) {
        ...
        @Override
        public UpdateBucketMetadataJournalTableConfigurationInput build() {
            tracker.validate();
            return new UpdateBucketMetadataJournalTableConfigurationInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> journalTableConfiguration((JournalTableConfigurationUpdates) SchemaUtils.validateSameMember($SCHEMA_JOURNAL_TABLE_CONFIGURATION, member, value));
        ...
        @Override
        public ShapeBuilder<UpdateBucketMetadataJournalTableConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.journalTableConfiguration(JournalTableConfigurationUpdates.builder().deserializeMember(de, member).build());
