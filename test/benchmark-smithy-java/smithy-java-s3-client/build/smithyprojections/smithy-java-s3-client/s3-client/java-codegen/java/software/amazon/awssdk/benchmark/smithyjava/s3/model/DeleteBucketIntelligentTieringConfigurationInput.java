...
@SmithyGenerated
public final class DeleteBucketIntelligentTieringConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_INTELLIGENT_TIERING_CONFIGURATION_INPUT;
    ...
    private DeleteBucketIntelligentTieringConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketIntelligentTieringConfigurationInput that = (DeleteBucketIntelligentTieringConfigurationInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketIntelligentTieringConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketIntelligentTieringConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketIntelligentTieringConfigurationInput> {
        ...
        @Override
        public DeleteBucketIntelligentTieringConfigurationInput build() {
            tracker.validate();
            return new DeleteBucketIntelligentTieringConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketIntelligentTieringConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
