 ...
 */
@SmithyGenerated
public final class S3TablesDestinationResult implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.S3_TABLES_DESTINATION_RESULT;
    ...
    private S3TablesDestinationResult(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        S3TablesDestinationResult that = (S3TablesDestinationResult) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_TABLE_NAMESPACE, member, tableNamespace);
     ...
     *
     * @return a builder for {@link S3TablesDestinationResult}.
     */
    ...
    /**
     * Builder for {@link S3TablesDestinationResult}.
     */
    public static final class Builder implements ShapeBuilder<S3TablesDestinationResult> {
        ...
        public Builder tableNamespace(String tableNamespace) {
            this.tableNamespace = Objects.requireNonNull(tableNamespace, "tableNamespace cannot be null");
            tracker.setMember($SCHEMA_TABLE_NAMESPACE);
            return this;
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> tableNamespace((String) SchemaUtils.validateSameMember($SCHEMA_TABLE_NAMESPACE, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<S3TablesDestinationResult> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_TABLE_NAMESPACE)) {
                tableNamespace("");
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 3 -> builder.tableNamespace(de.readString(member));
