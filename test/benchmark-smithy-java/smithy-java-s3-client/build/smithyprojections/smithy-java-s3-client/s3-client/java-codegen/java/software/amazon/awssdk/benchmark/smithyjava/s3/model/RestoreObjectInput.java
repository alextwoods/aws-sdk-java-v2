...
@SmithyGenerated
public final class RestoreObjectInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas6.RESTORE_OBJECT_INPUT;
    ...
    private static final Schema $SCHEMA_RESTORE_REQUEST = $SCHEMA.member("RestoreRequest");
    ...
    private final transient RestoreRequest restoreRequest;
    ...
    private RestoreObjectInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        RestoreObjectInput that = (RestoreObjectInput) other;
        return Objects.equals(this.bucket, that.bucket)
               ...
               && Objects.equals(this.restoreRequest, that.restoreRequest);
    }
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(restoreRequest);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (restoreRequest != null) {
            serializer.writeStruct($SCHEMA_RESTORE_REQUEST, restoreRequest);
        }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_RESTORE_REQUEST, member, restoreRequest);
     ...
     *
     * @return a builder for {@link RestoreObjectInput}.
     */
    public Builder toBuilder() {
        ...
        builder.restoreRequest(this.restoreRequest);
    ...
    /**
     * Builder for {@link RestoreObjectInput}.
     */
    public static final class Builder implements ShapeBuilder<RestoreObjectInput> {
        ...
        public RestoreObjectInput build() {
            tracker.validate();
            return new RestoreObjectInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> restoreRequest((RestoreRequest) SchemaUtils.validateSameMember($SCHEMA_RESTORE_REQUEST, member, value));
        ...
        @Override
        public ShapeBuilder<RestoreObjectInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 3 -> builder.restoreRequest(RestoreRequest.builder().deserializeMember(de, member).build());
