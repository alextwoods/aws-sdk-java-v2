...
@SmithyGenerated
public final class GetBucketInventoryConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_INVENTORY_CONFIGURATION_INPUT;
    ...
    private GetBucketInventoryConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketInventoryConfigurationInput that = (GetBucketInventoryConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketInventoryConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketInventoryConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketInventoryConfigurationInput> {
        ...
        @Override
        public GetBucketInventoryConfigurationInput build() {
            tracker.validate();
            return new GetBucketInventoryConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketInventoryConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
