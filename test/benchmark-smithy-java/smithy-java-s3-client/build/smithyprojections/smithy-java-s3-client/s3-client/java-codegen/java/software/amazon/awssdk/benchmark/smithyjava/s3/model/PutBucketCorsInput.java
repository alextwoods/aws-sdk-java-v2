...
@SmithyGenerated
public final class PutBucketCorsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.PUT_BUCKET_CORS_INPUT;
    private static final Schema $SCHEMA_BUCKET = $SCHEMA.member("Bucket");
    private static final Schema $SCHEMA_CORS_CONFIGURATION = $SCHEMA.member("CORSConfiguration");
    ...
    private final transient CORSConfiguration corsConfiguration;
    ...
    private PutBucketCorsInput(Builder builder) {
    ...
    /**
     * Describes the cross-origin access configuration for objects in an Amazon S3 bucket. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html">
     * Enabling Cross-Origin Resource Sharing</a> in the <i>Amazon S3 User Guide</i>.
     */
    ...
    public boolean equals(Object other) {
        ...
        PutBucketCorsInput that = (PutBucketCorsInput) other;
        return Objects.equals(this.bucket, that.bucket)
               ...
               && Objects.equals(this.corsConfiguration, that.corsConfiguration);
    }

    @Override
    public int hashCode() {
        int $hc = Objects.hashCode(bucket);
        $hc = 31 * $hc + Objects.hashCode(corsConfiguration);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (corsConfiguration != null) {
            serializer.writeStruct($SCHEMA_CORS_CONFIGURATION, corsConfiguration);
        }
        if (contentmD5 != null) {
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_CORS_CONFIGURATION, member, corsConfiguration);
     ...
     *
     * @return a builder for {@link PutBucketCorsInput}.
     */
    public Builder toBuilder() {
        var builder = new Builder();
        builder.bucket(this.bucket);
        builder.corsConfiguration(this.corsConfiguration);
    ...
    /**
     * Builder for {@link PutBucketCorsInput}.
     */
    public static final class Builder implements ShapeBuilder<PutBucketCorsInput> {
        ...
        public Builder corsConfiguration(CORSConfiguration corsConfiguration) {
            this.corsConfiguration = Objects.requireNonNull(corsConfiguration, "corsConfiguration cannot be null");
            tracker.setMember($SCHEMA_CORS_CONFIGURATION);
            return this;
        }
        ...
        public PutBucketCorsInput build() {
            tracker.validate();
            return new PutBucketCorsInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> corsConfiguration((CORSConfiguration) SchemaUtils.validateSameMember($SCHEMA_CORS_CONFIGURATION, member, value));
        ...
        @Override
        public ShapeBuilder<PutBucketCorsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_CORS_CONFIGURATION)) {
                tracker.setMember($SCHEMA_CORS_CONFIGURATION);
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.corsConfiguration(CORSConfiguration.builder().deserializeMember(de, member).build());
