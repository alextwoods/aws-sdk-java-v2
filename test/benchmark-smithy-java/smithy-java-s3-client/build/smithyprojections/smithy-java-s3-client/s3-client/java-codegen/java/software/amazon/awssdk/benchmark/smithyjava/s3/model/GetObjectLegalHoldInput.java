...
@SmithyGenerated
public final class GetObjectLegalHoldInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_OBJECT_LEGAL_HOLD_INPUT;
    ...
    private GetObjectLegalHoldInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetObjectLegalHoldInput that = (GetObjectLegalHoldInput) other;
     ...
     *
     * @return a builder for {@link GetObjectLegalHoldInput}.
     */
    ...
    /**
     * Builder for {@link GetObjectLegalHoldInput}.
     */
    public static final class Builder implements ShapeBuilder<GetObjectLegalHoldInput> {
        ...
        @Override
        public GetObjectLegalHoldInput build() {
            tracker.validate();
            return new GetObjectLegalHoldInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetObjectLegalHoldInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
