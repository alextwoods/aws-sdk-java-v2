...
@SmithyGenerated
public final class GetBucketAclInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.GET_BUCKET_ACL_INPUT;
    ...
    private GetBucketAclInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketAclInput that = (GetBucketAclInput) other;
     ...
     *
     * @return a builder for {@link GetBucketAclInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketAclInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketAclInput> {
        ...
        public GetBucketAclInput build() {
            tracker.validate();
            return new GetBucketAclInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketAclInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
