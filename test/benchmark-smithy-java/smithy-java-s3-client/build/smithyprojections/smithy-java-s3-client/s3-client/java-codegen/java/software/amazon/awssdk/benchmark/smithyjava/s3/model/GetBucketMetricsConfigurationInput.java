...
@SmithyGenerated
public final class GetBucketMetricsConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_METRICS_CONFIGURATION_INPUT;
    ...
    private GetBucketMetricsConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketMetricsConfigurationInput that = (GetBucketMetricsConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketMetricsConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketMetricsConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketMetricsConfigurationInput> {
        ...
        @Override
        public GetBucketMetricsConfigurationInput build() {
            tracker.validate();
            return new GetBucketMetricsConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketMetricsConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
