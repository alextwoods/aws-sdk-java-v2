...
@SmithyGenerated
public final class ListObjectsV2Input implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.LIST_OBJECTS_V2_INPUT;
    ...
    private static final Schema $SCHEMA_FETCH_OWNER = $SCHEMA.member("FetchOwner");
    ...
    private final transient Boolean fetchOwner;
    ...
    private ListObjectsV2Input(Builder builder) {
     ...
     * Zone or Local Zone). Bucket names must follow the format <code><i>bucket-base-name</i>--<i>zone-id</i>--x-s3</code>
     * (for example, <code><i>amzn-s3-demo-bucket</i>--<i>usw2-az1</i>--x-s3</code>). For information about bucket
     * naming restrictions, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-bucket-naming-rules.html">Directory bucket naming rules</a> in the <i>Amazon S3 User Guide</i>.
     *
     ...
     *
     * <p><code>CommonPrefixes</code> is filtered out from results if it is not lexicographically greater than the <code>
     * StartAfter</code> value.
     *
     * <ul>
     *   <li>
     ...
     *
     * <p><b>Directory buckets</b> - For directory buckets, the bucket owner is returned as the object owner for all
     * objects.
     */
    ...
    public boolean equals(Object other) {
        ...
        ListObjectsV2Input that = (ListObjectsV2Input) other;
        return Objects.equals(this.fetchOwner, that.fetchOwner)
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(fetchOwner);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (fetchOwner != null) {
            serializer.writeBoolean($SCHEMA_FETCH_OWNER, fetchOwner);
        }
        if (startAfter != null) {
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 3 -> (T) SchemaUtils.validateSameMember($SCHEMA_MAX_KEYS, member, maxKeys);
            ...
            case 6 -> (T) SchemaUtils.validateSameMember($SCHEMA_FETCH_OWNER, member, fetchOwner);
            case 7 -> (T) SchemaUtils.validateSameMember($SCHEMA_START_AFTER, member, startAfter);
            case 8 -> (T) SchemaUtils.validateSameMember($SCHEMA_REQUEST_PAYER, member, requestPayer);
            case 9 -> (T) SchemaUtils.validateSameMember($SCHEMA_EXPECTED_BUCKET_OWNER, member, expectedBucketOwner);
            case 10 -> (T) SchemaUtils.validateSameMember($SCHEMA_OPTIONAL_OBJECT_ATTRIBUTES, member, optionalObjectAttributes);
     ...
     *
     * @return a builder for {@link ListObjectsV2Input}.
     */
    public Builder toBuilder() {
        ...
        builder.fetchOwner(this.fetchOwner);
    ...
    /**
     * Builder for {@link ListObjectsV2Input}.
     */
    public static final class Builder implements ShapeBuilder<ListObjectsV2Input> {
        ...
        public ListObjectsV2Input build() {
            tracker.validate();
            return new ListObjectsV2Input(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 3 -> maxKeys((Integer) SchemaUtils.validateSameMember($SCHEMA_MAX_KEYS, member, value));
                ...
                case 6 -> fetchOwner((Boolean) SchemaUtils.validateSameMember($SCHEMA_FETCH_OWNER, member, value));
                case 7 -> startAfter((String) SchemaUtils.validateSameMember($SCHEMA_START_AFTER, member, value));
                case 8 -> requestPayer((RequestPayer) SchemaUtils.validateSameMember($SCHEMA_REQUEST_PAYER, member, value));
                case 9 -> expectedBucketOwner((String) SchemaUtils.validateSameMember($SCHEMA_EXPECTED_BUCKET_OWNER, member, value));
                case 10 -> optionalObjectAttributes((List<OptionalObjectAttributes>) SchemaUtils.validateSameMember($SCHEMA_OPTIONAL_OBJECT_ATTRIBUTES, member, value));
                default -> ShapeBuilder.super.setMemberValue(member, value);
            }
        }

        @Override
        public ShapeBuilder<ListObjectsV2Input> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 3 -> builder.maxKeys(de.readInteger(member));
                    case 4 -> builder.prefix(de.readString(member));
                    case 5 -> builder.continuationToken(de.readString(member));
                    case 6 -> builder.fetchOwner(de.readBoolean(member));
                    case 7 -> builder.startAfter(de.readString(member));
                    case 8 -> builder.requestPayer(RequestPayer.builder().deserializeMember(de, member).build());
                    case 9 -> builder.expectedBucketOwner(de.readString(member));
                    case 10 -> builder.optionalObjectAttributes(SharedSerde.deserializeOptionalObjectAttributesList(member, de));
