...
@SmithyGenerated
public final class DeleteBucketLifecycleInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_LIFECYCLE_INPUT;
    ...
    private DeleteBucketLifecycleInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketLifecycleInput that = (DeleteBucketLifecycleInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketLifecycleInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketLifecycleInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketLifecycleInput> {
        ...
        public DeleteBucketLifecycleInput build() {
            tracker.validate();
            return new DeleteBucketLifecycleInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketLifecycleInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
