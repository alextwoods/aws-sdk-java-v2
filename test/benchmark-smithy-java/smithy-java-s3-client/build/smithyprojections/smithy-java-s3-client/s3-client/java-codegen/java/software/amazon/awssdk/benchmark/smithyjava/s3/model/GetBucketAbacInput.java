...
@SmithyGenerated
public final class GetBucketAbacInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.GET_BUCKET_ABAC_INPUT;
    ...
    private GetBucketAbacInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketAbacInput that = (GetBucketAbacInput) other;
     ...
     *
     * @return a builder for {@link GetBucketAbacInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketAbacInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketAbacInput> {
        ...
        @Override
        public GetBucketAbacInput build() {
            tracker.validate();
            return new GetBucketAbacInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketAbacInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
