 ...
 */
@SmithyGenerated
public final class AnnotationLimitExceeded extends S3Exception {

    public static final Schema $SCHEMA = Schemas6.ANNOTATION_LIMIT_EXCEEDED;

    public static final ShapeId $ID = $SCHEMA.id();

    private AnnotationLimitExceeded(Builder builder) {
     ...
     *
     * @return a builder for {@link AnnotationLimitExceeded}.
     */
    ...
    /**
     * Builder for {@link AnnotationLimitExceeded}.
     */
    public static final class Builder implements ShapeBuilder<AnnotationLimitExceeded> {
        ...
        @Override
        public AnnotationLimitExceeded build() {
            return new AnnotationLimitExceeded(this);
        }
