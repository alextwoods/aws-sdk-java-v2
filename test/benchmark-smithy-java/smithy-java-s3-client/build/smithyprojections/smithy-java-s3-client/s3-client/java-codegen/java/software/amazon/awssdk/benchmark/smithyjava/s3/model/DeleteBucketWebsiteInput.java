...
@SmithyGenerated
public final class DeleteBucketWebsiteInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_WEBSITE_INPUT;
    ...
    private DeleteBucketWebsiteInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketWebsiteInput that = (DeleteBucketWebsiteInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketWebsiteInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketWebsiteInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketWebsiteInput> {
        ...
        public DeleteBucketWebsiteInput build() {
            tracker.validate();
            return new DeleteBucketWebsiteInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketWebsiteInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
