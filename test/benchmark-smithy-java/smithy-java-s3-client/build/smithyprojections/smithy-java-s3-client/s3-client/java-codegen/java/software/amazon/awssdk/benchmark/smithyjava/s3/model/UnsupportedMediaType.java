 ...
 */
@SmithyGenerated
public final class UnsupportedMediaType extends S3Exception {

    public static final Schema $SCHEMA = Schemas6.UNSUPPORTED_MEDIA_TYPE;

    public static final ShapeId $ID = $SCHEMA.id();

    private UnsupportedMediaType(Builder builder) {
     ...
     *
     * @return a builder for {@link UnsupportedMediaType}.
     */
    ...
    /**
     * Builder for {@link UnsupportedMediaType}.
     */
    public static final class Builder implements ShapeBuilder<UnsupportedMediaType> {
