...
@SmithyGenerated
public final class GetObjectAclInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_OBJECT_ACL_INPUT;
    ...
    private GetObjectAclInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetObjectAclInput that = (GetObjectAclInput) other;
     ...
     *
     * @return a builder for {@link GetObjectAclInput}.
     */
    ...
    /**
     * Builder for {@link GetObjectAclInput}.
     */
    public static final class Builder implements ShapeBuilder<GetObjectAclInput> {
        ...
        @Override
        public GetObjectAclInput build() {
            tracker.validate();
            return new GetObjectAclInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetObjectAclInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
