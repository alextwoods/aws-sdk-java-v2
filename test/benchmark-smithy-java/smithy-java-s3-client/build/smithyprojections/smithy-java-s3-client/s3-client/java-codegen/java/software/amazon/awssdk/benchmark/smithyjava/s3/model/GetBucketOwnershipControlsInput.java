...
@SmithyGenerated
public final class GetBucketOwnershipControlsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_OWNERSHIP_CONTROLS_INPUT;
    ...
    private GetBucketOwnershipControlsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketOwnershipControlsInput that = (GetBucketOwnershipControlsInput) other;
     ...
     *
     * @return a builder for {@link GetBucketOwnershipControlsInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketOwnershipControlsInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketOwnershipControlsInput> {
        ...
        @Override
        public GetBucketOwnershipControlsInput build() {
            tracker.validate();
            return new GetBucketOwnershipControlsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketOwnershipControlsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
