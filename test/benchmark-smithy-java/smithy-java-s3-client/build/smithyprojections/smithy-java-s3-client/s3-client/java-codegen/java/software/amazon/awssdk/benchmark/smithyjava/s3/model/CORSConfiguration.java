 ...
 */
@SmithyGenerated
public final class CORSConfiguration implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.CORS_CONFIGURATION;
    ...
    private CORSConfiguration(Builder builder) {
        this.corsRules = Collections.unmodifiableList(builder.corsRules);
    }
    ...
    public boolean equals(Object other) {
        ...
        CORSConfiguration that = (CORSConfiguration) other;
     ...
     *
     * @return a builder for {@link CORSConfiguration}.
     */
     ...
     */
    public static final class Builder implements ShapeBuilder<CORSConfiguration> {
        ...
        public Builder corsRules(List<CORSRule> corsRules) {
            this.corsRules = Objects.requireNonNull(corsRules, "corsRules cannot be null");
            tracker.setMember($SCHEMA_CORS_RULES);
            return this;
        }
        ...
        @Override
        public ShapeBuilder<CORSConfiguration> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            if (!tracker.checkMember($SCHEMA_CORS_RULES)) {
                corsRules(Collections.emptyList());
            }
            return this;
        }
