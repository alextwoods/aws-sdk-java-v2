...
@SmithyGenerated
public final class GetBucketLoggingInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_LOGGING_INPUT;
    ...
    private GetBucketLoggingInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketLoggingInput that = (GetBucketLoggingInput) other;
     ...
     *
     * @return a builder for {@link GetBucketLoggingInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketLoggingInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketLoggingInput> {
        ...
        @Override
        public GetBucketLoggingInput build() {
            tracker.validate();
            return new GetBucketLoggingInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketLoggingInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
