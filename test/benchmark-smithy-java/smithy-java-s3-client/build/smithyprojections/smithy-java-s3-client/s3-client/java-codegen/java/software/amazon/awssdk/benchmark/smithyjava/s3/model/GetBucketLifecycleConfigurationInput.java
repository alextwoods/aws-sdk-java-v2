...
@SmithyGenerated
public final class GetBucketLifecycleConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_LIFECYCLE_CONFIGURATION_INPUT;
    ...
    private GetBucketLifecycleConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketLifecycleConfigurationInput that = (GetBucketLifecycleConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketLifecycleConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketLifecycleConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketLifecycleConfigurationInput> {
        ...
        @Override
        public GetBucketLifecycleConfigurationInput build() {
            tracker.validate();
            return new GetBucketLifecycleConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketLifecycleConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
