 ...
 */
@SmithyGenerated
public sealed interface AnalyticsFilter extends SerializableStruct {
    Schema $SCHEMA = Schemas1.ANALYTICS_FILTER;
     ...
     */
    @SmithyGenerated
    record PrefixMember(String prefix) implements AnalyticsFilter {
     ...
     */
    @SmithyGenerated
    record TagMember(Tag tag) implements AnalyticsFilter {
    ...
    /**
     * A conjunction (logical AND) of predicates, which is used in evaluating an analytics filter. The operator must have at
     * least two predicates.
     */
    @SmithyGenerated
    record AndMember(AnalyticsAndOperator and) implements AnalyticsFilter {
         ...
         */
        @Override
        public AnalyticsAndOperator getValue() {
            return and;
        }
    ...
    record $Unknown(String memberName) implements AnalyticsFilter {
        @Override
        ...
        private record $Hidden() implements AnalyticsFilter {
            @Override
            public void serializeMembers(ShapeSerializer serializer) {}
    ...
    /**
     * Builder for {@link AnalyticsFilter}.
     */
    final class Builder implements ShapeBuilder<AnalyticsFilter>, BuildStage {
        private AnalyticsFilter value;
        ...
        public BuildStage and(AnalyticsAndOperator value) {
        ...
        private BuildStage setValue(AnalyticsFilter value) {
            if (this.value != null) {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 2 -> and((AnalyticsAndOperator) SchemaUtils.validateSameMember(AndMember.$SCHEMA_AND, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 2 -> builder.and(AnalyticsAndOperator.builder().deserializeMember(de, member).build());
