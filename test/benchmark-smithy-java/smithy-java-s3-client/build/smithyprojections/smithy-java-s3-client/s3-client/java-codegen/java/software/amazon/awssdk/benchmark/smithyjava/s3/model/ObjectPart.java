 ...
 */
@SmithyGenerated
public final class ObjectPart implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.OBJECT_PART;
    ...
    private ObjectPart(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ObjectPart that = (ObjectPart) other;
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_SIZE, member, size);
     ...
     *
     * @return a builder for {@link ObjectPart}.
     */
    ...
    /**
     * Builder for {@link ObjectPart}.
     */
    public static final class Builder implements ShapeBuilder<ObjectPart> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> size((Long) SchemaUtils.validateSameMember($SCHEMA_SIZE, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.size(de.readLong(member));
