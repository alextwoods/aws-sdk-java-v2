...
@SmithyGenerated
public final class DeletePublicAccessBlockInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_PUBLIC_ACCESS_BLOCK_INPUT;
    ...
    private DeletePublicAccessBlockInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeletePublicAccessBlockInput that = (DeletePublicAccessBlockInput) other;
     ...
     *
     * @return a builder for {@link DeletePublicAccessBlockInput}.
     */
    ...
    /**
     * Builder for {@link DeletePublicAccessBlockInput}.
     */
    public static final class Builder implements ShapeBuilder<DeletePublicAccessBlockInput> {
        ...
        @Override
        public DeletePublicAccessBlockInput build() {
            tracker.validate();
            return new DeletePublicAccessBlockInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeletePublicAccessBlockInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
