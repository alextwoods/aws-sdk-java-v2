...
@SmithyGenerated
public final class GetBucketIntelligentTieringConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_INTELLIGENT_TIERING_CONFIGURATION_INPUT;
    ...
    private GetBucketIntelligentTieringConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketIntelligentTieringConfigurationInput that = (GetBucketIntelligentTieringConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketIntelligentTieringConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketIntelligentTieringConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketIntelligentTieringConfigurationInput> {
        ...
        @Override
        public GetBucketIntelligentTieringConfigurationInput build() {
            tracker.validate();
            return new GetBucketIntelligentTieringConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketIntelligentTieringConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
