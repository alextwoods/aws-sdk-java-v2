...
@SmithyGenerated
public final class GetPublicAccessBlockInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.GET_PUBLIC_ACCESS_BLOCK_INPUT;
    ...
    private GetPublicAccessBlockInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetPublicAccessBlockInput that = (GetPublicAccessBlockInput) other;
     ...
     *
     * @return a builder for {@link GetPublicAccessBlockInput}.
     */
    ...
    /**
     * Builder for {@link GetPublicAccessBlockInput}.
     */
    public static final class Builder implements ShapeBuilder<GetPublicAccessBlockInput> {
        ...
        @Override
        public GetPublicAccessBlockInput build() {
            tracker.validate();
            return new GetPublicAccessBlockInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetPublicAccessBlockInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
