...
@SmithyGenerated
public final class ListBucketMetricsConfigurationsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas4.LIST_BUCKET_METRICS_CONFIGURATIONS_INPUT;
    ...
    private ListBucketMetricsConfigurationsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        ListBucketMetricsConfigurationsInput that = (ListBucketMetricsConfigurationsInput) other;
     ...
     *
     * @return a builder for {@link ListBucketMetricsConfigurationsInput}.
     */
    ...
    /**
     * Builder for {@link ListBucketMetricsConfigurationsInput}.
     */
    public static final class Builder implements ShapeBuilder<ListBucketMetricsConfigurationsInput> {
        ...
        @Override
        public ListBucketMetricsConfigurationsInput build() {
            tracker.validate();
            return new ListBucketMetricsConfigurationsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<ListBucketMetricsConfigurationsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
