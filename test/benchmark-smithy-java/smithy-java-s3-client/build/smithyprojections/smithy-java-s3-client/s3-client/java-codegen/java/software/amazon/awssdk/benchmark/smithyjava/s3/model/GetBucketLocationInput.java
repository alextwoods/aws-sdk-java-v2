...
@SmithyGenerated
public final class GetBucketLocationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_LOCATION_INPUT;
    ...
    private GetBucketLocationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketLocationInput that = (GetBucketLocationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketLocationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketLocationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketLocationInput> {
        ...
        public GetBucketLocationInput build() {
            tracker.validate();
            return new GetBucketLocationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketLocationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
