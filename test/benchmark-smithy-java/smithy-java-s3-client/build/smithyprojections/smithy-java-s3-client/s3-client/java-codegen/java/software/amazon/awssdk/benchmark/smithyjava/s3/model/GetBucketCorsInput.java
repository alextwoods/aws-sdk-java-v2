...
@SmithyGenerated
public final class GetBucketCorsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_CORS_INPUT;
    ...
    private GetBucketCorsInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketCorsInput that = (GetBucketCorsInput) other;
     ...
     *
     * @return a builder for {@link GetBucketCorsInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketCorsInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketCorsInput> {
        ...
        public GetBucketCorsInput build() {
            tracker.validate();
            return new GetBucketCorsInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketCorsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
