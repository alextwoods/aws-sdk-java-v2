...
@SmithyGenerated
public final class GetObjectInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_OBJECT_INPUT;
    ...
    private GetObjectInput(Builder builder) {
     ...
     *
     * <p><b>Object Lambda access points</b> - When you use this action with an Object Lambda access point, you must
     ...
     * as follows: <code>If-Match</code> condition evaluates to <code>true</code>, and; <code>If-Unmodified-Since</code>
    ...
    /**
     * Return the object only if it has been modified since the specified time; otherwise, return a <code>304 Not
     * Modified</code> error.
     *
     * <p>If both of the <code>If-None-Match</code> and <code>If-Modified-Since</code> headers are present in the
     * request as follows:<code> If-None-Match</code> condition evaluates to <code>false</code>, and; <code>
     * If-Modified-Since</code> condition evaluates to <code>true</code>; then, S3 returns <code>304 Not Modified</code>
     * status code.
     *
     * <p>For more information about conditional requests, see <a href="https://tools.ietf.org/html/rfc7232">RFC 7232</a>.
     */
    ...
    /**
     * Return the object only if it has not been modified since the specified time; otherwise, return a <code>412
     * Precondition Failed</code> error.
     *
     * <p>If both of the <code>If-Match</code> and <code>If-Unmodified-Since</code> headers are present in the request
     * as follows: <code>If-Match</code> condition evaluates to <code>true</code>, and; <code>If-Unmodified-Since</code>
     * condition evaluates to <code>false</code>; then, S3 returns <code>200 OK</code> and the data requested.
    ...
    /**
     * Downloads the specified byte range of an object. For more information about the HTTP Range header, see <a href="https://www.rfc-editor.org/rfc/rfc9110.html#name-range">
     * https://www.rfc-editor.org/rfc/rfc9110.html#name-range</a>.
     *
     * <p>Amazon S3 doesn't support retrieving multiple ranges of data per <code>GET</code> request.
     */
     ...
     *
     * <p>By default, the <code>GetObject</code> operation returns the current version of an object. To return a
     * different version, use the <code>versionId</code> subresource.
     *
     * <ul>
     *   <li>
     *     If you include a <code>versionId</code> in your request header, you must have the <code>
     *     s3:GetObjectVersion</code> permission to access a specific version of an object. The <code>s3:GetObject</code>
     ...
     * </ul>
     *
     * <p>For more information about versioning, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketVersioning.html">PutBucketVersioning</a>.
     */
     ...
     *
     * <p>If you encrypt an object by using server-side encryption with customer-provided encryption keys (SSE-C) when
     ...
     * storing the data. The key must be appropriate for use with the algorithm specified in the <code>
     * x-amz-server-side-encryption-customer-algorithm</code> header.
     *
     * <p>If you encrypt an object by using server-side encryption with customer-provided encryption keys (SSE-C) when
     * you store the object in Amazon S3, then when you GET the object, you must use the following headers:
     *
    ...
    public boolean equals(Object other) {
        ...
        GetObjectInput that = (GetObjectInput) other;
     ...
     *
     * @return a builder for {@link GetObjectInput}.
     */
    ...
    /**
     * Builder for {@link GetObjectInput}.
     */
    public static final class Builder implements ShapeBuilder<GetObjectInput> {
        ...
        @Override
        public GetObjectInput build() {
            tracker.validate();
            return new GetObjectInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetObjectInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
