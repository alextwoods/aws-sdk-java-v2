...
public final class NoSuchBucket extends S3Exception {
    ...
    public static final Schema $SCHEMA = Schemas1.NO_SUCH_BUCKET;

    public static final ShapeId $ID = $SCHEMA.id();

    private NoSuchBucket(Builder builder) {
     ...
     *
     * @return a builder for {@link NoSuchBucket}.
     */
    ...
    /**
     * Builder for {@link NoSuchBucket}.
     */
    public static final class Builder implements ShapeBuilder<NoSuchBucket> {
        ...
        @Override
        public NoSuchBucket build() {
            return new NoSuchBucket(this);
        }
