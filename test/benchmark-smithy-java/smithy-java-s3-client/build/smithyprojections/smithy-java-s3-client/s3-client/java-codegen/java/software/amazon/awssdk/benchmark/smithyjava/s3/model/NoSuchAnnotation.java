 ...
 */
@SmithyGenerated
public final class NoSuchAnnotation extends S3Exception {

    public static final Schema $SCHEMA = Schemas3.NO_SUCH_ANNOTATION;

    public static final ShapeId $ID = $SCHEMA.id();

    private NoSuchAnnotation(Builder builder) {
     ...
     *
     * @return a builder for {@link NoSuchAnnotation}.
     */
    ...
    /**
     * Builder for {@link NoSuchAnnotation}.
     */
    public static final class Builder implements ShapeBuilder<NoSuchAnnotation> {
        ...
        @Override
        public NoSuchAnnotation build() {
            return new NoSuchAnnotation(this);
        }
