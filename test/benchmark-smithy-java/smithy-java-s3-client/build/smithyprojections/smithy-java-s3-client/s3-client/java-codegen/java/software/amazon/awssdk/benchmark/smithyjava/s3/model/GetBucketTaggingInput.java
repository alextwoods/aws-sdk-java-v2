...
@SmithyGenerated
public final class GetBucketTaggingInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_TAGGING_INPUT;
    ...
    private GetBucketTaggingInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketTaggingInput that = (GetBucketTaggingInput) other;
     ...
     *
     * @return a builder for {@link GetBucketTaggingInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketTaggingInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketTaggingInput> {
        ...
        @Override
        public GetBucketTaggingInput build() {
            tracker.validate();
            return new GetBucketTaggingInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketTaggingInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
