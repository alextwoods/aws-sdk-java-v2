...
@SmithyGenerated
public final class PutBucketOwnershipControlsInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.PUT_BUCKET_OWNERSHIP_CONTROLS_INPUT;
    ...
    private static final Schema $SCHEMA_OWNERSHIP_CONTROLS = $SCHEMA.member("OwnershipControls");
    ...
    private final transient OwnershipControls ownershipControls;
    private final transient ChecksumAlgorithm checksumAlgorithm;

    private PutBucketOwnershipControlsInput(Builder builder) {
     ...
     * corresponding <code>x-amz-checksum-<i>algorithm</i></code> header sent. Otherwise, Amazon S3 fails the request
     * with the HTTP status code <code>400 Bad Request</code>. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a>
    ...
    public boolean equals(Object other) {
        ...
        PutBucketOwnershipControlsInput that = (PutBucketOwnershipControlsInput) other;
        return Objects.equals(this.bucket, that.bucket)
               ...
               && Objects.equals(this.ownershipControls, that.ownershipControls);
    }
    ...
    public int hashCode() {
        ...
        $hc = 31 * $hc + Objects.hashCode(ownershipControls);
    ...
    public void serializeMembers(ShapeSerializer serializer) {
        ...
        if (ownershipControls != null) {
            serializer.writeStruct($SCHEMA_OWNERSHIP_CONTROLS, ownershipControls);
        }
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            ...
            case 1 -> (T) SchemaUtils.validateSameMember($SCHEMA_OWNERSHIP_CONTROLS, member, ownershipControls);
     ...
     *
     * @return a builder for {@link PutBucketOwnershipControlsInput}.
     */
    public Builder toBuilder() {
        ...
        builder.ownershipControls(this.ownershipControls);
    ...
    /**
     * Builder for {@link PutBucketOwnershipControlsInput}.
     */
    public static final class Builder implements ShapeBuilder<PutBucketOwnershipControlsInput> {
         ...
         * @return this builder.
         */
        public Builder ownershipControls(OwnershipControls ownershipControls) {
            this.ownershipControls = Objects.requireNonNull(ownershipControls, "ownershipControls cannot be null");
            tracker.setMember($SCHEMA_OWNERSHIP_CONTROLS);
            return this;
        }
        ...
        @Override
        public PutBucketOwnershipControlsInput build() {
            tracker.validate();
            return new PutBucketOwnershipControlsInput(this);
        }
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                ...
                case 1 -> ownershipControls((OwnershipControls) SchemaUtils.validateSameMember($SCHEMA_OWNERSHIP_CONTROLS, member, value));
        ...
        @Override
        public ShapeBuilder<PutBucketOwnershipControlsInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
            ...
            if (!tracker.checkMember($SCHEMA_OWNERSHIP_CONTROLS)) {
                tracker.setMember($SCHEMA_OWNERSHIP_CONTROLS);
            }
            return this;
        }
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    ...
                    case 1 -> builder.ownershipControls(OwnershipControls.builder().deserializeMember(de, member).build());
