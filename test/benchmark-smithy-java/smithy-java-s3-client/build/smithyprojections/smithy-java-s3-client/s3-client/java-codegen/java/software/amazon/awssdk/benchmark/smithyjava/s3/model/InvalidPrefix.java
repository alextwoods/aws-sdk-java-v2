 ...
 */
@SmithyGenerated
public final class InvalidPrefix extends S3Exception {

    public static final Schema $SCHEMA = Schemas4.INVALID_PREFIX;

    public static final ShapeId $ID = $SCHEMA.id();

    private InvalidPrefix(Builder builder) {
     ...
     *
     * @return a builder for {@link InvalidPrefix}.
     */
    ...
    /**
     * Builder for {@link InvalidPrefix}.
     */
    public static final class Builder implements ShapeBuilder<InvalidPrefix> {
        ...
        @Override
        public InvalidPrefix build() {
            return new InvalidPrefix(this);
        }
