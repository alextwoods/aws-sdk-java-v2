...
@SmithyGenerated
public final class GetBucketMetadataConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_METADATA_CONFIGURATION_INPUT;
    ...
    private GetBucketMetadataConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketMetadataConfigurationInput that = (GetBucketMetadataConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketMetadataConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketMetadataConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketMetadataConfigurationInput> {
        ...
        @Override
        public GetBucketMetadataConfigurationInput build() {
            tracker.validate();
            return new GetBucketMetadataConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketMetadataConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
