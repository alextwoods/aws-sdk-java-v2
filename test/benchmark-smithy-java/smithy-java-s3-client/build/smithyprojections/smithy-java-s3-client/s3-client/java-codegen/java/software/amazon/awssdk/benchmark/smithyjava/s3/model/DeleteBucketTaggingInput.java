...
@SmithyGenerated
public final class DeleteBucketTaggingInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_BUCKET_TAGGING_INPUT;
    ...
    private DeleteBucketTaggingInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteBucketTaggingInput that = (DeleteBucketTaggingInput) other;
     ...
     *
     * @return a builder for {@link DeleteBucketTaggingInput}.
     */
    ...
    /**
     * Builder for {@link DeleteBucketTaggingInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteBucketTaggingInput> {
        ...
        @Override
        public DeleteBucketTaggingInput build() {
            tracker.validate();
            return new DeleteBucketTaggingInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteBucketTaggingInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
