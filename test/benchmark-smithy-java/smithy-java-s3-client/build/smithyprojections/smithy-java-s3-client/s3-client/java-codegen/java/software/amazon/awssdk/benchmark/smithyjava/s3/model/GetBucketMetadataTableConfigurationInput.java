...
@SmithyGenerated
public final class GetBucketMetadataTableConfigurationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_METADATA_TABLE_CONFIGURATION_INPUT;
    ...
    private GetBucketMetadataTableConfigurationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketMetadataTableConfigurationInput that = (GetBucketMetadataTableConfigurationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketMetadataTableConfigurationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketMetadataTableConfigurationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketMetadataTableConfigurationInput> {
        ...
        @Override
        public GetBucketMetadataTableConfigurationInput build() {
            tracker.validate();
            return new GetBucketMetadataTableConfigurationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketMetadataTableConfigurationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
