 ...
 */
@SmithyGenerated
public final class Part implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas5.PART;
     ...
     * uploaded with the <code>CRC32</code> checksum algorithm. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a>
     ...
     * uploaded with the <code>CRC32C</code> checksum algorithm. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a>
     * in the <i>Amazon S3 User Guide</i>.
     */
     ...
     * uploaded with the <code>SHA1</code> checksum algorithm. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a>
     * in the <i>Amazon S3 User Guide</i>.
     */
     ...
     * uploaded with the <code>SHA256</code> checksum algorithm. For more information, see <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking object integrity</a>
     * in the <i>Amazon S3 User Guide</i>.
     */
    ...
    @Override
    public int hashCode() {
        int $hc = Objects.hashCode(partNumber);
    ...
    public <T> T getMemberValue(Schema member) {
        return switch (member.memberIndex()) {
            case 0 -> (T) SchemaUtils.validateSameMember($SCHEMA_PART_NUMBER, member, partNumber);
     ...
     *
     * @return a builder for {@link Part}.
     */
    ...
    /**
     * Builder for {@link Part}.
     */
    public static final class Builder implements ShapeBuilder<Part> {
        ...
        public void setMemberValue(Schema member, Object value) {
            switch (member.memberIndex()) {
                case 0 -> partNumber((Integer) SchemaUtils.validateSameMember($SCHEMA_PART_NUMBER, member, value));
        ...
        private static final class $InnerDeserializer implements ShapeDeserializer.StructMemberConsumer<Builder> {
            ...
            public void accept(Builder builder, Schema member, ShapeDeserializer de) {
                switch (member.memberIndex()) {
                    case 0 -> builder.partNumber(de.readInteger(member));
