...
public final class BucketAlreadyExists extends S3Exception {
    ...
    public static final Schema $SCHEMA = Schemas.BUCKET_ALREADY_EXISTS;

    public static final ShapeId $ID = $SCHEMA.id();

    private BucketAlreadyExists(Builder builder) {
     ...
     *
     * @return a builder for {@link BucketAlreadyExists}.
     */
    ...
    /**
     * Builder for {@link BucketAlreadyExists}.
     */
    public static final class Builder implements ShapeBuilder<BucketAlreadyExists> {
        ...
        @Override
        public BucketAlreadyExists build() {
            return new BucketAlreadyExists(this);
        }
