...
@SmithyGenerated
public final class DeleteObjectTaggingInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas1.DELETE_OBJECT_TAGGING_INPUT;
    ...
    private DeleteObjectTaggingInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        DeleteObjectTaggingInput that = (DeleteObjectTaggingInput) other;
     ...
     *
     * @return a builder for {@link DeleteObjectTaggingInput}.
     */
    ...
    /**
     * Builder for {@link DeleteObjectTaggingInput}.
     */
    public static final class Builder implements ShapeBuilder<DeleteObjectTaggingInput> {
        ...
        public DeleteObjectTaggingInput build() {
            tracker.validate();
            return new DeleteObjectTaggingInput(this);
        }
        ...
        @Override
        public ShapeBuilder<DeleteObjectTaggingInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
