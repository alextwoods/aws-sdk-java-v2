...
@SmithyGenerated
public final class GetBucketVersioningInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_VERSIONING_INPUT;
    ...
    private GetBucketVersioningInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketVersioningInput that = (GetBucketVersioningInput) other;
     ...
     *
     * @return a builder for {@link GetBucketVersioningInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketVersioningInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketVersioningInput> {
        ...
        public GetBucketVersioningInput build() {
            tracker.validate();
            return new GetBucketVersioningInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketVersioningInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
