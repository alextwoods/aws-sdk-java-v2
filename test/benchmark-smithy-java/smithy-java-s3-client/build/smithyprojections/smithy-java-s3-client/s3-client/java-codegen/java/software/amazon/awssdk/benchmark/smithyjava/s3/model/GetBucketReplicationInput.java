...
@SmithyGenerated
public final class GetBucketReplicationInput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas3.GET_BUCKET_REPLICATION_INPUT;
    ...
    private GetBucketReplicationInput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketReplicationInput that = (GetBucketReplicationInput) other;
     ...
     *
     * @return a builder for {@link GetBucketReplicationInput}.
     */
    ...
    /**
     * Builder for {@link GetBucketReplicationInput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketReplicationInput> {
        ...
        public GetBucketReplicationInput build() {
            tracker.validate();
            return new GetBucketReplicationInput(this);
        }
        ...
        @Override
        public ShapeBuilder<GetBucketReplicationInput> errorCorrection() {
            if (tracker.allSet()) {
                return this;
            }
