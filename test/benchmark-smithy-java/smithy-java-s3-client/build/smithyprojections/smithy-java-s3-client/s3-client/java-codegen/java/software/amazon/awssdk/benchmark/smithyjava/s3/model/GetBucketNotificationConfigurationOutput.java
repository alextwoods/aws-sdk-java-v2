 ...
 */
@SmithyGenerated
public final class GetBucketNotificationConfigurationOutput implements SerializableStruct {

    public static final Schema $SCHEMA = Schemas2.GET_BUCKET_NOTIFICATION_CONFIGURATION_OUTPUT;
    ...
    private GetBucketNotificationConfigurationOutput(Builder builder) {
    ...
    public boolean equals(Object other) {
        ...
        GetBucketNotificationConfigurationOutput that = (GetBucketNotificationConfigurationOutput) other;
     ...
     *
     * @return a builder for {@link GetBucketNotificationConfigurationOutput}.
     */
    ...
    /**
     * Builder for {@link GetBucketNotificationConfigurationOutput}.
     */
    public static final class Builder implements ShapeBuilder<GetBucketNotificationConfigurationOutput> {
        ...
        @Override
        public GetBucketNotificationConfigurationOutput build() {
            return new GetBucketNotificationConfigurationOutput(this);
        }
