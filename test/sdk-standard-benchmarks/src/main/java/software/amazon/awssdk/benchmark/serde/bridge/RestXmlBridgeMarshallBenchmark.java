...
/**
 * Bridge counterpart to {@link software.amazon.awssdk.benchmark.serde.RestXmlMarshallBenchmark}.
 *
 ...
 *       {@code RestXmlClientProtocol#createRequest(operation, input, context, endpoint)}.</li>
 * </ol>
 *
...
@Fork(3)
public class RestXmlBridgeMarshallBenchmark {

    private static final String INTERMEDIATE_MODEL_PATH = "models/awsrestxmldataplane-1999-12-31-intermediate.json";
    private static final String TEST_DATA_PATH = "serde-tests/rest-xml/input/rest_xml.json";
    ...
    public void setup() throws Exception {
        // --- v2 input (identical to RestXmlMarshallBenchmark) ---
        ...
        Model smithyModel;
        try (InputStream is = RestXmlBridgeMarshallBenchmark.class.getResourceAsStream(SMITHY_MODEL_PATH)) {
