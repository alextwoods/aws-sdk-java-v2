...
/**
 * Bridge counterpart to {@code RestXmlUnmarshallBenchmark}: deserializes a restXml response
...
@Fork(3)
public class RestXmlBridgeUnmarshallBenchmark {

    private static final String TEST_DATA_PATH = "serde-tests/rest-xml/output/rest_xml.json";
    private static final String SMITHY_MODEL_PATH = "/smithy-models/rest-xml/model.json";
    private static final ShapeId SERVICE_ID = ShapeId.from("com.amazonaws.sdk.benchmark#AwsRestXmlDataPlane");
    private static final String V2_MODEL_PKG = "software.amazon.awssdk.services.restxmldataplane.model.";
    ...
    public void setup() throws Exception {
        ...
        // RestXmlClientProtocol (HttpBindingClientProtocol) deserializes the body using its own
        // payloadMediaType (application/xml) and the binding schema; it does not read the response
        // Content-Type. The v2 RestXmlUnmarshallBenchmark sets no hardcoded Content-Type either.
        ...
        Model smithyModel;
        try (InputStream is = RestXmlBridgeUnmarshallBenchmark.class.getResourceAsStream(SMITHY_MODEL_PATH)) {
        ...
        this.protocol = new RestXmlClientProtocol(SERVICE_ID);
        ...
        // v2 builder factory: services.restxmldataplane.model.<Op>Response.builder()
