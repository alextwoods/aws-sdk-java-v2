...
/**
 * Bridge counterpart to {@link software.amazon.awssdk.benchmark.serde.QueryMarshallBenchmark}.
 *
 ...
 *       {@code AwsQueryClientProtocol#createRequest(operation, input, context, endpoint)}.</li>
 * </ol>
 *
...
@Fork(3)
public class QueryBridgeMarshallBenchmark {
    ...
    // AwsQueryClientProtocol requires the service version (the Version form parameter); this matches
    // the version on the service shape in the smithy model.
    ...
    public void setup() throws Exception {
        // --- v2 input (identical to QueryMarshallBenchmark) ---
        ...
        Model smithyModel;
        try (InputStream is = QueryBridgeMarshallBenchmark.class.getResourceAsStream(SMITHY_MODEL_PATH)) {
        ...
        // DynamicClient's protocol auto-detection (which can't supply the required
        // serviceVersion setting for awsQuery) is bypassed.
