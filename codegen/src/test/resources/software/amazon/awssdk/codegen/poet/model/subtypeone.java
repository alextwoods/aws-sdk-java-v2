...
public final class SubTypeOne implements SdkPojo, Serializable, ToCopyableBuilder<SubTypeOne.Builder, SubTypeOne>, StructuredJsonWritable {
  private static final SdkField<String> SUB_TYPE_ONE_MEMBER_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  .memberName("SubTypeOneMember")
  .getter(getter(SubTypeOne::subTypeOneMember))
  .setter(setter(Builder::subTypeOneMember))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("SubTypeOneMember")
  .build()).build();
  ...
  private static final byte[] SUB_TYPE_ONE_MEMBER_FIELD_NAME_TOKEN = JsonFieldNameToken.of("SubTypeOneMember");
  ...
  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "SubTypeOneMember":return Optional.ofNullable(clazz.cast(subTypeOneMember()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (subTypeOneMember != null) {
      generator.writeFieldName("SubTypeOneMember", SUB_TYPE_ONE_MEMBER_FIELD_NAME_TOKEN);
      generator.writeValue(subTypeOneMember);
    }
  }

  static SubTypeOne $readJson(StructuredJsonReader reader) {
  ...
  static final class BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("SubTypeOneMember");
    ...
    private static void $readJsonMember(BuilderImpl b, int memberIndex,
      ...
      switch (memberIndex) {
        case 0: {
          b.subTypeOneMember = reader.readString();
          break;
        }
        default:
