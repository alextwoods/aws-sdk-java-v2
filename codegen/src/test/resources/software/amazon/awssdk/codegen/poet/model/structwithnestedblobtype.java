...
public final class StructWithNestedBlobType implements SdkPojo, Serializable, ToCopyableBuilder<StructWithNestedBlobType.Builder, StructWithNestedBlobType>, StructuredJsonWritable {
  private static final SdkField<SdkBytes> NESTED_BLOB_FIELD = SdkField.<SdkBytes>builder(MarshallingType.SDK_BYTES)
  .memberName("NestedBlob")
  .getter(getter(StructWithNestedBlobType::nestedBlob))
  .setter(setter(Builder::nestedBlob))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("NestedBlob")
  .build()).build();
  ...
  private static final byte[] NESTED_BLOB_FIELD_NAME_TOKEN = JsonFieldNameToken.of("NestedBlob");
  ...
  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "NestedBlob":return Optional.ofNullable(clazz.cast(nestedBlob()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (nestedBlob != null) {
      generator.writeFieldName("NestedBlob", NESTED_BLOB_FIELD_NAME_TOKEN);
      generator.writeBinaryValue(nestedBlob.asByteArrayUnsafe());
    }
  }
  ...
  static final class BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("NestedBlob");
