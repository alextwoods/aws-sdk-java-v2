...
public final class DeprecatedRenameRequest extends JsonProtocolTestsRequest implements ToCopyableBuilder<DeprecatedRenameRequest.Builder, DeprecatedRenameRequest>, StructuredJsonWritable {
  private static final SdkField<String> NEW_NAME_NO_DEPRECATION_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  .memberName("NewNameNoDeprecation")
  .getter(getter(DeprecatedRenameRequest::newNameNoDeprecation))
  ...
  .memberName("NewName")
  .getter(getter(DeprecatedRenameRequest::newName))
  ...
  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(NEW_NAME_NO_DEPRECATION_FIELD,NEW_NAME_FIELD));

  private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = memberNameToFieldInitializer();

  private static final byte[] NEW_NAME_NO_DEPRECATION_FIELD_NAME_TOKEN = JsonFieldNameToken.of("OriginalNameNoDeprecation");

  private static final byte[] NEW_NAME_FIELD_NAME_TOKEN = JsonFieldNameToken.of("OriginalNameDeprecated");
  ...
  public final String toString() {
    return ToString.builder("DeprecatedRenameRequest").add("NewNameNoDeprecation", newNameNoDeprecation()).add("NewName", newName()).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "NewNameNoDeprecation":return Optional.ofNullable(clazz.cast(newNameNoDeprecation()));
      case "NewName":return Optional.ofNullable(clazz.cast(newName()));
      case "OriginalNameDeprecated":return Optional.ofNullable(clazz.cast(newName()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (newNameNoDeprecation != null) {
      generator.writeFieldName("OriginalNameNoDeprecation", NEW_NAME_NO_DEPRECATION_FIELD_NAME_TOKEN);
      generator.writeValue(newNameNoDeprecation);
    }
    if (newName != null) {
      generator.writeFieldName("OriginalNameDeprecated", NEW_NAME_FIELD_NAME_TOKEN);
      generator.writeValue(newName);
    }
  }
  ...
  public interface Builder extends JsonProtocolTestsRequest.Builder, SdkPojo, CopyableBuilder<Builder, DeprecatedRenameRequest> {
     ...
     *
     * @param newNameNoDeprecation The new value for the NewNameNoDeprecation property for this object.
  ...
  static final class BuilderImpl extends JsonProtocolTestsRequest.BuilderImpl implements Builder {
    ...
    private BuilderImpl(DeprecatedRenameRequest model) {
      super(model);newNameNoDeprecation(model.newNameNoDeprecation);
