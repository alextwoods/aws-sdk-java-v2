...
public final class OperationWithDeprecatedMemberRequest extends JsonProtocolTestsRequest implements ToCopyableBuilder<OperationWithDeprecatedMemberRequest.Builder, OperationWithDeprecatedMemberRequest>, StructuredJsonWritable {
  ...
  .locationName("MemberModeledAsDeprecated")
  .build()).build();

  private static final SdkField<String> MEMBER_MODIFIED_AS_DEPRECATED_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  ...
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("MemberModifiedAsDeprecated")
  .build()).build();

  private static final SdkField<String> UNDEPRECATED_MEMBER_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  .memberName("UndeprecatedMember")
  .getter(getter(OperationWithDeprecatedMemberRequest::undeprecatedMember))
  .setter(setter(Builder::undeprecatedMember))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("UndeprecatedMember")
  .build()).build();

  private static final SdkField<String> MEMBER_IGNORE_DATA_TYPE_FAILURE_HANDLING_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  ...
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("MemberIgnoreDataTypeFailureHandling")
  .build(), new DataTypeConversionFailureHandlingTrait()).build();

  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(MEMBER_MODELED_AS_DEPRECATED_FIELD,MEMBER_MODIFIED_AS_DEPRECATED_FIELD,UNDEPRECATED_MEMBER_FIELD,MEMBER_IGNORE_DATA_TYPE_FAILURE_HANDLING_FIELD));

  private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = memberNameToFieldInitializer();

  private static final byte[] MEMBER_MODELED_AS_DEPRECATED_FIELD_NAME_TOKEN = JsonFieldNameToken.of("MemberModeledAsDeprecated");

  private static final byte[] MEMBER_MODIFIED_AS_DEPRECATED_FIELD_NAME_TOKEN = JsonFieldNameToken.of("MemberModifiedAsDeprecated");

  private static final byte[] UNDEPRECATED_MEMBER_FIELD_NAME_TOKEN = JsonFieldNameToken.of("UndeprecatedMember");

  private static final byte[] MEMBER_IGNORE_DATA_TYPE_FAILURE_HANDLING_FIELD_NAME_TOKEN = JsonFieldNameToken.of("MemberIgnoreDataTypeFailureHandling");
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return Objects.equals(memberModeledAsDeprecated(), other.memberModeledAsDeprecated())&&Objects.equals(memberModifiedAsDeprecated(), other.memberModifiedAsDeprecated())&&Objects.equals(undeprecatedMember(), other.undeprecatedMember())&&Objects.equals(memberIgnoreDataTypeFailureHandling(), other.memberIgnoreDataTypeFailureHandling());
  }
  ...
  public final String toString() {
    return ToString.builder("OperationWithDeprecatedMemberRequest").add("MemberModeledAsDeprecated", memberModeledAsDeprecated()).add("MemberModifiedAsDeprecated", memberModifiedAsDeprecated()).add("UndeprecatedMember", undeprecatedMember()).add("MemberIgnoreDataTypeFailureHandling", memberIgnoreDataTypeFailureHandling()).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "MemberModeledAsDeprecated":return Optional.ofNullable(clazz.cast(memberModeledAsDeprecated()));
      case "MemberModifiedAsDeprecated":return Optional.ofNullable(clazz.cast(memberModifiedAsDeprecated()));
      case "UndeprecatedMember":return Optional.ofNullable(clazz.cast(undeprecatedMember()));
      case "MemberIgnoreDataTypeFailureHandling":return Optional.ofNullable(clazz.cast(memberIgnoreDataTypeFailureHandling()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (memberModeledAsDeprecated != null) {
      generator.writeFieldName("MemberModeledAsDeprecated", MEMBER_MODELED_AS_DEPRECATED_FIELD_NAME_TOKEN);
      generator.writeValue(memberModeledAsDeprecated);
    }
    if (memberModifiedAsDeprecated != null) {
      generator.writeFieldName("MemberModifiedAsDeprecated", MEMBER_MODIFIED_AS_DEPRECATED_FIELD_NAME_TOKEN);
      generator.writeValue(memberModifiedAsDeprecated);
    }
    if (undeprecatedMember != null) {
      generator.writeFieldName("UndeprecatedMember", UNDEPRECATED_MEMBER_FIELD_NAME_TOKEN);
      generator.writeValue(undeprecatedMember);
    }
    if (memberIgnoreDataTypeFailureHandling != null) {
      generator.writeFieldName("MemberIgnoreDataTypeFailureHandling", MEMBER_IGNORE_DATA_TYPE_FAILURE_HANDLING_FIELD_NAME_TOKEN);
      generator.writeValue(memberIgnoreDataTypeFailureHandling);
    }
  }

  private static <T> Function<Object, T> getter(
      Function<OperationWithDeprecatedMemberRequest, T> g) {
  ...
  @Mutable
  @NotThreadSafe
  public interface Builder extends JsonProtocolTestsRequest.Builder, SdkPojo, CopyableBuilder<Builder, OperationWithDeprecatedMemberRequest> {
    /**
     ...
     *
     * @param memberIgnoreDataTypeFailureHandling The new value for the MemberIgnoreDataTypeFailureHandling property for this object.
     * @return Returns a reference to this object so that method calls can be chained together.
     */
  ...
  static final class BuilderImpl extends JsonProtocolTestsRequest.BuilderImpl implements Builder {
    ...
    private BuilderImpl(OperationWithDeprecatedMemberRequest model) {
      super(model);memberModeledAsDeprecated(model.memberModeledAsDeprecated);
    ...
    public final void setMemberIgnoreDataTypeFailureHandling(
        String memberIgnoreDataTypeFailureHandling) {
      this.memberIgnoreDataTypeFailureHandling = memberIgnoreDataTypeFailureHandling;
    }

    @Override
    public final Builder memberIgnoreDataTypeFailureHandling(
        String memberIgnoreDataTypeFailureHandling) {
      this.memberIgnoreDataTypeFailureHandling = memberIgnoreDataTypeFailureHandling;
      return this;
    }
