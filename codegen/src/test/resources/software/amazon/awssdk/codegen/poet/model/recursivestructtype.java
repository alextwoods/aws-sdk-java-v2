...
public final class RecursiveStructType implements SdkPojo, Serializable, ToCopyableBuilder<RecursiveStructType.Builder, RecursiveStructType>, StructuredJsonWritable {
  private static final SdkField<String> NO_RECURSE_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  .memberName("NoRecurse")
  .getter(getter(RecursiveStructType::noRecurse))
  .setter(setter(Builder::noRecurse))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("NoRecurse")
  .build()).build();

  private static final SdkField<RecursiveStructType> RECURSIVE_STRUCT_FIELD = SdkField.<RecursiveStructType>builder(MarshallingType.SDK_POJO)
  .memberName("RecursiveStruct")
  .getter(getter(RecursiveStructType::recursiveStruct))
  .setter(setter(Builder::recursiveStruct))
  .constructor(RecursiveStructType::builder)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("RecursiveStruct")
  .build()).build();

  private static final SdkField<List<RecursiveStructType>> RECURSIVE_LIST_FIELD = SdkField.<List<RecursiveStructType>>builder(MarshallingType.LIST)
  .memberName("RecursiveList")
  .getter(getter(RecursiveStructType::recursiveList))
  .setter(setter(Builder::recursiveList))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("RecursiveList")
  .build(), ListTrait.builder()
  .memberLocationName(null)
  .memberFieldInfo(SdkField.<RecursiveStructType>builder(MarshallingType.SDK_POJO)
  .constructor(RecursiveStructType::builder)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("member")
  ...
  private static final SdkField<Map<String, RecursiveStructType>> RECURSIVE_MAP_FIELD = SdkField.<Map<String, RecursiveStructType>>builder(MarshallingType.MAP)
  .memberName("RecursiveMap")
  .getter(getter(RecursiveStructType::recursiveMap))
  .setter(setter(Builder::recursiveMap))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("RecursiveMap")
  .build(), MapTrait.builder()
  .keyLocationName("key")
  .valueLocationName("value")
  .valueFieldInfo(SdkField.<RecursiveStructType>builder(MarshallingType.SDK_POJO)
  .constructor(RecursiveStructType::builder)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("value")
  ...
  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(NO_RECURSE_FIELD,RECURSIVE_STRUCT_FIELD,RECURSIVE_LIST_FIELD,RECURSIVE_MAP_FIELD));

  private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = memberNameToFieldInitializer();

  private static final byte[] NO_RECURSE_FIELD_NAME_TOKEN = JsonFieldNameToken.of("NoRecurse");

  private static final byte[] RECURSIVE_STRUCT_FIELD_NAME_TOKEN = JsonFieldNameToken.of("RecursiveStruct");

  private static final byte[] RECURSIVE_LIST_FIELD_NAME_TOKEN = JsonFieldNameToken.of("RecursiveList");

  private static final byte[] RECURSIVE_MAP_FIELD_NAME_TOKEN = JsonFieldNameToken.of("RecursiveMap");
  ...
  /**
   * For responses, this returns true if the service returned a value for the RecursiveList property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasRecursiveList} method.
   * </p>
  ...
  /**
   * For responses, this returns true if the service returned a value for the RecursiveMap property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasRecursiveMap} method.
   * </p>
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return Objects.equals(noRecurse(), other.noRecurse())&&Objects.equals(recursiveStruct(), other.recursiveStruct())&&hasRecursiveList() == other.hasRecursiveList() && Objects.equals(recursiveList(), other.recursiveList())&&hasRecursiveMap() == other.hasRecursiveMap() && Objects.equals(recursiveMap(), other.recursiveMap());
  }
  ...
  public final String toString() {
    return ToString.builder("RecursiveStructType").add("NoRecurse", noRecurse()).add("RecursiveStruct", recursiveStruct()).add("RecursiveList", hasRecursiveList() ? recursiveList() : null).add("RecursiveMap", hasRecursiveMap() ? recursiveMap() : null).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "NoRecurse":return Optional.ofNullable(clazz.cast(noRecurse()));
      case "RecursiveStruct":return Optional.ofNullable(clazz.cast(recursiveStruct()));
      case "RecursiveList":return Optional.ofNullable(clazz.cast(recursiveList()));
      case "RecursiveMap":return Optional.ofNullable(clazz.cast(recursiveMap()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (noRecurse != null) {
      generator.writeFieldName("NoRecurse", NO_RECURSE_FIELD_NAME_TOKEN);
      generator.writeValue(noRecurse);
    }
    if (recursiveStruct != null) {
      generator.writeFieldName("RecursiveStruct", RECURSIVE_STRUCT_FIELD_NAME_TOKEN);
      generator.writeStartObject();
      recursiveStruct.marshallJsonFields(generator);
      generator.writeEndObject();
    }
    if (recursiveList != null && (!recursiveList.isEmpty() || !(recursiveList instanceof SdkAutoConstructList))) {
      generator.writeFieldName("RecursiveList", RECURSIVE_LIST_FIELD_NAME_TOKEN);
      generator.writeStartArray(recursiveList.size());
      for (RecursiveStructType item0 : recursiveList) {
        if (item0 == null) {
          generator.writeNull();
        } else {
          generator.writeStartObject();
          item0.marshallJsonFields(generator);
          generator.writeEndObject();
        }
      }
      generator.writeEndArray();
    }
    if (recursiveMap != null && (!recursiveMap.isEmpty() || !(recursiveMap instanceof SdkAutoConstructMap))) {
      generator.writeFieldName("RecursiveMap", RECURSIVE_MAP_FIELD_NAME_TOKEN);
      generator.writeStartObject();
      for (Map.Entry<String, RecursiveStructType> entry0 : recursiveMap.entrySet()) {
        if (entry0.getValue() != null) {
          generator.writeFieldName(entry0.getKey());
          generator.writeStartObject();
          entry0.getValue().marshallJsonFields(generator);
          generator.writeEndObject();
        }
      }
      generator.writeEndObject();
  ...
  public interface Builder extends SdkPojo, CopyableBuilder<Builder, RecursiveStructType> {
     ...
     * Sets the value of the RecursiveStruct property for this object.
     *
     * This is a convenience method that creates an instance of the {@link RecursiveStructType.Builder} avoiding the need to create one manually via {@link RecursiveStructType#builder()}.
     *
     * <p>When the {@link Consumer} completes, {@link RecursiveStructType.Builder#build()} is called immediately and its result is passed to {@link #recursiveStruct(RecursiveStructType)}.
     ...
     * Sets the value of the RecursiveList property for this object.
     *
     * This is a convenience method that creates an instance of the {@link software.amazon.awssdk.services.jsonprotocoltests.model.RecursiveStructType.Builder} avoiding the need to create one manually via {@link software.amazon.awssdk.services.jsonprotocoltests.model.RecursiveStructType#builder()}.
     *
     * <p>When the {@link Consumer} completes, {@link software.amazon.awssdk.services.jsonprotocoltests.model.RecursiveStructType.Builder#build()} is called immediately and its result is passed to {@link #recursiveList(List<RecursiveStructType>)}.
     * @param recursiveList a consumer that will call methods on {@link software.amazon.awssdk.services.jsonprotocoltests.model.RecursiveStructType.Builder}
     * @return Returns a reference to this object so that method calls can be chained together.
  ...
  static final class BuilderImpl implements Builder {
    ...
    public final List<Builder> getRecursiveList() {
      List<Builder> result = RecursiveListTypeCopier.copyToBuilder(this.recursiveList);if (result instanceof SdkAutoConstructList) {return null;}return result;
    }
    ...
    public final Builder recursiveList(RecursiveStructType... recursiveList) {
      recursiveList(Arrays.asList(recursiveList));return this;
    }

    @Override
    @SafeVarargs
    public final Builder recursiveList(Consumer<Builder>... recursiveList) {
      recursiveList(Stream.of(recursiveList).map(c -> RecursiveStructType.builder().applyMutation(c).build()).collect(Collectors.toList()));return this;
    }

    public final Map<String, Builder> getRecursiveMap() {
      Map<String, Builder> result = RecursiveMapTypeCopier.copyToBuilder(this.recursiveMap);if (result instanceof SdkAutoConstructMap) {return null;}return result;
    }
