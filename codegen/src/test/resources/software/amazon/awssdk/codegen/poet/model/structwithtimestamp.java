...
public final class StructWithTimestamp implements SdkPojo, Serializable, ToCopyableBuilder<StructWithTimestamp.Builder, StructWithTimestamp>, StructuredJsonWritable {
  private static final SdkField<Instant> NESTED_TIMESTAMP_FIELD = SdkField.<Instant>builder(MarshallingType.INSTANT)
  .memberName("NestedTimestamp")
  .getter(getter(StructWithTimestamp::nestedTimestamp))
  .setter(setter(Builder::nestedTimestamp))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("NestedTimestamp")
  .build()).build();
  ...
  private static final byte[] NESTED_TIMESTAMP_FIELD_NAME_TOKEN = JsonFieldNameToken.of("NestedTimestamp");
  ...
  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "NestedTimestamp":return Optional.ofNullable(clazz.cast(nestedTimestamp()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (nestedTimestamp != null) {
      generator.writeFieldName("NestedTimestamp", NESTED_TIMESTAMP_FIELD_NAME_TOKEN);
      generator.writeValue(nestedTimestamp);
    }
  }
  ...
  static final class BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("NestedTimestamp");
