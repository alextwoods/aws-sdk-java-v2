...
public final class OperationWithDeprecatedMemberResponse extends JsonProtocolTestsResponse implements ToCopyableBuilder<OperationWithDeprecatedMemberResponse.Builder, OperationWithDeprecatedMemberResponse> {
  ...
  .getter(getter(OperationWithDeprecatedMemberResponse::undeprecatedMember))
  ...
  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(MEMBER_MODELED_AS_DEPRECATED_FIELD,MEMBER_MODIFIED_AS_DEPRECATED_FIELD,UNDEPRECATED_MEMBER_FIELD));
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return Objects.equals(memberModeledAsDeprecated(), other.memberModeledAsDeprecated())&&Objects.equals(memberModifiedAsDeprecated(), other.memberModifiedAsDeprecated())&&Objects.equals(undeprecatedMember(), other.undeprecatedMember());
  }
  ...
  public final String toString() {
    return ToString.builder("OperationWithDeprecatedMemberResponse").add("MemberModeledAsDeprecated", memberModeledAsDeprecated()).add("MemberModifiedAsDeprecated", memberModifiedAsDeprecated()).add("UndeprecatedMember", undeprecatedMember()).build();
  }
  ...
  private static <T> Function<Object, T> getter(
      Function<OperationWithDeprecatedMemberResponse, T> g) {
  ...
  @Mutable
  @NotThreadSafe
  public interface Builder extends JsonProtocolTestsResponse.Builder, SdkPojo, CopyableBuilder<Builder, OperationWithDeprecatedMemberResponse> {
    /**
  ...
  static final class BuilderImpl extends JsonProtocolTestsResponse.BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("MemberModeledAsDeprecated", "MemberModifiedAsDeprecated", "UndeprecatedMember");
