...
public final class ContainsReservedKeyword implements SdkPojo, Serializable, ToCopyableBuilder<ContainsReservedKeyword.Builder, ContainsReservedKeyword>, StructuredJsonWritable {
  private static final SdkField<String> NUL_FIELD = SdkField.<String>builder(MarshallingType.STRING)
  .memberName("NUL")
  .getter(getter(ContainsReservedKeyword::nul))
  .setter(setter(Builder::nul))
  ...
  private static final byte[] NUL_FIELD_NAME_TOKEN = JsonFieldNameToken.of("NULL");
  ...
  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "NUL":return Optional.ofNullable(clazz.cast(nul()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (nul != null) {
      generator.writeFieldName("NULL", NUL_FIELD_NAME_TOKEN);
      generator.writeValue(nul);
    }
  }
  ...
  public interface Builder extends SdkPojo, CopyableBuilder<Builder, ContainsReservedKeyword> {
     ...
     *
     * @param nul The new value for the NUL property for this object.
