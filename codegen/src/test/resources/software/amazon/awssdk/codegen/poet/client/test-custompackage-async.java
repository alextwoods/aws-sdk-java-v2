 ...
 *
 * @see ProtocolRestJsonWithCustomPackageAsyncClient#builder()
 */
@Generated("software.amazon.awssdk:codegen")
@SdkInternalApi
final class DefaultProtocolRestJsonWithCustomPackageAsyncClient implements ProtocolRestJsonWithCustomPackageAsyncClient {
     ...
     *         credentials, etc.</li>
     *         <li>ProtocolRestJsonWithCustomPackageException Base class for all service exceptions. Unknown exceptions
     *         will be thrown as an instance of this type.</li>
     *         </ul>
     * @sample ProtocolRestJsonWithCustomPackageAsyncClient.OneOperation
