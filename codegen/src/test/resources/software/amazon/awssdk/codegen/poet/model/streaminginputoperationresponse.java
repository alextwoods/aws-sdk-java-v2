...
public final class StreamingInputOperationResponse extends JsonProtocolTestsResponse implements ToCopyableBuilder<StreamingInputOperationResponse.Builder, StreamingInputOperationResponse> {
  ...
  static StreamingInputOperationResponse $readJson(StructuredJsonReader reader) {
  ...
  @Mutable
  @NotThreadSafe
  public interface Builder extends JsonProtocolTestsResponse.Builder, SdkPojo, CopyableBuilder<Builder, StreamingInputOperationResponse> {
  }
