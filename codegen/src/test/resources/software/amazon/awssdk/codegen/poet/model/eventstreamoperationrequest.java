...
public final class EventStreamOperationRequest extends JsonProtocolTestsRequest implements ToCopyableBuilder<EventStreamOperationRequest.Builder, EventStreamOperationRequest>, StructuredJsonWritable {
  ...
  @Mutable
  @NotThreadSafe
  public interface Builder extends JsonProtocolTestsRequest.Builder, SdkPojo, CopyableBuilder<Builder, EventStreamOperationRequest> {
    @Override
