...
public final class ExistenceCheckNamingRequest extends JsonProtocolTestsRequest implements ToCopyableBuilder<ExistenceCheckNamingRequest.Builder, ExistenceCheckNamingRequest>, StructuredJsonWritable {
  private static final SdkField<List<String>> BUILD_FIELD = SdkField.<List<String>>builder(MarshallingType.LIST)
  .memberName("Build")
  ...
  private static final SdkField<List<String>> SUPER_FIELD = SdkField.<List<String>>builder(MarshallingType.LIST)
  .memberName("super")
  ...
  private static final SdkField<Map<String, String>> TO_STRING_FIELD = SdkField.<Map<String, String>>builder(MarshallingType.MAP)
  .memberName("toString")
  ...
  .valueFieldInfo(SdkField.<String>builder(MarshallingType.STRING)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("value")
  .build()).build())
  ...
  private static final SdkField<Map<String, String>> EQUALS_FIELD = SdkField.<Map<String, String>>builder(MarshallingType.MAP)
  .memberName("equals")
  ...
  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(BUILD_FIELD,SUPER_FIELD,TO_STRING_FIELD,EQUALS_FIELD));

  private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = memberNameToFieldInitializer();

  private static final byte[] BUILD_FIELD_NAME_TOKEN = JsonFieldNameToken.of("Build");

  private static final byte[] SUPER_FIELD_NAME_TOKEN = JsonFieldNameToken.of("super");

  private static final byte[] TO_STRING_FIELD_NAME_TOKEN = JsonFieldNameToken.of("toString");

  private static final byte[] EQUALS_FIELD_NAME_TOKEN = JsonFieldNameToken.of("equals");
  ...
  /**
   * For responses, this returns true if the service returned a value for the Build property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasBuild} method.
   * </p>
  ...
  /**
   * For responses, this returns true if the service returned a value for the Super property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasSuperValue} method.
   * </p>
  ...
  /**
   * For responses, this returns true if the service returned a value for the ToString property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasToStringValue} method.
   * </p>
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasEqualsValue} method.
   * </p>
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return hasBuild() == other.hasBuild() && Objects.equals(build(), other.build())&&hasSuperValue() == other.hasSuperValue() && Objects.equals(superValue(), other.superValue())&&hasToStringValue() == other.hasToStringValue() && Objects.equals(toStringValue(), other.toStringValue())&&hasEqualsValue() == other.hasEqualsValue() && Objects.equals(equalsValue(), other.equalsValue());
  }
  ...
  public final String toString() {
    return ToString.builder("ExistenceCheckNamingRequest").add("Build", hasBuild() ? build() : null).add("Super", hasSuperValue() ? superValue() : null).add("ToString", hasToStringValue() ? toStringValue() : null).add("Equals", hasEqualsValue() ? equalsValue() : null).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "Build":return Optional.ofNullable(clazz.cast(build()));
      case "super":return Optional.ofNullable(clazz.cast(superValue()));
      case "toString":return Optional.ofNullable(clazz.cast(toStringValue()));
      case "equals":return Optional.ofNullable(clazz.cast(equalsValue()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (build != null && (!build.isEmpty() || !(build instanceof SdkAutoConstructList))) {
      generator.writeFieldName("Build", BUILD_FIELD_NAME_TOKEN);
      generator.writeStartArray(build.size());
      for (String item0 : build) {
        if (item0 == null) {
          generator.writeNull();
        } else {
          generator.writeValue(item0);
        }
      }
      generator.writeEndArray();
    }
    if (superValue != null && (!superValue.isEmpty() || !(superValue instanceof SdkAutoConstructList))) {
      generator.writeFieldName("super", SUPER_FIELD_NAME_TOKEN);
      generator.writeStartArray(superValue.size());
      for (String item0 : superValue) {
        if (item0 == null) {
          generator.writeNull();
        } else {
          generator.writeValue(item0);
    ...
    if (toStringValue != null && (!toStringValue.isEmpty() || !(toStringValue instanceof SdkAutoConstructMap))) {
      generator.writeFieldName("toString", TO_STRING_FIELD_NAME_TOKEN);
      generator.writeStartObject();
      for (Map.Entry<String, String> entry0 : toStringValue.entrySet()) {
    ...
    if (equalsValue != null && (!equalsValue.isEmpty() || !(equalsValue instanceof SdkAutoConstructMap))) {
      generator.writeFieldName("equals", EQUALS_FIELD_NAME_TOKEN);
      generator.writeStartObject();
      for (Map.Entry<String, String> entry0 : equalsValue.entrySet()) {
        if (entry0.getValue() != null) {
          generator.writeFieldName(entry0.getKey());
          generator.writeValue(entry0.getValue());
        }
  ...
  @Mutable
  @NotThreadSafe
  public interface Builder extends JsonProtocolTestsRequest.Builder, SdkPojo, CopyableBuilder<Builder, ExistenceCheckNamingRequest> {
    /**
  ...
  static final class BuilderImpl extends JsonProtocolTestsRequest.BuilderImpl implements Builder {
    ...
    public final Collection<String> getBuild() {
      if (build instanceof SdkAutoConstructList) {return null;}return build;
    }
    ...
    public final Builder build(String... build) {
      build(Arrays.asList(build));return this;
    }

    public final Collection<String> getSuperValue() {
      if (superValue instanceof SdkAutoConstructList) {return null;}return superValue;
    }
    ...
    public final Builder superValue(String... superValue) {
      superValue(Arrays.asList(superValue));return this;
    }

    public final Map<String, String> getToStringValue() {
      if (toStringValue instanceof SdkAutoConstructMap) {return null;}return toStringValue;
    }
    ...
    public final Map<String, String> getEqualsValue() {
      if (equalsValue instanceof SdkAutoConstructMap) {return null;}return equalsValue;
    }
