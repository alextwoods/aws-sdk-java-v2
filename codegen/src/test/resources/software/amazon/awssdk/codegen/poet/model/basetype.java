...
public final class BaseType implements SdkPojo, Serializable, ToCopyableBuilder<BaseType.Builder, BaseType>, StructuredJsonWritable {
  ...
  .getter(getter(BaseType::baseMember))
  .setter(setter(Builder::baseMember))
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("BaseMember")
  .build()).build();
  ...
  private static final byte[] BASE_MEMBER_FIELD_NAME_TOKEN = JsonFieldNameToken.of("BaseMember");
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return Objects.equals(baseMember(), other.baseMember())&&Objects.equals(customShape1(), other.customShape1())&&Objects.equals(customShape2(), other.customShape2());
  }
  ...
  public final String toString() {
    return ToString.builder("BaseType").add("BaseMember", baseMember()).add("CustomShape1", customShape1()).add("CustomShape2", customShape2()).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "BaseMember":return Optional.ofNullable(clazz.cast(baseMember()));
      case "CustomShape1":return Optional.ofNullable(clazz.cast(customShape1()));
      case "CustomShape2":return Optional.ofNullable(clazz.cast(customShape2()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (baseMember != null) {
      generator.writeFieldName("BaseMember", BASE_MEMBER_FIELD_NAME_TOKEN);
      generator.writeValue(baseMember);
    }
  }

  static BaseType $readJson(StructuredJsonReader reader) {
  ...
  public interface Builder extends SdkPojo, CopyableBuilder<Builder, BaseType> {
    ...
    /**
     * Custom shape of type string
     * @param customShape1 Custom shape of type string
     * @return Returns a reference to this object so that method calls can be chained together.
     */
    ...
    /**
     * Custom shape of type integer
     * @param customShape2 Custom shape of type integer
     * @return Returns a reference to this object so that method calls can be chained together.
     */
  ...
  static final class BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("BaseMember");
    ...
    private static void $readJsonMember(BuilderImpl b, int memberIndex,
      ...
      switch (memberIndex) {
        case 0: {
          b.baseMember = reader.readString();
          break;
        }
        default:
