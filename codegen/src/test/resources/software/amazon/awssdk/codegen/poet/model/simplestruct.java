...
public final class SimpleStruct implements SdkPojo, Serializable, ToCopyableBuilder<SimpleStruct.Builder, SimpleStruct>, StructuredJsonWritable {
  ...
  .getter(getter(SimpleStruct::stringMember))
  ...
  static SimpleStruct $readJson(StructuredJsonReader reader) {
  ...
  static final class BuilderImpl implements Builder, StructuredJsonReadable {
    private static final JsonMemberTable $JSON_MEMBER_TABLE = JsonMemberTable.of("StringMember");
