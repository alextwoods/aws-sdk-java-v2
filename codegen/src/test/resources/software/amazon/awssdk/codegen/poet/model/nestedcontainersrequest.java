...
public final class NestedContainersRequest extends JsonProtocolTestsRequest implements ToCopyableBuilder<NestedContainersRequest.Builder, NestedContainersRequest>, StructuredJsonWritable {
  private static final SdkField<List<List<String>>> LIST_OF_LIST_OF_STRINGS_FIELD = SdkField.<List<List<String>>>builder(MarshallingType.LIST)
  ...
  .locationName("ListOfListOfStrings")
  .build(), ListTrait.builder()
  .memberLocationName(null)
  .memberFieldInfo(SdkField.<List<String>>builder(MarshallingType.LIST)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("member")
  .build(), ListTrait.builder()
  .memberLocationName(null)
  .memberFieldInfo(SdkField.<String>builder(MarshallingType.STRING)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("member")
  .build()).build())
  ...
  private static final SdkField<List<List<List<String>>>> LIST_OF_LIST_OF_LIST_OF_STRINGS_FIELD = SdkField.<List<List<List<String>>>>builder(MarshallingType.LIST)
  ...
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("ListOfListOfListOfStrings")
  .build(), ListTrait.builder()
  .memberLocationName(null)
  .memberFieldInfo(SdkField.<List<List<String>>>builder(MarshallingType.LIST)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("member")
  .build(), ListTrait.builder()
  ...
  private static final SdkField<Map<String, List<List<String>>>> MAP_OF_STRING_TO_LIST_OF_LIST_OF_STRINGS_FIELD = SdkField.<Map<String, List<List<String>>>>builder(MarshallingType.MAP)
  ...
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("MapOfStringToListOfListOfStrings")
  .build(), MapTrait.builder()
  .keyLocationName("key")
  .valueLocationName("value")
  .valueFieldInfo(SdkField.<List<List<String>>>builder(MarshallingType.LIST)
  .traits(LocationTrait.builder()
  .location(MarshallLocation.PAYLOAD)
  .locationName("value")
  .build(), ListTrait.builder()
  ...
  private static final List<SdkField<?>> SDK_FIELDS = Collections.unmodifiableList(Arrays.asList(LIST_OF_LIST_OF_STRINGS_FIELD,LIST_OF_LIST_OF_LIST_OF_STRINGS_FIELD,MAP_OF_STRING_TO_LIST_OF_LIST_OF_STRINGS_FIELD));

  private static final Map<String, SdkField<?>> SDK_NAME_TO_FIELD = memberNameToFieldInitializer();

  private static final byte[] LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN = JsonFieldNameToken.of("ListOfListOfStrings");

  private static final byte[] LIST_OF_LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN = JsonFieldNameToken.of("ListOfListOfListOfStrings");

  private static final byte[] MAP_OF_STRING_TO_LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN = JsonFieldNameToken.of("MapOfStringToListOfListOfStrings");
  ...
  /**
   * For responses, this returns true if the service returned a value for the ListOfListOfStrings property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasListOfListOfStrings} method.
   * </p>
  ...
  /**
   * For responses, this returns true if the service returned a value for the ListOfListOfListOfStrings property. This DOES NOT check that the value is non-empty (for which, you should check the {@code isEmpty()} method on the property). This is useful because the SDK will never return a null collection or map, but you may need to differentiate between the service returning nothing (or null) and the service returning an empty collection or map. For requests, this returns true if a value for the property was specified in the request builder, and false if a value was not specified.
   */
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasListOfListOfListOfStrings} method.
   * </p>
   ...
   * </p>
   * <p>
   * This method will never return null. If you would like to know whether the service returned this field (so that you can differentiate between null and empty), you can use the {@link #hasMapOfStringToListOfListOfStrings} method.
   * </p>
  ...
  public final int hashCode() {
    ...
    hashCode = 31 * hashCode + Objects.hashCode(hasMapOfStringToListOfListOfStrings() ? mapOfStringToListOfListOfStrings() : null);
    return hashCode;
  }
  ...
  public final boolean equalsBySdkFields(Object obj) {
    ...
    return hasListOfListOfStrings() == other.hasListOfListOfStrings() && Objects.equals(listOfListOfStrings(), other.listOfListOfStrings())&&hasListOfListOfListOfStrings() == other.hasListOfListOfListOfStrings() && Objects.equals(listOfListOfListOfStrings(), other.listOfListOfListOfStrings())&&hasMapOfStringToListOfListOfStrings() == other.hasMapOfStringToListOfListOfStrings() && Objects.equals(mapOfStringToListOfListOfStrings(), other.mapOfStringToListOfListOfStrings());
  }
  ...
  public final String toString() {
    return ToString.builder("NestedContainersRequest").add("ListOfListOfStrings", hasListOfListOfStrings() ? listOfListOfStrings() : null).add("ListOfListOfListOfStrings", hasListOfListOfListOfStrings() ? listOfListOfListOfStrings() : null).add("MapOfStringToListOfListOfStrings", hasMapOfStringToListOfListOfStrings() ? mapOfStringToListOfListOfStrings() : null).build();
  }

  public final <T> Optional<T> getValueForField(String fieldName, Class<T> clazz) {
    switch (fieldName) {
      case "ListOfListOfStrings":return Optional.ofNullable(clazz.cast(listOfListOfStrings()));
      case "ListOfListOfListOfStrings":return Optional.ofNullable(clazz.cast(listOfListOfListOfStrings()));
      case "MapOfStringToListOfListOfStrings":return Optional.ofNullable(clazz.cast(mapOfStringToListOfListOfStrings()));
  ...
  public final void marshallJsonFields(StructuredJsonGenerator generator) {
    if (listOfListOfStrings != null && (!listOfListOfStrings.isEmpty() || !(listOfListOfStrings instanceof SdkAutoConstructList))) {
      generator.writeFieldName("ListOfListOfStrings", LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN);
      generator.writeStartArray(listOfListOfStrings.size());
      for (List<String> item0 : listOfListOfStrings) {
        if (item0 == null) {
          generator.writeNull();
        } else if (!item0.isEmpty() || !(item0 instanceof SdkAutoConstructList)) {
          generator.writeStartArray(item0.size());
          for (String item1 : item0) {
            if (item1 == null) {
              generator.writeNull();
            } else {
              generator.writeValue(item1);
            }
          }
    ...
    if (listOfListOfListOfStrings != null && (!listOfListOfListOfStrings.isEmpty() || !(listOfListOfListOfStrings instanceof SdkAutoConstructList))) {
      generator.writeFieldName("ListOfListOfListOfStrings", LIST_OF_LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN);
      generator.writeStartArray(listOfListOfListOfStrings.size());
      for (List<List<String>> item0 : listOfListOfListOfStrings) {
        if (item0 == null) {
          generator.writeNull();
        } else if (!item0.isEmpty() || !(item0 instanceof SdkAutoConstructList)) {
          generator.writeStartArray(item0.size());
          for (List<String> item1 : item0) {
            if (item1 == null) {
              generator.writeNull();
            } else if (!item1.isEmpty() || !(item1 instanceof SdkAutoConstructList)) {
              generator.writeStartArray(item1.size());
              for (String item2 : item1) {
                if (item2 == null) {
                  generator.writeNull();
                } else {
                  generator.writeValue(item2);
                }
              }
              generator.writeEndArray();
            }
    ...
    if (mapOfStringToListOfListOfStrings != null && (!mapOfStringToListOfListOfStrings.isEmpty() || !(mapOfStringToListOfListOfStrings instanceof SdkAutoConstructMap))) {
      generator.writeFieldName("MapOfStringToListOfListOfStrings", MAP_OF_STRING_TO_LIST_OF_LIST_OF_STRINGS_FIELD_NAME_TOKEN);
      generator.writeStartObject();
      for (Map.Entry<String, List<List<String>>> entry0 : mapOfStringToListOfListOfStrings.entrySet()) {
        if (entry0.getValue() != null && (!entry0.getValue().isEmpty() || !(entry0.getValue() instanceof SdkAutoConstructList))) {
          generator.writeFieldName(entry0.getKey());
          generator.writeStartArray(entry0.getValue().size());
          for (List<String> item1 : entry0.getValue()) {
            if (item1 == null) {
              generator.writeNull();
            } else if (!item1.isEmpty() || !(item1 instanceof SdkAutoConstructList)) {
              generator.writeStartArray(item1.size());
  ...
  public interface Builder extends JsonProtocolTestsRequest.Builder, SdkPojo, CopyableBuilder<Builder, NestedContainersRequest> {
     ...
     */
    Builder listOfListOfListOfStrings(
        Collection<? extends Collection<String>>... listOfListOfListOfStrings);

    /**
     * Sets the value of the MapOfStringToListOfListOfStrings property for this object.
     *
     * @param mapOfStringToListOfListOfStrings The new value for the MapOfStringToListOfListOfStrings property for this object.
     * @return Returns a reference to this object so that method calls can be chained together.
     */
  ...
  static final class BuilderImpl extends JsonProtocolTestsRequest.BuilderImpl implements Builder {
    ...
    public final Collection<? extends Collection<String>> getListOfListOfStrings() {
      if (listOfListOfStrings instanceof SdkAutoConstructList) {return null;}return listOfListOfStrings;
    }

    public final void setListOfListOfStrings(
        Collection<? extends Collection<String>> listOfListOfStrings) {
      this.listOfListOfStrings = ListOfListOfStringsCopier.copy(listOfListOfStrings);
    }

    @Override
    public final Builder listOfListOfStrings(
        Collection<? extends Collection<String>> listOfListOfStrings) {
      this.listOfListOfStrings = ListOfListOfStringsCopier.copy(listOfListOfStrings);
      return this;
    }
    ...
    public final Builder listOfListOfStrings(Collection<String>... listOfListOfStrings) {
      listOfListOfStrings(Arrays.asList(listOfListOfStrings));return this;
    }

    public final Collection<? extends Collection<? extends Collection<String>>> getListOfListOfListOfStrings(
        ) {
      if (listOfListOfListOfStrings instanceof SdkAutoConstructList) {return null;}return listOfListOfListOfStrings;
    }
    ...
    public final Builder listOfListOfListOfStrings(
        Collection<? extends Collection<String>>... listOfListOfListOfStrings) {
      listOfListOfListOfStrings(Arrays.asList(listOfListOfListOfStrings));return this;
    }

    public final Map<String, ? extends Collection<? extends Collection<String>>> getMapOfStringToListOfListOfStrings(
        ) {
      if (mapOfStringToListOfListOfStrings instanceof SdkAutoConstructMap) {return null;}return mapOfStringToListOfListOfStrings;
    }
