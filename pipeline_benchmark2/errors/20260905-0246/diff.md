# Error behavior diff — `20260905-0246`
...
|---|---|---:|---:|
| `throttling` | transient | 1,481 | 732 |
| `internal-error` | persistent | 57 | 209 |
| `internal-error` | transient | 254 | 93 |
| `unavailable` | transient | 298 | 142 |
| `resource-not-found` | persistent | 6 | 3 |
| `conditional-check-failed` | persistent | 6 | 2 |
| `malformed-body` | persistent | 191 | 65 |
| `malformed-body` | transient | 189 | 44 |
| `empty-500` | persistent | 69 | 150 |
| `empty-500` | transient | 73 | 178 |
| `truncated-stream` | transient | 111 | 27 |
| `connection-reset` | persistent | 103 | 2 |
| `connection-reset` | transient | 107 | 2 |
...
|---|---|---|---:|---|---|---|---:|---|---|---|---:|
| `none` | control | `baseline` | 1 | ok | `-` | - | - | - | - | - | 186 |
| `none` | control | `bridge` | 1 | ok | `-` | - | - | - | - | - | 149 |
| `throughput-exceeded` | persistent | `baseline` | 3 | throw | `ProvisionedThroughputExceededException` | ProvisionedThroughputExceededException | 400 | FAULTREQID000000000000000 | false | true | 605 |
| `throughput-exceeded` | persistent | `bridge` | 3 | throw | `ProvisionedThroughputExceededException` | ProvisionedThroughputExceededException | 400 | FAULTREQID000000000000000 | false | true | 1154 |
| `throughput-exceeded` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 1490 |
| `throughput-exceeded` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 2097 |
| `throttling` | persistent | `baseline` | 3 | throw | `ThrottlingException` | ThrottlingException | 400 | FAULTREQID000000000000000 | false | true | 1526 |
| `throttling` | persistent | `bridge` | 3 | throw | `ThrottlingException` | ThrottlingException | 400 | FAULTREQID000000000000000 | false | true | 2636 |
| `throttling` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 1481 |
| `throttling` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 732 |
| `internal-error` | persistent | `baseline` | 3 | throw | `InternalServerErrorException` | InternalServerError | 500 | FAULTREQID000000000000000 | false | false | 57 |
| `internal-error` | persistent | `bridge` | 3 | throw | `InternalServerErrorException` | InternalServerError | 500 | FAULTREQID000000000000000 | false | false | 209 |
| `internal-error` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 254 |
| `internal-error` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 93 |
| `unavailable` | persistent | `baseline` | 3 | throw | `DynamoDbException` | - | 503 | FAULTREQID000000000000000 | false | false | 103 |
| `unavailable` | persistent | `bridge` | 3 | throw | `DynamoDbException` | - | 503 | FAULTREQID000000000000000 | false | false | 96 |
| `unavailable` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 298 |
| `unavailable` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 142 |
...
| `unavailable-retry-after` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 2007 |
...
| `malformed-body` | persistent | `baseline` | 3 | throw | `SdkClientException` | - | - | - | false | - | 191 |
| `malformed-body` | persistent | `bridge` | 3 | throw | `SdkClientException` | - | - | - | false | - | 65 |
| `malformed-body` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 189 |
| `malformed-body` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 44 |
| `empty-500` | persistent | `baseline` | 3 | throw | `DynamoDbException` | - | 500 | FAULTREQID000000000000000 | false | false | 69 |
| `empty-500` | persistent | `bridge` | 3 | throw | `DynamoDbException` | - | 500 | FAULTREQID000000000000000 | false | false | 150 |
| `empty-500` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 73 |
| `empty-500` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 178 |
| `truncated-stream` | persistent | `baseline` | 3 | throw | `SdkClientException` | - | - | - | false | - | 289 |
| `truncated-stream` | persistent | `bridge` | 3 | throw | `SdkClientException` | - | - | - | false | - | 223 |
| `truncated-stream` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 111 |
| `truncated-stream` | transient | `bridge` | 3 | ok | `-` | - | - | - | - | - | 27 |
...
| `connection-reset` | transient | `baseline` | 3 | ok | `-` | - | - | - | - | - | 107 |
| `connection-reset` | transient | `bridge` | 1 | throw | `SdkClientException` | - | - | - | false | - | 2 |

Median wall time per arm across all cases: `baseline` 188 ms, `bridge` 125 ms
